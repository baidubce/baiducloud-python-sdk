"""
Request entity for DeleteRouteRequest information.
"""
...
class DeleteRouteRequest(AbstractModel):
    """
    Request entity for DeleteRouteRequest operation.
    ...
    def __init__(self, instance_id, route_name, x_region):
        """
        Initialize DeleteRouteRequest request entity.
