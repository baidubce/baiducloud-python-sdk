"""
Request entity for UpdateRouteRequest information.
"""
...
class UpdateRouteRequest(AbstractModel):
    """
    Request entity for UpdateRouteRequest operation.
    ...
    def __init__(
        ...
        """
        Initialize UpdateRouteRequest request entity.
        ...
        :param custom_headers: 自定义请求头列表；更新时完全替换原配置
