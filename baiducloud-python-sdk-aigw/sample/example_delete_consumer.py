"""
Example for aigw delete_consumer method.
"""
...
if __name__ == '__main__':
    try:
        ...
        request = aigw_models.DeleteConsumerRequest(instance_id="", consumer_id="", x_region="", key_type="")
        res = client.delete_consumer(request)
