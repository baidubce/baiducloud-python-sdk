"""
Example for aigw delete_service method.
"""
...
if __name__ == '__main__':
    try:
        ...
        request = aigw_models.DeleteServiceRequest(instance_id="", service_name="", namespace="", x_region="")
        res = client.delete_service(request)
