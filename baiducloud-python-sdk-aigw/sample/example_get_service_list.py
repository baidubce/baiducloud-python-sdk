"""
Example for aigw get_service_list method.
"""
...
if __name__ == '__main__':
    try:
        ...
        request = aigw_models.GetServiceListRequest(instance_id="", x_region="", service_source="")
        res = client.get_service_list(request)
