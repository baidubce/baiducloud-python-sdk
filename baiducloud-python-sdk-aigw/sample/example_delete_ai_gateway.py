"""
Example for aigw delete_ai_gateway method.
"""
...
if __name__ == '__main__':
    try:
        ...
        request = aigw_models.DeleteAiGatewayRequest(instance_id="", x_region="", force=False)
        res = client.delete_ai_gateway(request)
