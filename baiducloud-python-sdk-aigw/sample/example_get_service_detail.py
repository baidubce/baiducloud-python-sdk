"""
Example for aigw get_service_detail method.
"""
...
if __name__ == '__main__':
    try:
        ...
        request = aigw_models.GetServiceDetailRequest(instance_id="", service_name="", x_region="")
        res = client.get_service_detail(request)
