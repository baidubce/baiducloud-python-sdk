"""
StatelessCfw information
"""

from baiducloud_python_sdk_core.abstract_model import AbstractModel


class StatelessCfw(AbstractModel):
    """
    StatelessCfw
    """
    ...
    def __init__(
        ...
        """
        Initialize StatelessCfw instance.
        ...
        :param created_time: CFW的创建时间，标准UTC时间格式
        ...
        :param default_action: CFW默认策略，白名单模式取值deny、黑名单模式取值allow
        :type default_action: str (optional)

        :param protocol: CFW协议，取值 \\[ TCP \\| UDP \\| ICMP \\| ALL \\]
        :type protocol: str (optional)

        :param ip_list: CFW IP列表
