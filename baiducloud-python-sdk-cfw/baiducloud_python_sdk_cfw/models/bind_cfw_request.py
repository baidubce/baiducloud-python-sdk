"""
Request entity for BindCfwRequest information.
"""
...
class BindCfwRequest(AbstractModel):
    """
    Request entity for BindCfwRequest operation.
    ...
    def __init__(self, cfw_id, instance_type, instances):
        """
        Initialize BindCfwRequest request entity.
