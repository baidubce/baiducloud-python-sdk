"""
Example for cfw enable_cfw_protect method.
"""
...
if __name__ == '__main__':
    try:
        ...
        request = cfw_models.EnableCfwProtectRequest(cfw_id="", instance_id="", role="", member_id="")
        res = client.enable_cfw_protect(request)
