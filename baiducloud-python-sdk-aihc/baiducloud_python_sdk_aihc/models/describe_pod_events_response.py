"""
Request entity for DescribePodEventsResponse information.
"""
...
class DescribePodEventsResponse(BceResponse):
    """
    ...
    def __init__(self, request_id=None, events=None, total=None):
        """
        Initialize DescribePodEventsResponse response.

        :param request_id: 请求ID
        :type request_id: str (optional)

        :param events: 成功请求时的返回结果
