"""
Request entity for DescribeJobRequest information.
"""
...
class DescribeJobRequest(AbstractModel):
    """
    Request entity for DescribeJobRequest operation.

    This class encapsulates all parameters for the API request.
    """

    def __init__(self, resource_pool_id, queue_id, job_id, need_detail=None):
        """
        Initialize DescribeJobRequest request entity.
        ...
        :param need_detail: 是否需要详细信息，值为true时将返回Pod及历史Pod列表
        :type need_detail: bool (optional)
        """
        super().__init__()
