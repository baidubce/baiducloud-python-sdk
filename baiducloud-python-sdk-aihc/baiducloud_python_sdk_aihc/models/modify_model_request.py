"""
Request entity for ModifyModelRequest information.
"""
...
class ModifyModelRequest(AbstractModel):
    """
    Request entity for ModifyModelRequest operation.
    ...
    def __init__(self, model_id, name, description):
        """
        Initialize ModifyModelRequest request entity.
