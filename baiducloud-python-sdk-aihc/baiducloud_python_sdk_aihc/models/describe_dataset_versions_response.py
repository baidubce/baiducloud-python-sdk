"""
Request entity for DescribeDatasetVersionsResponse information.
"""
...
class DescribeDatasetVersionsResponse(BceResponse):
    """
    ...
    def __init__(self, total_count=None, versions=None):
        """
        Initialize DescribeDatasetVersionsResponse response.
