"""
Request entity for DescribeJobEventsRequest information.
"""
...
class DescribeJobEventsRequest(AbstractModel):
    """
    Request entity for DescribeJobEventsRequest operation.

    This class encapsulates all parameters for the API request.
    """

    def __init__(self, resource_pool_id, queue_id, job_id, start_time=None, end_time=None):
        """
        Initialize DescribeJobEventsRequest request entity.
        ...
        :param start_time: 获取任务事件的起始时间，默认为任务创建时间
        :type start_time: str (optional)

        :param end_time: 获取任务事件的结束时间，默认为 now
    ...
    def from_dict(self, m):
        ...
        :rtype: DescribeJobEventsRequest
