"""
Request entity for DescribeModelVersionsResponse information.
"""
...
class DescribeModelVersionsResponse(BceResponse):
    """
    ...
    def __init__(self, total_count=None, versions=None):
        """
        Initialize DescribeModelVersionsResponse response.
