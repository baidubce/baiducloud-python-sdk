"""
Example for aihc retrieve_the_dataset_list_v2 method.
"""
...
if __name__ == '__main__':
    try:
        ...
        request = aihc_models.RetrieveTheDatasetListV2Request(
            storage_type="", storage_instances="", import_format="", page_number=0, page_size=0
        )
        res = client.retrieve_the_dataset_list_v2(request)
