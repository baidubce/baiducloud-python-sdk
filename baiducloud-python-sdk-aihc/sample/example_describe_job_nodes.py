"""
Example for aihc describe_job_nodes method.
"""
...
if __name__ == '__main__':
    try:
        ...
        request = aihc_models.DescribeJobNodesRequest(resource_pool_id="", queue_id="", job_id="")
        res = client.describe_job_nodes(request)
