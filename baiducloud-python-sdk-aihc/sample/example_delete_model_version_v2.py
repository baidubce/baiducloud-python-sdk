"""
Example for aihc delete_model_version_v2 method.
"""
...
if __name__ == '__main__':
    try:
        ...
        request = aihc_models.DeleteModelVersionV2Request(model_id="", version_id="")
        res = client.delete_model_version_v2(request)
