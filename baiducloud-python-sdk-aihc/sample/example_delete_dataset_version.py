"""
Example for aihc delete_dataset_version method.
"""
...
if __name__ == '__main__':
    try:
        ...
        request = aihc_models.DeleteDatasetVersionRequest(dataset_id="", version_id="")
        res = client.delete_dataset_version(request)
