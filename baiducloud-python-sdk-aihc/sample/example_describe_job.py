"""
Example for aihc describe_job method.
"""
...
if __name__ == '__main__':
    try:
        ...
        request = aihc_models.DescribeJobRequest(resource_pool_id="", queue_id="", job_id="", need_detail=False)
        res = client.describe_job(request)
