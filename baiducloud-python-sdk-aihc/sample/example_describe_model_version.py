"""
Example for aihc describe_model_version method.
"""
...
if __name__ == '__main__':
    try:
        ...
        request = aihc_models.DescribeModelVersionRequest(model_id="", version_id="")
        res = client.describe_model_version(request)
