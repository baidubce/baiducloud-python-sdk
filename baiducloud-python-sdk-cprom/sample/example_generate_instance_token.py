"""
Example for cprom generate_instance_token method.
"""
...
if __name__ == '__main__':
    try:
        ...
        request = cprom_models.GenerateInstanceTokenRequest(instance_id="", action="", token="")
        res = client.generate_instance_token(request)
