"""
Example for cprom list_related_cloud_products method.
"""
...
if __name__ == '__main__':
    try:
        ...
        request = cprom_models.ListRelatedCloudProductsRequest(instance_id="")
        res = client.list_related_cloud_products(request)
