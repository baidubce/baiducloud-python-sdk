"""
Example for cprom delete_notification_policy method.
"""
...
if __name__ == '__main__':
    try:
        ...
        request = cprom_models.DeleteNotificationPolicyRequest(notify_rule_id="")
        res = client.delete_notification_policy(request)
