"""
Example for cprom get_notification_policy method.
"""
...
if __name__ == '__main__':
    try:
        ...
        request = cprom_models.GetNotificationPolicyRequest(notify_rule_id="")
        res = client.get_notification_policy(request)
