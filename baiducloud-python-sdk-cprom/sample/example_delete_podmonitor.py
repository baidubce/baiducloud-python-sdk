"""
Example for cprom delete_podmonitor method.
"""
...
if __name__ == '__main__':
    try:
        ...
        request = cprom_models.DeletePodmonitorRequest(pod_monitor_name="", instance_id="", agent_id="")
        res = client.delete_podmonitor(request)
