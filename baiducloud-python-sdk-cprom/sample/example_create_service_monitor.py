"""
Example for cprom create_service_monitor method.
"""
...
if __name__ == '__main__':
    try:
        ...
        request = cprom_models.CreateServiceMonitorRequest(
            instance_id="", agent_id="", api_version="", kind="", metadata=metadata, spec=spec
        )
        res = client.create_service_monitor(request)
