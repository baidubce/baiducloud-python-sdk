"""
Example for cprom list_alerts method.
"""
...
if __name__ == '__main__':
    try:
        ...
        request = cprom_models.ListAlertsRequest(instance_id="", page_size=0, page_no=0, keyword_type="", keyword="")
        res = client.list_alerts(request)
