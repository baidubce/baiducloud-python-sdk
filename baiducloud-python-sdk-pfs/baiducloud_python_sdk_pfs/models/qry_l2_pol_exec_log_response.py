"""
Request entity for QryL2PolExecLogResponse information.
"""
...
class QryL2PolExecLogResponse(BceResponse):
    """
    QryL2PolExecLogResponse
    """

    def __init__(self, request_id=None, policy_id=None, instance_id=None, execute_infos=None):
        """
        Initialize QryL2PolExecLogResponse response.
