"""
Request entity for DeleteFilesetRequest information.
"""
...
class DeleteFilesetRequest(AbstractModel):
    """
    Request entity for DeleteFilesetRequest operation.
    ...
    def __init__(self, instance_id, fileset_id):
        """
        Initialize DeleteFilesetRequest request entity.

        :param instance_id: fileset所属的pfs实例短id
        :type instance_id: str (required)

        :param fileset_id: 删除fileset的Id
