"""
Request entity for DescribeL3MountTargetRequest information.
"""

from baiducloud_python_sdk_core.abstract_model import AbstractModel


class DescribeL3MountTargetRequest(AbstractModel):
    """
    Request entity for DescribeL3MountTargetRequest operation.
    ...
    def __init__(self, instance_id, mount_target_id):
        """
        Initialize DescribeL3MountTargetRequest request entity.
    ...
    def from_dict(self, m):
        ...
        :rtype: DescribeL3MountTargetRequest
