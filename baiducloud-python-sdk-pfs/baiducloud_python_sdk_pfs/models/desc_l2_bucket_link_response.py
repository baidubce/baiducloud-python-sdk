"""
Request entity for DescL2BucketLinkResponse information.
"""

from baiducloud_python_sdk_core.bce_response import BceResponse


class DescL2BucketLinkResponse(BceResponse):
    """
    DescL2BucketLinkResponse
    """
    ...
    def __init__(
        ...
        """
        Initialize DescL2BucketLinkResponse response.
        ...
        :param transfer_type: <li>0 导出任务<br><li>1 导入任务
        ...
        :param report: 任务报告，在任务结束（已成功、任务失败、已取消）时生效。只有当数据流动任务为一次性任务时会返回。
