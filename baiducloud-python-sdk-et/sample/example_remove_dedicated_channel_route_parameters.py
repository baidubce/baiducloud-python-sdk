"""
Example for et remove_dedicated_channel_route_parameters method.
"""
...
if __name__ == '__main__':
    try:
        ...
        request = et_models.RemoveDedicatedChannelRouteParametersRequest(
            et_id="", et_channel_id="", route_type="", client_token="", networks=[], ipv6_networks=[]
        )
        res = client.remove_dedicated_channel_route_parameters(request)
