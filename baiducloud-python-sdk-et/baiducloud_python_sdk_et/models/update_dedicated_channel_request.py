"""
Request entity for UpdateDedicatedChannelRequest information.
"""

from baiducloud_python_sdk_core.abstract_model import AbstractModel


class UpdateDedicatedChannelRequest(AbstractModel):
    """
    Request entity for UpdateDedicatedChannelRequest operation.

    This class encapsulates all parameters for the API request.
    """

    def __init__(self, et_id, et_channel_id, client_token=None, name=None, description=None, bgp_route_limit=None):
        """
        Initialize UpdateDedicatedChannelRequest request entity.
    ...
    def from_dict(self, m):
        ...
        :rtype: UpdateDedicatedChannelRequest
