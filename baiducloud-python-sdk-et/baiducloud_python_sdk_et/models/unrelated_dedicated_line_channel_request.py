"""
Request entity for UnrelatedDedicatedLineChannelRequest information.
"""

from baiducloud_python_sdk_core.abstract_model import AbstractModel


class UnrelatedDedicatedLineChannelRequest(AbstractModel):
    """
    Request entity for UnrelatedDedicatedLineChannelRequest operation.
    ...
    def __init__(self, et_id, et_channel_id, extra_channel_id, client_token=None):
        """
        Initialize UnrelatedDedicatedLineChannelRequest request entity.
    ...
    def from_dict(self, m):
        ...
        :rtype: UnrelatedDedicatedLineChannelRequest
