"""
Request entity for UpdateDedicatedChannelBfdRequest information.
"""

from baiducloud_python_sdk_core.abstract_model import AbstractModel


class UpdateDedicatedChannelBfdRequest(AbstractModel):
    """
    Request entity for UpdateDedicatedChannelBfdRequest operation.
    ...
    def __init__(self, et_id, et_channel_id, send_interval, receiv_interval, detect_multiplier, client_token=None):
        """
        Initialize UpdateDedicatedChannelBfdRequest request entity.
    ...
    def from_dict(self, m):
        ...
        :rtype: UpdateDedicatedChannelBfdRequest
