"""
Request entity for CreateDedicatedChannelUserObjectRequest information.
"""

from baiducloud_python_sdk_core.abstract_model import AbstractModel


class CreateDedicatedChannelUserObjectRequest(AbstractModel):
    """
    Request entity for CreateDedicatedChannelUserObjectRequest operation.
    ...
    def __init__(self, et_id, et_channel_id, authorized_users, client_token=None):
        """
        Initialize CreateDedicatedChannelUserObjectRequest request entity.
    ...
    def from_dict(self, m):
        ...
        :rtype: CreateDedicatedChannelUserObjectRequest
