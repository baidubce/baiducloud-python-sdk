"""
Request entity for RemoveDedicatedChannelRouteParametersRequest information.
"""

from baiducloud_python_sdk_core.abstract_model import AbstractModel


class RemoveDedicatedChannelRouteParametersRequest(AbstractModel):
    """
    Request entity for RemoveDedicatedChannelRouteParametersRequest operation.
    ...
    def __init__(self, et_id, et_channel_id, route_type, client_token=None, networks=None, ipv6_networks=None):
        """
        Initialize RemoveDedicatedChannelRouteParametersRequest request entity.
    ...
    def from_dict(self, m):
        ...
        :rtype: RemoveDedicatedChannelRouteParametersRequest
