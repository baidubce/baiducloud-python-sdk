"""
Request entity for CreateBlbUdpListenerRequest information.
"""

from baiducloud_python_sdk_core.abstract_model import AbstractModel


class CreateBlbUdpListenerRequest(AbstractModel):
    """
    Request entity for CreateBlbUdpListenerRequest operation.
    ...
    def __init__(
        ...
        """
        Initialize CreateBlbUdpListenerRequest request entity.
        ...
        :param health_check_type: 健康检查协议类型，支持\"UDP\"/\"ICMP\"，默认\"UDP\"
        :type health_check_type: str (optional)

        :param health_check_port: 健康检查端口，当健康检查协议为\"UDP\"时指定，默认为backendPort.
        :type health_check_port: int (optional)

        :param health_check_string: health_check_string parameter
    ...
    def from_dict(self, m):
        ...
        :rtype: CreateBlbUdpListenerRequest
