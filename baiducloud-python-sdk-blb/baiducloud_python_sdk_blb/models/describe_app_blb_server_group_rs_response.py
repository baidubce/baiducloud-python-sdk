"""
Request entity for DescribeAppBlbServerGroupRsResponse information.
"""
...
class DescribeAppBlbServerGroupRsResponse(BceResponse):
    """
    ...
    def __init__(self, backend_server_list=None, marker=None, is_truncated=None, next_marker=None, max_keys=None):
        """
        Initialize DescribeAppBlbServerGroupRsResponse response.
