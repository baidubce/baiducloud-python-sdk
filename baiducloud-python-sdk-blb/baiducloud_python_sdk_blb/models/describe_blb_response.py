"""
Request entity for DescribeBlbResponse information.
"""
...
class DescribeBlbResponse(BceResponse):
    """
    DescribeBlbResponse
    """
    ...
    def __init__(
        ...
        """
        Initialize DescribeBlbResponse response.
        ...
        :param vpc_id: LoadBalancer所属vpcId
        ...
        :param allow_modify: 是否允许控制台修改
        :type allow_modify: bool (optional)

        :param modification_protection_reason: 不允许修改原因
