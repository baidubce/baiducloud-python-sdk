"""
Request entity for UpdateBlbSslListenerRequest information.
"""

from baiducloud_python_sdk_core.abstract_model import AbstractModel


class UpdateBlbSslListenerRequest(AbstractModel):
    """
    Request entity for UpdateBlbSslListenerRequest operation.
    ...
    def __init__(
        ...
        """
        Initialize UpdateBlbSslListenerRequest request entity.
        ...
        :param health_check_type: 健康检查协议类型，支持\"TCP\"
    ...
    def from_dict(self, m):
        ...
        :rtype: UpdateBlbSslListenerRequest
