"""
Request entity for DescribeAppBlbServerGroupRequest information.
"""

from baiducloud_python_sdk_core.abstract_model import AbstractModel


class DescribeAppBlbServerGroupRequest(AbstractModel):
    """
    Request entity for DescribeAppBlbServerGroupRequest operation.
    ...
    def __init__(self, blb_id, name=None, exactly_match=None, marker=None, max_keys=None):
        """
        Initialize DescribeAppBlbServerGroupRequest request entity.
    ...
    def from_dict(self, m):
        ...
        :rtype: DescribeAppBlbServerGroupRequest
