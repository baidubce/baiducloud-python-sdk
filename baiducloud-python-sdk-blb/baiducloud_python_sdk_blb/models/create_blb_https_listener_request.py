"""
Request entity for CreateBlbHttpsListenerRequest information.
"""
...
class CreateBlbHttpsListenerRequest(AbstractModel):
    """
    Request entity for CreateBlbHttpsListenerRequest operation.
    ...
    def __init__(
        ...
        """
        Initialize CreateBlbHttpsListenerRequest request entity.
        ...
        :type keep_session_cookie_name: int (optional)
        ...
        :param health_check_type: 健康检查协议，支持\"HTTP\"/\"TCP\"，默认\"HTTP\"
        ...
        :param cert_ids: 监听器要加载的证书,当前仅允许传入1个证书ID，如果传入多个，则只有最后一个生效
    ...
    def from_dict(self, m):
        ...
        :rtype: CreateBlbHttpsListenerRequest
