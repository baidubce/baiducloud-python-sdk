"""
Request entity for UpdateAppBlbTcpListenerRequest information.
"""

from baiducloud_python_sdk_core.abstract_model import AbstractModel


class UpdateAppBlbTcpListenerRequest(AbstractModel):
    """
    Request entity for UpdateAppBlbTcpListenerRequest operation.

    This class encapsulates all parameters for the API request.
    """

    def __init__(
        self, blb_id, listener_port, client_token=None, scheduler=None, tcp_session_timeout=None, description=None
    ):
        """
        Initialize UpdateAppBlbTcpListenerRequest request entity.
    ...
    def from_dict(self, m):
        ...
        :rtype: UpdateAppBlbTcpListenerRequest
