"""
Request entity for DeleteAppBlbIpGroupMemberRequest information.
"""

from baiducloud_python_sdk_core.abstract_model import AbstractModel


class DeleteAppBlbIpGroupMemberRequest(AbstractModel):
    """
    Request entity for DeleteAppBlbIpGroupMemberRequest operation.

    This class encapsulates all parameters for the API request.
    """

    def __init__(self, blb_id, ip_group_id, member_id_list, client_token=None):
        """
        Initialize DeleteAppBlbIpGroupMemberRequest request entity.
        ...
        :param member_id_list: 要删除的IP组成员id数组
        :type member_id_list: List[str] (required)
        """
        super().__init__()
        self.blb_id = blb_id
    ...
    def from_dict(self, m):
        ...
        :rtype: DeleteAppBlbIpGroupMemberRequest
