"""
Request entity for UpdateAppBlbServerGroupPortRequest information.
"""

from baiducloud_python_sdk_core.abstract_model import AbstractModel


class UpdateAppBlbServerGroupPortRequest(AbstractModel):
    """
    Request entity for UpdateAppBlbServerGroupPortRequest operation.
    ...
    def __init__(
        ...
        """
        Initialize UpdateAppBlbServerGroupPortRequest request entity.
        ...
        :param port_id: 要更新的服务器组端口的标识符
        :type port_id: str (required)
        ...
        :param health_check_port: 健康检查端口，默认为port的取值，当健康检查协议为\"HTTP\"时生效
    ...
    def from_dict(self, m):
        ...
        :rtype: UpdateAppBlbServerGroupPortRequest
