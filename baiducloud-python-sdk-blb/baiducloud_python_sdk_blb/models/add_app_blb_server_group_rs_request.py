"""
Request entity for AddAppBlbServerGroupRsRequest information.
"""
...
class AddAppBlbServerGroupRsRequest(AbstractModel):
    """
    Request entity for AddAppBlbServerGroupRsRequest operation.

    This class encapsulates all parameters for the API request.
    """

    def __init__(self, blb_id, sg_id, backend_server_list, client_token=None):
        """
        Initialize AddAppBlbServerGroupRsRequest request entity.
    ...
    def from_dict(self, m):
        ...
        :rtype: AddAppBlbServerGroupRsRequest
