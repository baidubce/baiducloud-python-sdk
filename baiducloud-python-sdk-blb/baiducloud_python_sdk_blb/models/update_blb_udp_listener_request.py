"""
Request entity for UpdateBlbUdpListenerRequest information.
"""

from baiducloud_python_sdk_core.abstract_model import AbstractModel


class UpdateBlbUdpListenerRequest(AbstractModel):
    """
    Request entity for UpdateBlbUdpListenerRequest operation.
    ...
    def __init__(
        ...
        """
        Initialize UpdateBlbUdpListenerRequest request entity.
        ...
        :param health_check_type: 健康检查协议类型，支持\"UDP\"/\"ICMP\"
        :type health_check_type: str (optional)

        :param health_check_port: 健康检查端口，当健康检查协议为\"UDP\"时可指定
    ...
    def from_dict(self, m):
        ...
        :rtype: UpdateBlbUdpListenerRequest
