"""
Request entity for CreateAppBlbHttpsListenerRequest information.
"""
...
class CreateAppBlbHttpsListenerRequest(AbstractModel):
    """
    Request entity for CreateAppBlbHttpsListenerRequest operation.
    ...
    def __init__(
        ...
        """
        Initialize CreateAppBlbHttpsListenerRequest request entity.
        ...
        :param keep_session_timeout: 会话保持的cookie有效时间（单位：秒），当且仅当开启会话保持时有效，默认3600s，需为1-15552000间的整数
    ...
    def from_dict(self, m):
        ...
        :rtype: CreateAppBlbHttpsListenerRequest
