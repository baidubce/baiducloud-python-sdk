"""
Request entity for CreateAppBlbServerGroupPortRequest information.
"""

from baiducloud_python_sdk_core.abstract_model import AbstractModel


class CreateAppBlbServerGroupPortRequest(AbstractModel):
    """
    Request entity for CreateAppBlbServerGroupPortRequest operation.
    ...
    def __init__(
        ...
        """
        Initialize CreateAppBlbServerGroupPortRequest request entity.
        ...
        :param sg_id: 端口所属服务器组标识符
        :type sg_id: str (required)

        :param port: 端口号，需为1-65535间的整数
        :type port: int (required)

        :param type: 监听端口的协议类型，\"TCP\"/\"UDP\"/\"HTTP\"
        :type type: str (required)

        :param enable_health_check: 是否开启健康检查，默认true
        :type enable_health_check: bool (optional)

        :param health_check: health_check parameter
        :type health_check: str (optional)

        :param health_check_port: 健康检查端口，允许范围为1-65535，默认为port的取值，当健康检查协议为\"HTTP\"时生效
        ...
        :param udp_health_check_string: UDP服务的健康检查字段。当健康检查协议为\"UDP\"时，则必传
    ...
    def from_dict(self, m):
        ...
        :rtype: CreateAppBlbServerGroupPortRequest
