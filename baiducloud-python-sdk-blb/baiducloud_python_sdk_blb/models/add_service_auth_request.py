"""
Request entity for AddServiceAuthRequest information.
"""
...
class AddServiceAuthRequest(AbstractModel):
    """
    Request entity for AddServiceAuthRequest operation.
    ...
    def __init__(self, service, auth_list, client_token=None):
        """
        Initialize AddServiceAuthRequest request entity.
