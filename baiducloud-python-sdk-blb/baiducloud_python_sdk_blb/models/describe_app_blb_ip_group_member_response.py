"""
Request entity for DescribeAppBlbIpGroupMemberResponse information.
"""
...
class DescribeAppBlbIpGroupMemberResponse(BceResponse):
    """
    DescribeAppBlbIpGroupMemberResponse
    """

    def __init__(self, marker=None, is_truncated=None, next_marker=None, max_keys=None, member_list=None):
        """
        Initialize DescribeAppBlbIpGroupMemberResponse response.
