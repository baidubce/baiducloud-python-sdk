"""
AppIpGroupBackendPolicy information
"""

from baiducloud_python_sdk_core.abstract_model import AbstractModel


class AppIpGroupBackendPolicy(AbstractModel):
    """
    AppIpGroupBackendPolicy
    """
    ...
    def __init__(
        ...
        """
        Initialize AppIpGroupBackendPolicy instance.

        :param id: IP组协议标识符
        :type id: str (optional)

        :param type: IP组协议类型，\"TCP\"/\"HTTP\"/\"UDP\"
        :type type: str (optional)

        :param health_check: 健康检查协议类型，\"TCP\"/\"HTTP\"/\"UDP\"
