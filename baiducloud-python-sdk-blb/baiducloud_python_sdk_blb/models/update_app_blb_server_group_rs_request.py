"""
Request entity for UpdateAppBlbServerGroupRsRequest information.
"""
...
class UpdateAppBlbServerGroupRsRequest(AbstractModel):
    """
    Request entity for UpdateAppBlbServerGroupRsRequest operation.
    ...
    def __init__(self, blb_id, sg_id, backend_server_list, client_token=None):
        """
        Initialize UpdateAppBlbServerGroupRsRequest request entity.
    ...
    def from_dict(self, m):
        ...
        :rtype: UpdateAppBlbServerGroupRsRequest
