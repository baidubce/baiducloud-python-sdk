...
class BillingForCreate(AbstractModel):
    """
    BillingForCreate
    """
    ...
    def __init__(self, payment_timing=None, billing_method=None, reservation=None):
        """
        Initialize BillingForCreate instance.

        :param payment_timing: 付款时间，预支付（Prepaid）和后支付（Postpaid），目前只支持预支付
        :type payment_timing: str (optional)

        :param billing_method: 计费方式，后付费的时候传，\"BySpec\"按固定规格、\"ByCapacityUnit\"按使用量
