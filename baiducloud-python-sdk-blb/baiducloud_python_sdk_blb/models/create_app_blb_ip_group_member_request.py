"""
Request entity for CreateAppBlbIpGroupMemberRequest information.
"""
...
class CreateAppBlbIpGroupMemberRequest(AbstractModel):
    """
    Request entity for CreateAppBlbIpGroupMemberRequest operation.
    ...
    def __init__(self, blb_id, ip_group_id, member_list, client_token=None):
        """
        Initialize CreateAppBlbIpGroupMemberRequest request entity.
        ...
        :type member_list: List[AppIpGroupMemberForCreate] (required)
        """
        super().__init__()
        self.blb_id = blb_id
    ...
    def from_dict(self, m):
        ...
        :rtype: CreateAppBlbIpGroupMemberRequest
