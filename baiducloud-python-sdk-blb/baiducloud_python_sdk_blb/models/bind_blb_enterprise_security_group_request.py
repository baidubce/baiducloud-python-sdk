"""
Request entity for BindBlbEnterpriseSecurityGroupRequest information.
"""

from baiducloud_python_sdk_core.abstract_model import AbstractModel


class BindBlbEnterpriseSecurityGroupRequest(AbstractModel):
    """
    Request entity for BindBlbEnterpriseSecurityGroupRequest operation.
    ...
    def __init__(self, blb_id, enterprise_security_group_ids, client_token=None):
        """
        Initialize BindBlbEnterpriseSecurityGroupRequest request entity.
        ...
        :param enterprise_security_group_ids: 绑定的企业安全组ID列表
    ...
    def from_dict(self, m):
        ...
        :rtype: BindBlbEnterpriseSecurityGroupRequest
