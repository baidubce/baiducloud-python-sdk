"""
Request entity for DescribeBlbServerHealthResponse information.
"""

from baiducloud_python_sdk_core.bce_response import BceResponse
from baiducloud_python_sdk_blb.models.backend_server_status import BackendServerStatus


class DescribeBlbServerHealthResponse(BceResponse):
    """
    DescribeBlbServerHealthResponse
    """
    ...
    def __init__(
        ...
        """
        Initialize DescribeBlbServerHealthResponse response.

        :param backend_server_list: 后端服务器状态列表
        :type backend_server_list: List[BackendServerStatus] (optional)

        :param type: 监听器类型，值为\"TCP\"/\"HTTP\"
    ...
    def from_dict(self, m):
        ...
        if m.get('backendServerList') is not None:
            self.backend_server_list = [BackendServerStatus().from_dict(i) for i in m.get('backendServerList')]
