"""
Request entity for UnbindBlbEnterpriseSecurityGroupRequest information.
"""

from baiducloud_python_sdk_core.abstract_model import AbstractModel


class UnbindBlbEnterpriseSecurityGroupRequest(AbstractModel):
    """
    Request entity for UnbindBlbEnterpriseSecurityGroupRequest operation.

    This class encapsulates all parameters for the API request.
    """

    def __init__(self, blb_id, enterprise_security_group_ids, client_token=None):
        """
        Initialize UnbindBlbEnterpriseSecurityGroupRequest request entity.
        ...
        :param enterprise_security_group_ids: 解绑的企业安全组ID列表
    ...
    def from_dict(self, m):
        ...
        :rtype: UnbindBlbEnterpriseSecurityGroupRequest
