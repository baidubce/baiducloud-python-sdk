"""
Request entity for CreateAppBlbServerGroupRequest information.
"""
...
class CreateAppBlbServerGroupRequest(AbstractModel):
    """
    Request entity for CreateAppBlbServerGroupRequest operation.
    ...
    def __init__(
        ...
        :param name: 服务器组的名称，方便记忆。长度1~65个字节，字母开头，\\_可包含字母数字-/.字符。若不传该参数，会自动生成
    ...
    def from_dict(self, m):
        ...
        :rtype: CreateAppBlbServerGroupRequest
