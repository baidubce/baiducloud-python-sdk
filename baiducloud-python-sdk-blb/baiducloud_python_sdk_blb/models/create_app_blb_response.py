"""
Request entity for CreateAppBlbResponse information.
"""

from baiducloud_python_sdk_core.bce_response import BceResponse


class CreateAppBlbResponse(BceResponse):
    """
    CreateAppBlbResponse
    """

    def __init__(self, address=None, name=None, desc=None, blb_id=None):
        """
        Initialize CreateAppBlbResponse response.

        :param address: 分配的服务地址IP，通过这个IP即能访问该实例
