"""
Request entity for UpdateAppBlbIpGroupProtocolRequest information.
"""

from baiducloud_python_sdk_core.abstract_model import AbstractModel


class UpdateAppBlbIpGroupProtocolRequest(AbstractModel):
    """
    Request entity for UpdateAppBlbIpGroupProtocolRequest operation.
    ...
    def __init__(
        ...
        """
        Initialize UpdateAppBlbIpGroupProtocolRequest request entity.
        ...
        :param udp_health_check_string: udp健康检查字符串，当健康检查协议为\"UDP\"时生效
    ...
    def from_dict(self, m):
        ...
        :rtype: UpdateAppBlbIpGroupProtocolRequest
