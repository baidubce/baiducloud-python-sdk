"""
Request entity for CreateAppBlbUdpListenerRequest information.
"""

from baiducloud_python_sdk_core.abstract_model import AbstractModel


class CreateAppBlbUdpListenerRequest(AbstractModel):
    """
    Request entity for CreateAppBlbUdpListenerRequest operation.

    This class encapsulates all parameters for the API request.
    """

    def __init__(
        self, blb_id, listener_port, scheduler, client_token=None, udp_session_timeout=None, description=None
    ):
        """
        Initialize CreateAppBlbUdpListenerRequest request entity.
    ...
    def from_dict(self, m):
        ...
        :rtype: CreateAppBlbUdpListenerRequest
