"""
Request entity for CreateBlbHttpListenerRequest information.
"""
...
class CreateBlbHttpListenerRequest(AbstractModel):
    """
    Request entity for CreateBlbHttpListenerRequest operation.
    ...
    def __init__(
        ...
        """
        Initialize CreateBlbHttpListenerRequest request entity.
        ...
        :param x_forwarded_proto: 将监听使用的协议通过 x-forwarded-proto HTTP Header 转发给后端服务器
    ...
    def from_dict(self, m):
        ...
        :rtype: CreateBlbHttpListenerRequest
