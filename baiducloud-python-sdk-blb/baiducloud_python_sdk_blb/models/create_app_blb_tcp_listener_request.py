"""
Request entity for CreateAppBlbTcpListenerRequest information.
"""

from baiducloud_python_sdk_core.abstract_model import AbstractModel


class CreateAppBlbTcpListenerRequest(AbstractModel):
    """
    Request entity for CreateAppBlbTcpListenerRequest operation.

    This class encapsulates all parameters for the API request.
    """

    def __init__(
        self, blb_id, listener_port, scheduler, client_token=None, tcp_session_timeout=None, description=None
    ):
        """
        Initialize CreateAppBlbTcpListenerRequest request entity.
    ...
    def from_dict(self, m):
        ...
        :rtype: CreateAppBlbTcpListenerRequest
