"""
Example for blb create_app_blb_https_listener method.
"""
...
if __name__ == '__main__':
    try:
        ...
        request = blb_models.CreateAppBlbHttpsListenerRequest(
            blb_id="",
            listener_port=0,
            scheduler="",
            cert_ids=[],
        ...
        res = client.create_app_blb_https_listener(request)
