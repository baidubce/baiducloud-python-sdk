"""
Example for blb describe_blb_servers method.
"""
...
if __name__ == '__main__':
    try:
        ...
        request = blb_models.DescribeBlbServersRequest(blb_id="", marker="", max_keys=0)
        res = client.describe_blb_servers(request)
