"""
Example for blb create_blb_https_listener method.
"""
...
if __name__ == '__main__':
    try:
        ...
        request = blb_models.CreateBlbHttpsListenerRequest(
            blb_id="",
            listener_port=0,
            backend_port=0,
            scheduler="",
        ...
        res = client.create_blb_https_listener(request)
