"""
Example for blb update_app_blb_ip_group_protocol method.
"""
...
if __name__ == '__main__':
    try:
        ...
        request = blb_models.UpdateAppBlbIpGroupProtocolRequest(
            blb_id="",
            ip_group_id="",
            id="",
            client_token="",
        ...
        res = client.update_app_blb_ip_group_protocol(request)
