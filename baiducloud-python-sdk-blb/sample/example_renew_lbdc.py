"""
Example for blb renew_lbdc method.
"""
...
if __name__ == '__main__':
    try:
        ...
        billing = blb_models.BillingForRenew(reservation=reservation)
        request = blb_models.RenewLbdcRequest(id="", billing=billing, client_token="")
        res = client.renew_lbdc(request)
