"""
Example for blb update_app_blb_server_group_port method.
"""
...
if __name__ == '__main__':
    try:
        ...
        request = blb_models.UpdateAppBlbServerGroupPortRequest(
            blb_id="",
            sg_id="",
            port_id="",
            client_token="",
        ...
        res = client.update_app_blb_server_group_port(request)
