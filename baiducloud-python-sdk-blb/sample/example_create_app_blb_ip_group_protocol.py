"""
Example for blb create_app_blb_ip_group_protocol method.
"""
...
if __name__ == '__main__':
    try:
        ...
        request = blb_models.CreateAppBlbIpGroupProtocolRequest(
            blb_id="",
            ip_group_id="",
            type="",
            client_token="",
        ...
        res = client.create_app_blb_ip_group_protocol(request)
