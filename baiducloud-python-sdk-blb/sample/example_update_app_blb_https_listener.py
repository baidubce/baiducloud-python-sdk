"""
Example for blb update_app_blb_https_listener method.
"""
...
if __name__ == '__main__':
    try:
        ...
        request = blb_models.UpdateAppBlbHttpsListenerRequest(
            blb_id="",
            listener_port=0,
            scheduler="",
            cert_ids=[],
        ...
        res = client.update_app_blb_https_listener(request)
