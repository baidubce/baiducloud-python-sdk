"""
Example for bls update_log_shipper method.
"""
...
if __name__ == '__main__':
    try:
        ...
        request = bls_models.UpdateLogShipperRequest(
            log_shipper_id="", log_shipper_name="", dest_config=dest_config, project=""
        )
        res = client.update_log_shipper(request)
