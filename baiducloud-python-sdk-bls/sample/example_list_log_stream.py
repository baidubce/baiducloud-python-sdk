"""
Example for bls list_log_stream method.
"""
...
if __name__ == '__main__':
    try:
        ...
        request = bls_models.ListLogStreamRequest(
            project="", log_store_name="", name_pattern="", order="", order_by="", page_no=0, page_size=0
        )
        res = client.list_log_stream(request)
        content = res.object_content.read().decode('utf-8')
        print(content)
