"""
Example for bls describe_log_store_template method.
"""
...
if __name__ == '__main__':
    try:
        ...
        request = bls_models.DescribeLogStoreTemplateRequest(name="")
        res = client.describe_log_store_template(request)
