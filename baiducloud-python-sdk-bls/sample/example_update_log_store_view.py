"""
Example for bls update_log_store_view method.
"""
...
if __name__ == '__main__':
    try:
        ...
        request = bls_models.UpdateLogStoreViewRequest(name="", logstores=[], project="")
        res = client.update_log_store_view(request)
