"""
Example for bls create_log_store_view method.
"""
...
if __name__ == '__main__':
    try:
        ...
        request = bls_models.CreateLogStoreViewRequest(name="", logstores=[], project="")
        res = client.create_log_store_view(request)
