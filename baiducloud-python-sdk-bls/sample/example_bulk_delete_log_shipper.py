"""
Example for bls bulk_delete_log_shipper method.
"""
...
if __name__ == '__main__':
    try:
        ...
        request = bls_models.BulkDeleteLogShipperRequest(log_shipper_ids=[])
        res = client.bulk_delete_log_shipper(request)
