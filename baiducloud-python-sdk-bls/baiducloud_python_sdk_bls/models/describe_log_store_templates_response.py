"""
Request entity for DescribeLogStoreTemplatesResponse information.
"""
...
class DescribeLogStoreTemplatesResponse(BceResponse):
    """
    DescribeLogStoreTemplatesResponse
    """

    def __init__(
        self, success=None, code=None, message=None, templates=None, page_no=None, page_size=None, total_count=None
    ):
        """
        Initialize DescribeLogStoreTemplatesResponse response.
