"""
Request entity for CreateLogStoreViewRequest information.
"""
...
class CreateLogStoreViewRequest(AbstractModel):
    """
    Request entity for CreateLogStoreViewRequest operation.
    ...
    def __init__(self, name, logstores, project=None):
        """
        Initialize CreateLogStoreViewRequest request entity.
    ...
    def from_dict(self, m):
        ...
        :rtype: CreateLogStoreViewRequest
