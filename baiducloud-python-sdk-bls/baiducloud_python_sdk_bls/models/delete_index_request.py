"""
Request entity for DeleteIndexRequest information.
"""
...
class DeleteIndexRequest(AbstractModel):
    """
    Request entity for DeleteIndexRequest operation.
    ...
    def __init__(self, log_store_name, project=None):
        """
        Initialize DeleteIndexRequest request entity.
