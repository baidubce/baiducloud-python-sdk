"""
Request entity for ListAlarmExecutionsRequest information.
"""

from baiducloud_python_sdk_core.abstract_model import AbstractModel


class ListAlarmExecutionsRequest(AbstractModel):
    """
    Request entity for ListAlarmExecutionsRequest operation.
    ...
    def __init__(
        ...
        """
        Initialize ListAlarmExecutionsRequest request entity.
        ...
        :param order_by: 排序字段，@timestamp: 执行时间， 默认值：@timestamp
    ...
    def from_dict(self, m):
        ...
        :rtype: ListAlarmExecutionsRequest
