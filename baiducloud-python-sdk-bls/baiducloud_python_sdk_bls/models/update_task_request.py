"""
Request entity for UpdateTaskRequest information.
"""
...
class UpdateTaskRequest(AbstractModel):
    """
    Request entity for UpdateTaskRequest operation.

    This class encapsulates all parameters for the API request.
    """

    def __init__(self, task_id, name, config, hosts, tags=None):
        """
        Initialize UpdateTaskRequest request entity.
