"""
Request entity for UpdateLogStoreTemplateRequest information.
"""
...
class UpdateLogStoreTemplateRequest(AbstractModel):
    """
    Request entity for UpdateLogStoreTemplateRequest operation.
    ...
    def __init__(self, name, project_patterns, logstore_patterns, priority, template=None):
        """
        Initialize UpdateLogStoreTemplateRequest request entity.
    ...
    def from_dict(self, m):
        ...
        :rtype: UpdateLogStoreTemplateRequest
