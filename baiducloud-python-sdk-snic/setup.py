...
with io.open(os.path.join("baiducloud_python_sdk_snic", "__init__.py"), "rt") as f:
...
setup(
    ...
    version=SDK_VERSION,
    description='Baidu Cloud snicApi SDK Library for Python',
    ...
    project_urls={
        ...
        'Changelog': (
            'https://github.com/baidubce/baiducloud-python-sdk/blob/master/baiducloud-python-sdk-snic/ChangeLog.md'
        ),
    },
)
