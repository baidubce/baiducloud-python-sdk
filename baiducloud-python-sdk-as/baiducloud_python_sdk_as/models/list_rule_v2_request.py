"""
Request entity for ListRuleV2Request information.
"""

from baiducloud_python_sdk_core.abstract_model import AbstractModel


class ListRuleV2Request(AbstractModel):
    """
    Request entity for ListRuleV2Request operation.
    ...
    def __init__(self, groupid, page_no, page_size, keyword=None, keyword_type=None, order=None, order_by=None):
        """
        Initialize ListRuleV2Request request entity.
