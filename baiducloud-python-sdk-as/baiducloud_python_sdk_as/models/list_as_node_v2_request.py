"""
Request entity for ListAsNodeV2Request information.
"""

from baiducloud_python_sdk_core.abstract_model import AbstractModel


class ListAsNodeV2Request(AbstractModel):
    """
    Request entity for ListAsNodeV2Request operation.

    This class encapsulates all parameters for the API request.
    """

    def __init__(self, groupid, page_no, page_size, keyword=None, keyword_type=None, order=None, order_by=None):
        """
        Initialize ListAsNodeV2Request request entity.
