"""
Request entity for ListRuleV2Response information.
"""

from baiducloud_python_sdk_core.bce_response import BceResponse
from baiducloud_python_sdk_as.models.rule import Rule


class ListRuleV2Response(BceResponse):
    """
    ListRuleV2Response
    """
    ...
    def __init__(self, order_by=None, order=None, page_no=None, page_size=None, total_count=None, result=None):
        """
        Initialize ListRuleV2Response response.
        ...
        :param result: 查询结果
        :type result: List[Rule] (optional)
        """
        super().__init__()
    ...
    def from_dict(self, m):
        ...
        if m.get('result') is not None:
            self.result = [Rule().from_dict(i) for i in m.get('result')]
        return self
