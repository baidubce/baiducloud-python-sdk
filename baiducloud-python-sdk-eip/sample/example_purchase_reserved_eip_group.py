"""
Example for eip purchase_reserved_eip_group method.
"""
...
if __name__ == '__main__':
    try:
        ...
        request = eip_models.PurchaseReservedEipGroupRequest(id="", billing=billing, client_token="")
        res = client.purchase_reserved_eip_group(request)
