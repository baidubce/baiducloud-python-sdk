...
from baiducloud_python_sdk_eip.models.restore_eip_in_recycle_bin_request import RestoreEipInRecycleBinRequest
...
if __name__ == '__main__':
    try:
        ...
        request = RestoreEipInRecycleBinRequest(
            eip = "", 
            client_token = ""
        )
        res = EipClient.restore_eip_in_recycle_bin(request)
