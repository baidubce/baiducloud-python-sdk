...
from baiducloud_python_sdk_eip.models.enable_eip_direct_access_request import EnableEipDirectAccessRequest
...
if __name__ == '__main__':
    try:
        ...
        request = EnableEipDirectAccessRequest(
            eip = "", 
            client_token = ""
        )
        res = EipClient.enable_eip_direct_access(request)
