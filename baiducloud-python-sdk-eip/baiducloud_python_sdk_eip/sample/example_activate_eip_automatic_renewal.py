...
from baiducloud_python_sdk_eip.models.activate_eip_automatic_renewal_request import ActivateEipAutomaticRenewalRequest
...
if __name__ == '__main__':
    try:
        ...
        request = ActivateEipAutomaticRenewalRequest(
            client_token = "", 
            eip = "", 
            auto_renew_time_unit = "", 
            auto_renew_time = 0
        )
        res = EipClient.activate_eip_automatic_renewal(request)
