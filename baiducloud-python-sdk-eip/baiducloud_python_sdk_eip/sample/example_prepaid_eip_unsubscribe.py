...
from baiducloud_python_sdk_eip.models.prepaid_eip_unsubscribe_request import PrepaidEipUnsubscribeRequest
...
if __name__ == '__main__':
    try:
        ...
        request = PrepaidEipUnsubscribeRequest(
            eip = "", 
            client_token = ""
        )
        res = EipClient.prepaid_eip_unsubscribe(request)
