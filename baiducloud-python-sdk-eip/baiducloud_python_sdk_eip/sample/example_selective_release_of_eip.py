...
from baiducloud_python_sdk_eip.models.selective_release_of_eip_request import SelectiveReleaseOfEipRequest
...
if __name__ == '__main__':
    try:
        ...
        request = SelectiveReleaseOfEipRequest(
            eip = "", 
            release_to_recycle = False, 
            client_token = ""
        )
        res = EipClient.selective_release_of_eip(request)
