...
from baiducloud_python_sdk_eip.models.update_eip_delete_protect_request import UpdateEipDeleteProtectRequest
...
if __name__ == '__main__':
    try:
        ...
        request = UpdateEipDeleteProtectRequest(
            eip = "", 
            delete_protect = False, 
            client_token = ""
        )
        res = EipClient.update_eip_delete_protect(request)
