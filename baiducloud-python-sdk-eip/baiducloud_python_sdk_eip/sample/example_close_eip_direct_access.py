...
from baiducloud_python_sdk_eip.models.close_eip_direct_access_request import CloseEipDirectAccessRequest
...
if __name__ == '__main__':
    try:
        ...
        request = CloseEipDirectAccessRequest(
            eip = "", 
            client_token = ""
        )
        res = EipClient.close_eip_direct_access(request)
