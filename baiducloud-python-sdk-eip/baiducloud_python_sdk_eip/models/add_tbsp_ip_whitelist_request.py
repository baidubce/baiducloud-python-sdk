"""
Request entity for AddTbspIpWhitelistRequest information.
"""
...
class AddTbspIpWhitelistRequest(AbstractModel):
    """
    Request entity for AddTbspIpWhitelistRequest operation.
    ...
    def __init__(self, id, client_token=None, ip=None, ip_cidr_list=None):
        """
        Initialize AddTbspIpWhitelistRequest request entity.
        ...
        :param ip_cidr_list: IP白名单网段列表 (完整IP地址格式或IP网段格式)
        :type ip_cidr_list: List[str] (optional)
        """
        super().__init__()
        self.id = id
    ...
    def from_dict(self, m):
        ...
        :rtype: AddTbspIpWhitelistRequest
