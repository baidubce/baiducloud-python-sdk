"""
Request entity for ReleaseEipRequest information.
"""

from baiducloud_python_sdk_core.abstract_model import AbstractModel


class ReleaseEipRequest(AbstractModel):
    """
    Request entity for ReleaseEipRequest operation.
    ...
    def __init__(self, eip, release_to_recycle=None, client_token=None):
        """
        Initialize ReleaseEipRequest request entity.
