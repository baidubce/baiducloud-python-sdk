"""
Request entity for ListRecycleEipsResponse information.
"""
...
class ListRecycleEipsResponse(BceResponse):
    ...
    def __init__(self, eip_list=None, marker=None, is_truncated=None, next_marker=None, max_keys=None):
        """
        Initialize ListRecycleEipsResponse response.

        :param eip_list: 包含查询结果的列表。
        :type eip_list: List[RecycleEipModel] (optional)
    ...
    def from_dict(self, m):
        ...
        if m.get('eipList') is not None:
            self.eip_list = [RecycleEipModel().from_dict(i) for i in m.get('eipList')]
