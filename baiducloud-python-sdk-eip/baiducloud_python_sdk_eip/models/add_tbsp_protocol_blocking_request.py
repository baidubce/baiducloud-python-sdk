"""
Request entity for AddTbspProtocolBlockingRequest information.
"""
...
class AddTbspProtocolBlockingRequest(AbstractModel):
    """
    Request entity for AddTbspProtocolBlockingRequest operation.
    ...
    def __init__(self, id, client_token=None, ip=None, protocol_port_list=None):
        """
        Initialize AddTbspProtocolBlockingRequest request entity.
        ...
        :param protocol_port_list: 协议封禁端口列表
    ...
    def from_dict(self, m):
        ...
        :rtype: AddTbspProtocolBlockingRequest
