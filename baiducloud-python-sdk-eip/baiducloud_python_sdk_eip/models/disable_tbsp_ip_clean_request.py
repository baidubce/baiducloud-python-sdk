"""
Request entity for DisableTbspIpCleanRequest information.
"""
...
class DisableTbspIpCleanRequest(AbstractModel):
    """
    Request entity for DisableTbspIpCleanRequest operation.
    ...
    def __init__(self, id, client_token=None, ip=None, turn_off_duration=None):
        """
        Initialize DisableTbspIpCleanRequest request entity.
        ...
        :param turn_off_duration: 防护对象IP关闭清洗时长 (单位: 分钟)，最小值为30，最大值为7200
        :type turn_off_duration: int (optional)
        """
        super().__init__()
        self.id = id
    ...
    def from_dict(self, m):
        ...
        :rtype: DisableTbspIpCleanRequest
