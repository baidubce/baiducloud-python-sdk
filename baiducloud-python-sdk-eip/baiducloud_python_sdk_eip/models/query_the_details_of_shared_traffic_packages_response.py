"""
Request entity for QueryTheDetailsOfSharedTrafficPackagesResponse information.
"""

from baiducloud_python_sdk_core.bce_response import BceResponse


class QueryTheDetailsOfSharedTrafficPackagesResponse(BceResponse):
    """
    ...
    def __init__(
        ...
        """
        Initialize QueryTheDetailsOfSharedTrafficPackagesResponse response.

        :param id: 共享流量包id
        :type id: str (optional)

        :param deduct_policy: deduct_policy field
