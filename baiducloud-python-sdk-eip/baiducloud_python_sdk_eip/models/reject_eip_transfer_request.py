"""
Request entity for RejectEipTransferRequest information.
"""

from baiducloud_python_sdk_core.abstract_model import AbstractModel


class RejectEipTransferRequest(AbstractModel):
    """
    Request entity for RejectEipTransferRequest operation.
    ...
    def __init__(self, transfer_id_list, client_token=None):
        """
        Initialize RejectEipTransferRequest request entity.
    ...
    def from_dict(self, m):
        ...
        :rtype: RejectEipTransferRequest
