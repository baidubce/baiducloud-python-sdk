"""
Request entity for GetEipBpResponse information.
"""

from baiducloud_python_sdk_core.bce_response import BceResponse


class GetEipBpResponse(BceResponse):
    """
    GetEipBpResponse
    """
    ...
    def __init__(
        ...
        instance_id=None,
        eips=None,
        instance_bandwidth_in_mbps=None,
        create_time=None,
        ...
        """
        Initialize GetEipBpResponse response.
        ...
        :param eips: eips field
        :type eips: List[str] (optional)

        :param instance_bandwidth_in_mbps: instance_bandwidth_in_mbps field
        :type instance_bandwidth_in_mbps: int (optional)

        :param create_time: 带宽包创建时间
        :type create_time: str (optional)

        :param auto_release_time: 带宽包自动释放时间,若未设置则同所绑定资源的到期时间一致
        ...
        self.eips = eips
        self.instance_bandwidth_in_mbps = instance_bandwidth_in_mbps
    ...
    def to_dict(self):
        ...
        if self.instance_bandwidth_in_mbps is not None:
            result['instanceBandwidthInMbps'] = self.instance_bandwidth_in_mbps
    ...
    def from_dict(self, m):
        ...
        if m.get('instanceBandwidthInMbps') is not None:
            self.instance_bandwidth_in_mbps = m.get('instanceBandwidthInMbps')
