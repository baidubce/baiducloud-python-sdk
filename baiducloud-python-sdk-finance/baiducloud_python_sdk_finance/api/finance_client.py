...
from baiducloud_python_sdk_finance.models.get_renew_resource_list_response import GetRenewResourceListResponse

_logger = logging.getLogger(__name__)


class FinanceClient(BceBaseClient):
    """
    finance base sdk client
    """
    ...
    def create_renew_resource_rule(self, request, config=None):
        """
        create_renew_resource_rule

        :param request: Request entity containing all parameters
        :type request: FinanceClientRequest
        ...
        path = utils.append_uri(
            FinanceClient.VERSION_V1,
            FinanceClient.CONSTANT_RENEW,
            FinanceClient.CONSTANT_RESOURCE,
            FinanceClient.CONSTANT_RULE,
            FinanceClient.CONSTANT_CREATE,
        )
        headers = None
        merged_config = self._create_request_with_host(request, config)
        return self._send_request(http_methods.POST, path=path, body=request.to_json_string(), config=merged_config)

    def get_renew_resource_list(self, request, config=None):
        """
        get_renew_resource_list
        ...
        :return: API response containing GetRenewResourceListResponse data
        ...
        return self._send_request(
            ...
            model=GetRenewResourceListResponse,
        )
