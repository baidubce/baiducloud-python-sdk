"""
Example for vdb password_using_get method.
"""
...
if __name__ == '__main__':
    try:
        ...
        request = vdb_models.PasswordUsingGetRequest(instance_id="", username="", engine_type="")
        res = client.password_using_get(request)
