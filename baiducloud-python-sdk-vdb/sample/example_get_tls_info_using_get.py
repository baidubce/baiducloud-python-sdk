"""
Example for vdb get_tls_info_using_get method.
"""
...
if __name__ == '__main__':
    try:
        ...
        request = vdb_models.GetTlsInfoUsingGetRequest(instance_id="", engine_type="")
        res = client.get_tls_info_using_get(request)
