"""
Example for vdb getinstancelistusingget1 method.
"""
...
if __name__ == '__main__':
    try:
        ...
        request = vdb_models.Getinstancelistusingget1Request(engine_type="")
        res = client.getinstancelistusingget1(request)
