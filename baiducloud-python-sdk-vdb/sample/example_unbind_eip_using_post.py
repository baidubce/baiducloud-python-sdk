"""
Example for vdb unbind_eip_using_post method.
"""
...
if __name__ == '__main__':
    try:
        ...
        request = vdb_models.UnbindEipUsingPostRequest(instance_id="", engine_type="")
        res = client.unbind_eip_using_post(request)
