"""
Example for vdb describe_instance_configs method.
"""
...
if __name__ == '__main__':
    try:
        ...
        request = vdb_models.DescribeInstanceConfigsRequest(instance_id="")
        res = client.describe_instance_configs(request)
