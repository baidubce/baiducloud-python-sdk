"""
Example for vdb bind_eip_using_post method.
"""
...
if __name__ == '__main__':
    try:
        ...
        request = vdb_models.BindEipUsingPOSTRequest(instance_id="", engine_type="", eip="")
        res = client.bind_eip_using_post(request)
