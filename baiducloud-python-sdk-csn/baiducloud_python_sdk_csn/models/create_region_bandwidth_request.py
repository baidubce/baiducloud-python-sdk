"""
Request entity for CreateRegionBandwidthRequest information.
"""

from baiducloud_python_sdk_core.abstract_model import AbstractModel


class CreateRegionBandwidthRequest(AbstractModel):
    """
    Request entity for CreateRegionBandwidthRequest operation.
    ...
    def __init__(self, csn_bp_id, local_region, peer_region, bandwidth, client_token=None):
        """
        Initialize CreateRegionBandwidthRequest request entity.
    ...
    def from_dict(self, m):
        ...
        :rtype: CreateRegionBandwidthRequest
