"""
Request entity for DeleteRegionBandwidthRequest information.
"""

from baiducloud_python_sdk_core.abstract_model import AbstractModel


class DeleteRegionBandwidthRequest(AbstractModel):
    """
    Request entity for DeleteRegionBandwidthRequest operation.

    This class encapsulates all parameters for the API request.
    """

    def __init__(self, csn_bp_id, local_region, peer_region, client_token=None):
        """
        Initialize DeleteRegionBandwidthRequest request entity.
        ...
        :param local_region: 地域带宽的本端region
        :type local_region: str (required)

        :param peer_region: 地域带宽的对端region
    ...
    def from_dict(self, m):
        ...
        :rtype: DeleteRegionBandwidthRequest
