"""
CsnRtPropagation information
"""

from baiducloud_python_sdk_core.abstract_model import AbstractModel


class CsnRtPropagation(AbstractModel):
    """
    CsnRtPropagation
    """
    ...
    def __init__(
        ...
        """
        Initialize CsnRtPropagation instance.

        :param attach_id: 网络实例在云智能网中的身份ID
        :type attach_id: str (optional)

        :param description: 学习关系的描述信息
