"""
Request entity for QueryCsnBpDetailResponse information.
"""
...
class QueryCsnBpDetailResponse(BceResponse):
    """
    ...
    def __init__(
        ...
        """
        Initialize QueryCsnBpDetailResponse response.
        ...
        :param interwork_type: interwork_type field
        :type interwork_type: str (optional)

        :param interwork_region: interwork_region field
        ...
        :param expire_time: 带宽包预付费的到期时间
        :type expire_time: str (optional)

        :param created_time: 带宽包的创建时间
