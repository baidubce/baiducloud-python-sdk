"""
Request entity for CreateStudyRelationRequest information.
"""

from baiducloud_python_sdk_core.abstract_model import AbstractModel


class CreateStudyRelationRequest(AbstractModel):
    """
    Request entity for CreateStudyRelationRequest operation.
    ...
    def __init__(self, csn_rt_id, attach_id, client_token=None, description=None):
        """
        Initialize CreateStudyRelationRequest request entity.
    ...
    def from_dict(self, m):
        ...
        :rtype: CreateStudyRelationRequest
