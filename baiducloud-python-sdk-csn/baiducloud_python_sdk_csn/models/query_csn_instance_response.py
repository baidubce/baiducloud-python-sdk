"""
Request entity for QueryCsnInstanceResponse information.
"""

from baiducloud_python_sdk_core.bce_response import BceResponse
from baiducloud_python_sdk_csn.models.instance import Instance


class QueryCsnInstanceResponse(BceResponse):
    """
    QueryCsnInstanceResponse
    """

    def __init__(self, instances=None, marker=None, is_truncated=None, next_marker=None, max_keys=None):
        """
        Initialize QueryCsnInstanceResponse response.

        :param instances: 网络实例列表
