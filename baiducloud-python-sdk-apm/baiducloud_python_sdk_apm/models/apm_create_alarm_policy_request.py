"""
Request entity for ApmCreateAlarmPolicyRequest information.
"""
...
class ApmCreateAlarmPolicyRequest(AbstractModel):
    """
    Request entity for ApmCreateAlarmPolicyRequest operation.
    ...
    def __init__(
        ...
        """
        Initialize ApmCreateAlarmPolicyRequest request entity.

        :param name: 报警策略名称
        :type name: str (required)

        :param state: 策略状态，可选值：ENABLED-启动，DISABLED-禁用
    ...
    def from_dict(self, m):
        ...
        :rtype: ApmCreateAlarmPolicyRequest
