"""
Request entity for DescribeServicesNamesRequest information.
"""
...
class DescribeServicesNamesRequest(AbstractModel):
    """
    Request entity for DescribeServicesNamesRequest operation.
    ...
    def __init__(
        ...
        """
        Initialize DescribeServicesNamesRequest request entity.
        ...
        :param service_name: 按应用名过滤，若未设置，返回所有应用
        :type service_name: str (optional)

        :param service_id: 按应用ID过滤
        :type service_id: str (optional)

        :param language: 按语言过滤，若未设置，返回所有语言
        :type language: str (optional)

        :param env: 按env过滤，若未设置，返回所有env的应用
        :type env: str (optional)

        :param source: 按应用来源过滤，可选项：APP_BUILDER（千帆AppBuilder）
        ...
        :param order: 排序方式，可选项：desc、asc
        :type order: str (required)
    ...
    def from_dict(self, m):
        ...
        :rtype: DescribeServicesNamesRequest
