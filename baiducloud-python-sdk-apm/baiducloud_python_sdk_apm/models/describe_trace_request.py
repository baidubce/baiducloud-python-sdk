"""
Request entity for DescribeTraceRequest information.
"""
...
class DescribeTraceRequest(AbstractModel):
    """
    Request entity for DescribeTraceRequest operation.
    ...
    def __init__(
        ...
        """
        Initialize DescribeTraceRequest request entity.

        :param action: action parameter
        :type action: str (required)

        :param span_datetime: span_datetime parameter
        :type span_datetime: str (optional)

        :param begin_datetime: 开始时间，UTC时间。与spanDatetime必填其一
        :type begin_datetime: str (optional)

        :param end_datetime: 结束时间，UTC时间。与spanDatetime必填其一
        ...
        super().__init__()
        self.action = action
        self.span_datetime = span_datetime
    ...
    def to_dict(self):
        ...
        if _map is not None:
            return _map
        result = dict()
        if self.span_datetime is not None:
            result['spanDatetime'] = self.span_datetime
    ...
    def from_dict(self, m):
        ...
        if m.get('spanDatetime') is not None:
            self.span_datetime = m.get('spanDatetime')
