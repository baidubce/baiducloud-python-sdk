"""
Request entity for DescribeLLMSpansResponse information.
"""
...
class DescribeLLMSpansResponse(BceResponse):
    """
    DescribeLLMSpansResponse
    """

    def __init__(self, success=None, code=None, message=None, spans=None, next_marker=None, is_truncated=None):
        """
        Initialize DescribeLLMSpansResponse response.
        ...
        :param spans: Span列表
        :type spans: List[LLMSpan] (optional)
    ...
    def from_dict(self, m):
        ...
        if m.get('spans') is not None:
            self.spans = [LLMSpan().from_dict(i) for i in m.get('spans')]
