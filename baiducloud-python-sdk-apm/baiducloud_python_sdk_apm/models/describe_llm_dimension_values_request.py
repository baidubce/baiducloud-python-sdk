"""
Request entity for DescribeLLMDimensionValuesRequest information.
"""
...
class DescribeLLMDimensionValuesRequest(AbstractModel):
    """
    Request entity for DescribeLLMDimensionValuesRequest operation.

    This class encapsulates all parameters for the API request.
    """

    def __init__(self, begin_datetime, end_datetime, key, filters=None):
        """
        Initialize DescribeLLMDimensionValuesRequest request entity.
        ...
        :param filters: 过滤项列表，仅支持service(应用名称)过滤
    ...
    def from_dict(self, m):
        ...
        :rtype: DescribeLLMDimensionValuesRequest
