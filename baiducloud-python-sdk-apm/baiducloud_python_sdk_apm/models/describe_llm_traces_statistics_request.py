"""
Request entity for DescribeLLMTracesStatisticsRequest information.
"""
...
class DescribeLLMTracesStatisticsRequest(AbstractModel):
    """
    Request entity for DescribeLLMTracesStatisticsRequest operation.
    ...
    def __init__(self, begin_datetime, end_datetime, filters=None):
        """
        Initialize DescribeLLMTracesStatisticsRequest request entity.
    ...
    def from_dict(self, m):
        ...
        :rtype: DescribeLLMTracesStatisticsRequest
