"""
Example for apm describe_dimension_values method.
"""
...
if __name__ == '__main__':
    try:
        ...
        request = apm_models.DescribeDimensionValuesRequest(
            action="", begin_datetime="", end_datetime="", dimension_key="", filters=[]
        )
