"""
Example for cloudassistant get_action_run method.
"""
...
if __name__ == '__main__':
    try:
        ...
        request = cloudassistant_models.GetActionRunRequest(
            id="", with_log="", page_no=0, page_size=0, child_run_state="", locale=""
        )
        res = client.get_action_run(request)
