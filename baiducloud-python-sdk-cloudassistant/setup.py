...
with io.open(os.path.join("baiducloud_python_sdk_cloudassistant", "__init__.py"), "rt") as f:
...
setup(
    ...
    version=SDK_VERSION,
    description='Baidu Cloud cloudassistantApi SDK Library for Python',
    ...
    keywords=["baiducloud", "cloudassistant"],
    ...
    project_urls={
        ...
        'Changelog': (
            ...
            'baiducloud-python-sdk-cloudassistant/ChangeLog.md'
        ),
    },
)
