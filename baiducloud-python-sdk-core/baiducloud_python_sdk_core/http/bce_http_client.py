...
from baiducloud_python_sdk_core.exception import BceHttpClientError
...
def _get_connection(protocol, host, port, connection_timeout_in_millis, proxy_host=None, proxy_port=None):
    """
    :param protocol
    :type protocol: baiducloud_python_sdk_core.protocol.Protocol
    :param endpoint
    :type endpoint: str
    ...
    if protocol.name == baiducloud_python_sdk_core.protocol.HTTP.name:
    ...
    elif protocol.name == baiducloud_python_sdk_core.protocol.HTTPS.name:
        if proxy_host and proxy_port:
...
def send_request(
        ...
        http_method, path, body, headers, params, use_backup_endpoint=False, model=None):
    """
    ...
    :param request:
    :type request: baiducloud_python_sdk_core.internal.InternalRequest

    :return:
    :rtype: baiducloud_python_sdk_core.BceResponse
    """
    ...
    while True:
        ...
        try:
            ...
            response = model() if model is not None else BceResponse()
