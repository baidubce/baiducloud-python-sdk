...
with io.open(os.path.join("baiducloud_python_sdk_agentidentity", "__init__.py"), "rt") as f:
...
setup(
    name='baiducloud-python-sdk-agentidentity',
    version=SDK_VERSION,
    description='Baidu Cloud agentidentityApi SDK Library for Python',
    ...
    keywords=["baiducloud", "agentidentity"],
    ...
    project_urls={
        ...
        'Changelog': (
            ...
            'baiducloud-python-sdk-agentidentity/ChangeLog.md'
        ),
    },
)
