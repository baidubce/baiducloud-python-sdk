"""
Request entity for QueryAclRulesResponse information.
"""
...
class QueryAclRulesResponse(BceResponse):
    """
    QueryAclRulesResponse
    """

    def __init__(self, marker=None, is_truncated=None, next_marker=None, max_keys=None, acl_rules=None):
        """
        Initialize QueryAclRulesResponse response.
