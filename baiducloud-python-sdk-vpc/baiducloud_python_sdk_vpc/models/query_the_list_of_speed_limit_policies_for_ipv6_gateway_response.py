"""
Request entity for QueryTheListOfSpeedLimitPoliciesForIpv6GatewayResponse information.
"""
...
class QueryTheListOfSpeedLimitPoliciesForIpv6GatewayResponse(BceResponse):
    """
    QueryTheListOfSpeedLimitPoliciesForIpv6GatewayResponse
    """

    def __init__(self, rate_limit_rules=None, marker=None, is_truncated=None, next_marker=None, max_keys=None):
        """
        Initialize QueryTheListOfSpeedLimitPoliciesForIpv6GatewayResponse response.

        :param rate_limit_rules: IPv6网关的限速规则列表
