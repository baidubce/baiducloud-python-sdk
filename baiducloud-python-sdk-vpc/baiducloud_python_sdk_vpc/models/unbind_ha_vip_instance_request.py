"""
Request entity for UnbindHaVipInstanceRequest information.
"""

from baiducloud_python_sdk_core.abstract_model import AbstractModel


class UnbindHaVipInstanceRequest(AbstractModel):
    """
    Request entity for UnbindHaVipInstanceRequest operation.
    ...
    def __init__(self, ha_vip_id, instance_ids, instance_type, client_token=None):
        """
        Initialize UnbindHaVipInstanceRequest request entity.
    ...
    def from_dict(self, m):
        ...
        :rtype: UnbindHaVipInstanceRequest
