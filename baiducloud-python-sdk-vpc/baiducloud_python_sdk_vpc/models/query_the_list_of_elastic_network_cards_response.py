"""
Request entity for QueryTheListOfElasticNetworkCardsResponse information.
"""

from baiducloud_python_sdk_core.bce_response import BceResponse
from baiducloud_python_sdk_vpc.models.eni import Eni


class QueryTheListOfElasticNetworkCardsResponse(BceResponse):
    """
    QueryTheListOfElasticNetworkCardsResponse
    """

    def __init__(self, enis=None, marker=None, is_truncated=None, next_marker=None, max_keys=None):
        """
        Initialize QueryTheListOfElasticNetworkCardsResponse response.

        :param enis: 弹性网卡列表
        :type enis: List[Eni] (optional)
    ...
    def from_dict(self, m):
        ...
        if m.get('enis') is not None:
            self.enis = [Eni().from_dict(i) for i in m.get('enis')]
