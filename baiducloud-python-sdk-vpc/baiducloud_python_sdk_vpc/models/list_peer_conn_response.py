...
class ListPeerConnResponse(BceResponse):
    ...
    def to_dict(self):
        ...
        if self.peer_conns is not None:
            result['peerConns'] = [i.to_dict() for i in self.peer_conns]
    ...
    def from_dict(self, m):
        ...
        """
        m = m or dict()
        if m.get('peerConns') is not None:
            self.peer_conns = [PeerConn().from_dict(i) for i in m.get('peerConns')]
