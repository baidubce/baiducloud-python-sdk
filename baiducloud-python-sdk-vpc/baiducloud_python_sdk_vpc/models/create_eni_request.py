"""
Request entity for CreateEniRequest information.
"""
...
class CreateEniRequest(AbstractModel):
    """
    Request entity for CreateEniRequest operation.
    ...
    def __init__(
        ...
        """
        Initialize CreateEniRequest request entity.
