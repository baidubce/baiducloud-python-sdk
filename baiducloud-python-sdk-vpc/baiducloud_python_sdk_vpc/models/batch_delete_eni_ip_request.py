"""
Request entity for BatchDeleteEniIpRequest information.
"""

from baiducloud_python_sdk_core.abstract_model import AbstractModel


class BatchDeleteEniIpRequest(AbstractModel):
    """
    Request entity for BatchDeleteEniIpRequest operation.
    ...
    def __init__(self, eni_id, private_ip_addresses, client_token=None):
        """
        Initialize BatchDeleteEniIpRequest request entity.
