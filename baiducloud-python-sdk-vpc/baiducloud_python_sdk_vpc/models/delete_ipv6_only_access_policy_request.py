"""
Request entity for DeleteIpv6OnlyAccessPolicyRequest information.
"""

from baiducloud_python_sdk_core.abstract_model import AbstractModel


class DeleteIpv6OnlyAccessPolicyRequest(AbstractModel):
    """
    Request entity for DeleteIpv6OnlyAccessPolicyRequest operation.
    ...
    def __init__(self, gateway_id, egress_only_rule_id, client_token=None):
        """
        Initialize DeleteIpv6OnlyAccessPolicyRequest request entity.
    ...
    def from_dict(self, m):
        ...
        :rtype: DeleteIpv6OnlyAccessPolicyRequest
