"""
Request entity for CreateIpGroupRequest information.
"""
...
class CreateIpGroupRequest(AbstractModel):
    """
    Request entity for CreateIpGroupRequest operation.
    ...
    def __init__(self, name, ip_version, ip_address_info, client_token=None, description=None):
        """
        Initialize CreateIpGroupRequest request entity.
