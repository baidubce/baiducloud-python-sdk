"""
Request entity for UpdateNetworkDetectionRequest information.
"""

from baiducloud_python_sdk_core.abstract_model import AbstractModel


class UpdateNetworkDetectionRequest(AbstractModel):
    """
    Request entity for UpdateNetworkDetectionRequest operation.
    ...
    def __init__(self, probe_id, client_token=None, name=None, description=None, dest_ip=None, dest_port=None):
        """
        Initialize UpdateNetworkDetectionRequest request entity.
    ...
    def from_dict(self, m):
        ...
        :rtype: UpdateNetworkDetectionRequest
