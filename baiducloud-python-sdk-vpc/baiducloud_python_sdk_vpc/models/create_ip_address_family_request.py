"""
Request entity for CreateIpAddressFamilyRequest information.
"""

from baiducloud_python_sdk_core.abstract_model import AbstractModel


class CreateIpAddressFamilyRequest(AbstractModel):
    """
    Request entity for CreateIpAddressFamilyRequest operation.
    ...
    def __init__(self, name, ip_version, ip_set_ids, client_token=None, description=None):
        """
        Initialize CreateIpAddressFamilyRequest request entity.
    ...
    def from_dict(self, m):
        ...
        :rtype: CreateIpAddressFamilyRequest
