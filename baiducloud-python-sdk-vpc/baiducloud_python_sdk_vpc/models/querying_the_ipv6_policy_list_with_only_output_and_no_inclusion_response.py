"""
Request entity for QueryingTheIpv6PolicyListWithOnlyOutputAndNoInclusionResponse information.
"""
...
class QueryingTheIpv6PolicyListWithOnlyOutputAndNoInclusionResponse(BceResponse):
    """
    QueryingTheIpv6PolicyListWithOnlyOutputAndNoInclusionResponse
    """

    def __init__(self, egress_only_rules=None, marker=None, is_truncated=None, next_marker=None, max_keys=None):
        """
        Initialize QueryingTheIpv6PolicyListWithOnlyOutputAndNoInclusionResponse response.

        :param egress_only_rules: 包含查询结果的列表
