"""
Request entity for QuerySecurityGroupsListResponse information.
"""
...
class QuerySecurityGroupsListResponse(BceResponse):
    """
    ...
    def __init__(self, marker=None, is_truncated=None, next_marker=None, max_keys=None, security_groups=None):
        """
        Initialize QuerySecurityGroupsListResponse response.
