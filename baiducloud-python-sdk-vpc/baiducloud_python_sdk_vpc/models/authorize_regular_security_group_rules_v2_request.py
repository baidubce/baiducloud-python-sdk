"""
Request entity for AuthorizeRegularSecurityGroupRulesV2Request information.
"""
...
class AuthorizeRegularSecurityGroupRulesV2Request(AbstractModel):
    """
    Request entity for AuthorizeRegularSecurityGroupRulesV2Request operation.
    ...
    def __init__(self, security_group_id, rule, sg_version=None, client_token=None):
        """
        Initialize AuthorizeRegularSecurityGroupRulesV2Request request entity.
    ...
    def from_dict(self, m):
        ...
        :rtype: AuthorizeRegularSecurityGroupRulesV2Request
