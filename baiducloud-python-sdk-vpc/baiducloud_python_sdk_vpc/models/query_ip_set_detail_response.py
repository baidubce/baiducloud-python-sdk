"""
Request entity for QueryIpSetDetailResponse information.
"""
...
class QueryIpSetDetailResponse(BceResponse):
    """
    QueryIpSetDetailResponse
    """
    ...
    def __init__(
        ...
        """
        Initialize QueryIpSetDetailResponse response.
