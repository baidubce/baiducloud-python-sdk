"""
Request entity for BindHaVipEipRequest information.
"""

from baiducloud_python_sdk_core.abstract_model import AbstractModel


class BindHaVipEipRequest(AbstractModel):
    """
    Request entity for BindHaVipEipRequest operation.
    ...
    def __init__(self, ha_vip_id, public_ip_address, client_token=None):
        """
        Initialize BindHaVipEipRequest request entity.
