"""
Request entity for RevokeRegularSecurityGroupRulesV2Request information.
"""
...
class RevokeRegularSecurityGroupRulesV2Request(AbstractModel):
    """
    Request entity for RevokeRegularSecurityGroupRulesV2Request operation.

    This class encapsulates all parameters for the API request.
    """

    def __init__(self, security_group_id, rule, client_token=None, sg_version=None):
        """
        Initialize RevokeRegularSecurityGroupRulesV2Request request entity.
    ...
    def from_dict(self, m):
        ...
        :rtype: RevokeRegularSecurityGroupRulesV2Request
