"""
Request entity for DeleteRegularSecurityGroupRulesV2Request information.
"""

from baiducloud_python_sdk_core.abstract_model import AbstractModel


class DeleteRegularSecurityGroupRulesV2Request(AbstractModel):
    """
    Request entity for DeleteRegularSecurityGroupRulesV2Request operation.
    ...
    def __init__(self, security_group_rule_id, client_token=None, sg_version=None):
        """
        Initialize DeleteRegularSecurityGroupRulesV2Request request entity.
    ...
    def from_dict(self, m):
        ...
        :rtype: DeleteRegularSecurityGroupRulesV2Request
