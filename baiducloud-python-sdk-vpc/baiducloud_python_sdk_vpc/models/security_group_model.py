...
class SecurityGroupModel(AbstractModel):
    ...
    def __init__(
        self, id=None, name=None, desc=None, vpc_id=None, created_time=None, sg_version=None, rules=None, tags=None
    ):
        """
        ...
        :param vpc_id: 私有网络VPC ID
        :type vpc_id: str (optional)

        :param created_time: 安全组创建时间
