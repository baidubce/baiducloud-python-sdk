"""
Request entity for ElasticNetworkCardUpdateEnterpriseSecurityGroupRequest information.
"""

from baiducloud_python_sdk_core.abstract_model import AbstractModel


class ElasticNetworkCardUpdateEnterpriseSecurityGroupRequest(AbstractModel):
    """
    Request entity for ElasticNetworkCardUpdateEnterpriseSecurityGroupRequest operation.
    ...
    def __init__(self, eni_id, enterprise_security_group_ids, client_token=None):
        """
        Initialize ElasticNetworkCardUpdateEnterpriseSecurityGroupRequest request entity.
    ...
    def from_dict(self, m):
        ...
        :rtype: ElasticNetworkCardUpdateEnterpriseSecurityGroupRequest
