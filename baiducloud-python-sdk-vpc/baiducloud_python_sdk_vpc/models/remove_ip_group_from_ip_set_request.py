"""
Request entity for RemoveIpGroupFromIpSetRequest information.
"""

from baiducloud_python_sdk_core.abstract_model import AbstractModel


class RemoveIpGroupFromIpSetRequest(AbstractModel):
    """
    Request entity for RemoveIpGroupFromIpSetRequest operation.
    ...
    def __init__(self, ip_group_id, ip_set_ids, client_token=None):
        """
        Initialize RemoveIpGroupFromIpSetRequest request entity.
    ...
    def from_dict(self, m):
        ...
        :rtype: RemoveIpGroupFromIpSetRequest
