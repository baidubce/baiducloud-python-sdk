"""
Request entity for RevokeSecurityGroupRulesRequest information.
"""
...
class RevokeSecurityGroupRulesRequest(AbstractModel):
    """
    Request entity for RevokeSecurityGroupRulesRequest operation.
    ...
    def __init__(self, security_group_id, rule, client_token=None, sg_version=None):
        """
        Initialize RevokeSecurityGroupRulesRequest request entity.
    ...
    def from_dict(self, m):
        ...
        :rtype: RevokeSecurityGroupRulesRequest
