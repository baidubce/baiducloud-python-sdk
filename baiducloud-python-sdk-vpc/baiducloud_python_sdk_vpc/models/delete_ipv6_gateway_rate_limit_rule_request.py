"""
Request entity for DeleteIpv6GatewayRateLimitRuleRequest information.
"""

from baiducloud_python_sdk_core.abstract_model import AbstractModel


class DeleteIpv6GatewayRateLimitRuleRequest(AbstractModel):
    """
    Request entity for DeleteIpv6GatewayRateLimitRuleRequest operation.
    ...
    def __init__(self, gateway_id, rate_limit_rule_id, client_token=None):
        """
        Initialize DeleteIpv6GatewayRateLimitRuleRequest request entity.
    ...
    def from_dict(self, m):
        ...
        :rtype: DeleteIpv6GatewayRateLimitRuleRequest
