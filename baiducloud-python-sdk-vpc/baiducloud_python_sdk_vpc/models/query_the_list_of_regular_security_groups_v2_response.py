"""
Request entity for QueryTheListOfRegularSecurityGroupsV2Response information.
"""

from baiducloud_python_sdk_core.bce_response import BceResponse
from baiducloud_python_sdk_vpc.models.security_group_model import SecurityGroupModel


class QueryTheListOfRegularSecurityGroupsV2Response(BceResponse):
    """
    QueryTheListOfRegularSecurityGroupsV2Response
    """

    def __init__(self, marker=None, is_truncated=None, next_marker=None, max_keys=None, security_groups=None):
        """
        Initialize QueryTheListOfRegularSecurityGroupsV2Response response.
        ...
        :param security_groups: 安全组信息，由SecurityGroupModel组成的集合
