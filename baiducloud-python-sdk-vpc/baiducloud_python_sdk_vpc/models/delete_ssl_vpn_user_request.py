"""
Request entity for DeleteSslVpnUserRequest information.
"""
...
class DeleteSslVpnUserRequest(AbstractModel):
    """
    Request entity for DeleteSslVpnUserRequest operation.
    ...
    def __init__(self, vpn_id, user_id, client_token=None):
        """
        Initialize DeleteSslVpnUserRequest request entity.
