"""
Request entity for CreateAHighlyAvailableVirtualIpRequest information.
"""

from baiducloud_python_sdk_core.abstract_model import AbstractModel


class CreateAHighlyAvailableVirtualIpRequest(AbstractModel):
    """
    Request entity for CreateAHighlyAvailableVirtualIpRequest operation.
    ...
    def __init__(self, name, subnet_id, private_ip_address, client_token=None, description=None):
        """
        Initialize CreateAHighlyAvailableVirtualIpRequest request entity.
    ...
    def from_dict(self, m):
        ...
        :rtype: CreateAHighlyAvailableVirtualIpRequest
