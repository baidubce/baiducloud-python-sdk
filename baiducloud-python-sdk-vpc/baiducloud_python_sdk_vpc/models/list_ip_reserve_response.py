"""
Request entity for ListIpReserveResponse information.
"""
...
class ListIpReserveResponse(BceResponse):
    """
    ListIpReserveResponse
    """

    def __init__(self, ip_reserves=None, marker=None, is_truncated=None, next_marker=None, max_keys=None):
        """
        Initialize ListIpReserveResponse response.

        :param ip_reserves: 预留网段列表
        :type ip_reserves: List[IpReserve] (optional)
    ...
    def from_dict(self, m):
        ...
        if m.get('ipReserves') is not None:
            self.ip_reserves = [IpReserve().from_dict(i) for i in m.get('ipReserves')]
