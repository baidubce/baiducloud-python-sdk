"""
Request entity for RemoveIpAddressGroupFromIpAddressFamilyRequest information.
"""

from baiducloud_python_sdk_core.abstract_model import AbstractModel


class RemoveIpAddressGroupFromIpAddressFamilyRequest(AbstractModel):
    """
    Request entity for RemoveIpAddressGroupFromIpAddressFamilyRequest operation.
    ...
    def __init__(self, ip_group_id, ip_set_ids, client_token=None):
        """
        Initialize RemoveIpAddressGroupFromIpAddressFamilyRequest request entity.
        ...
        :param ip_set_ids: 移除的IP地址组ID，单次最多指定5个
    ...
    def from_dict(self, m):
        ...
        :rtype: RemoveIpAddressGroupFromIpAddressFamilyRequest
