"""
Request entity for AuthorizeEnterpriseSecurityGroupRulesRequest information.
"""
...
class AuthorizeEnterpriseSecurityGroupRulesRequest(AbstractModel):
    """
    Request entity for AuthorizeEnterpriseSecurityGroupRulesRequest operation.
    ...
    def __init__(self, enterprise_security_group_id, rules, client_token=None):
        """
        Initialize AuthorizeEnterpriseSecurityGroupRulesRequest request entity.
    ...
    def from_dict(self, m):
        ...
        :rtype: AuthorizeEnterpriseSecurityGroupRulesRequest
