...
from baiducloud_python_sdk_vpc.models.enable_vpc_relay_request import EnableVpcRelayRequest
...
if __name__ == '__main__':
    try:
        ...
        request = EnableVpcRelayRequest(
            vpc_id = "", 
            client_token = ""
        )
        res = VpcClient.enable_vpc_relay(request)
