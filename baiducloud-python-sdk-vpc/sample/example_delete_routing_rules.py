"""
Example for vpc delete_routing_rules method.
"""
...
if __name__ == '__main__':
    try:
        ...
        request = vpc_models.DeleteRoutingRulesRequest(route_rule_id="", client_token="")
        res = client.delete_routing_rules(request)
