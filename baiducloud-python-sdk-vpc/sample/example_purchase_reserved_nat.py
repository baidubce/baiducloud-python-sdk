"""
Example for vpc purchase_reserved_nat method.
"""
...
if __name__ == '__main__':
    try:
        ...
        request = vpc_models.PurchaseReservedNatRequest(nat_id="", billing=billing, client_token="")
        res = client.purchase_reserved_nat(request)
