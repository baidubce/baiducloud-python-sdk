"""
Example for vpc update_ip_group method.
"""
...
if __name__ == '__main__':
    try:
        ...
        request = vpc_models.UpdateIpGroupRequest(ip_set_id="", client_token="", name="", description="")
        res = client.update_ip_group(request)
