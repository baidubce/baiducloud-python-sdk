"""
Example for vpc batch_add_dnat_rules method.
"""
...
if __name__ == '__main__':
    try:
        ...
        request = vpc_models.BatchAddDnatRulesRequest(nat_id="", rules=[], client_token="")
        res = client.batch_add_dnat_rules(request)
