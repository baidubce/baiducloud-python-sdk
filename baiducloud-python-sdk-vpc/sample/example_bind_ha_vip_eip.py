"""
Example for vpc bind_ha_vip_eip method.
"""
...
if __name__ == '__main__':
    try:
        ...
        request = vpc_models.BindHaVipEipRequest(ha_vip_id="", public_ip_address="", client_token="")
        res = client.bind_ha_vip_eip(request)
