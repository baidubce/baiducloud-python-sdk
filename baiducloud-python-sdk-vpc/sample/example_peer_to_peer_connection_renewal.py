"""
Example for vpc peer_to_peer_connection_renewal method.
"""
...
if __name__ == '__main__':
    try:
        ...
        request = vpc_models.PeerToPeerConnectionRenewalRequest(peer_conn_id="", billing=billing, client_token="")
        res = client.peer_to_peer_connection_renewal(request)
