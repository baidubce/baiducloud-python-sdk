"""
Example for vpc query_ip_group_list method.
"""
...
if __name__ == '__main__':
    try:
        ...
        request = vpc_models.QueryIpGroupListRequest(ip_version="", marker="", max_keys=0)
        res = client.query_ip_group_list(request)
