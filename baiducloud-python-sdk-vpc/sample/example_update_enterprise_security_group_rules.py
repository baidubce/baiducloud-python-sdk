"""
Example for vpc update_enterprise_security_group_rules method.
"""
...
if __name__ == '__main__':
    try:
        ...
        request = vpc_models.UpdateEnterpriseSecurityGroupRulesRequest(
        ...
        res = client.update_enterprise_security_group_rules(request)
