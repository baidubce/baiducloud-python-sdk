"""
Request entity for ListPegadbSlowLogsRequest information.
"""

from baiducloud_python_sdk_core.abstract_model import AbstractModel


class ListPegadbSlowLogsRequest(AbstractModel):
    """
    Request entity for ListPegadbSlowLogsRequest operation.
    ...
    def __init__(self, app_id, node_id, start, end, db_engine, page=None, page_size=None, order_by=None, order=None):
        """
        Initialize ListPegadbSlowLogsRequest request entity.
    ...
    def from_dict(self, m):
        ...
        :rtype: ListPegadbSlowLogsRequest
