"""
Request entity for GetMongodbSlowLogTimeDistributionRequest information.
"""

from baiducloud_python_sdk_core.abstract_model import AbstractModel


class GetMongodbSlowLogTimeDistributionRequest(AbstractModel):
    """
    Request entity for GetMongodbSlowLogTimeDistributionRequest operation.
    ...
    def __init__(self, app_id, start, end, node_id=None, db_names=None, fingerprint_md5=None):
        """
        Initialize GetMongodbSlowLogTimeDistributionRequest request entity.
    ...
    def from_dict(self, m):
        ...
        :rtype: GetMongodbSlowLogTimeDistributionRequest
