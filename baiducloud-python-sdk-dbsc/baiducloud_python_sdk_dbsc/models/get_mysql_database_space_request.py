"""
Request entity for GetMysqlDatabaseSpaceRequest information.
"""

from baiducloud_python_sdk_core.abstract_model import AbstractModel


class GetMysqlDatabaseSpaceRequest(AbstractModel):
    """
    Request entity for GetMysqlDatabaseSpaceRequest operation.
    ...
    def __init__(self, app_id, node_id=None, database=None, order_by=None, order=None, page=None, page_size=None):
        """
        Initialize GetMysqlDatabaseSpaceRequest request entity.
    ...
    def from_dict(self, m):
        ...
        :rtype: GetMysqlDatabaseSpaceRequest
