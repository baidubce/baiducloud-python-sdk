"""
Request entity for GetMysqlSpaceSummaryResponse information.
"""

from baiducloud_python_sdk_core.bce_response import BceResponse


class GetMysqlSpaceSummaryResponse(BceResponse):
    """
    GetMysqlSpaceSummaryResponse
    """
    ...
    def __init__(
        ...
        """
        Initialize GetMysqlSpaceSummaryResponse response.

        :param total_disk_size: total_disk_size field
        :type total_disk_size: object (optional)

        :param used_space: 已用空间（字节）
        :type used_space: float (optional)

        :param available_space: 可用空间（字节）
        :type available_space: float (optional)

        :param available_days: 预计可用天数
        :type available_days: float (optional)

        :param day_grow_space_avg: 日均增长空间（字节）
        :type day_grow_space_avg: float (optional)
        """
        super().__init__()
