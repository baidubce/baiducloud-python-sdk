"""
Request entity for GetPegadbSlowLogTimeDistributionRequest information.
"""

from baiducloud_python_sdk_core.abstract_model import AbstractModel


class GetPegadbSlowLogTimeDistributionRequest(AbstractModel):
    """
    Request entity for GetPegadbSlowLogTimeDistributionRequest operation.
    ...
    def __init__(self, app_id, node_id, start, end, db_engine):
        """
        Initialize GetPegadbSlowLogTimeDistributionRequest request entity.
    ...
    def from_dict(self, m):
        ...
        :rtype: GetPegadbSlowLogTimeDistributionRequest
