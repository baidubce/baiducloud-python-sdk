"""
Request entity for GetMysqlRateLimitTaskDetailResponse information.
"""
...
class GetMysqlRateLimitTaskDetailResponse(BceResponse):
    """
    ...
    def __init__(self, total_count=None, items=None):
        """
        Initialize GetMysqlRateLimitTaskDetailResponse response.
