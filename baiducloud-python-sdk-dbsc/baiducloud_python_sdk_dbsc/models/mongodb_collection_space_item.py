"""
MongodbCollectionSpaceItem information
"""

from baiducloud_python_sdk_core.abstract_model import AbstractModel


class MongodbCollectionSpaceItem(AbstractModel):
    """
    MongodbCollectionSpaceItem
    """
    ...
    def __init__(
        ...
        """
        Initialize MongodbCollectionSpaceItem instance.
        ...
        :param total_size: 总空间（字节），存储空间、索引空间之和
        ...
        :param total_free_storage_size: 总空闲空间（字节），文档空闲空间、索引空闲空间之和
    ...
    def from_dict(self, m):
        ...
        :rtype: MongodbCollectionSpaceItem
