"""
Request entity for GetMongodbSlowLogTrendRequest information.
"""

from baiducloud_python_sdk_core.abstract_model import AbstractModel


class GetMongodbSlowLogTrendRequest(AbstractModel):
    """
    Request entity for GetMongodbSlowLogTrendRequest operation.
    ...
    def __init__(self, app_id, start, end, period, node_id=None):
        """
        Initialize GetMongodbSlowLogTrendRequest request entity.
    ...
    def from_dict(self, m):
        ...
        :rtype: GetMongodbSlowLogTrendRequest
