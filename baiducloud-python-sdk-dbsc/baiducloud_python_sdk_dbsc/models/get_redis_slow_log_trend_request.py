"""
Request entity for GetRedisSlowLogTrendRequest information.
"""

from baiducloud_python_sdk_core.abstract_model import AbstractModel


class GetRedisSlowLogTrendRequest(AbstractModel):
    """
    Request entity for GetRedisSlowLogTrendRequest operation.
    ...
    def __init__(self, app_id, node_id, start, end, db_engine, period):
        """
        Initialize GetRedisSlowLogTrendRequest request entity.
    ...
    def from_dict(self, m):
        ...
        :rtype: GetRedisSlowLogTrendRequest
