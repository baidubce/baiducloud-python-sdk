"""
Request entity for GetPegadbSlowLogTrendRequest information.
"""

from baiducloud_python_sdk_core.abstract_model import AbstractModel


class GetPegadbSlowLogTrendRequest(AbstractModel):
    """
    Request entity for GetPegadbSlowLogTrendRequest operation.

    This class encapsulates all parameters for the API request.
    """

    def __init__(self, app_id, node_id, start, end, db_engine, period):
        """
        Initialize GetPegadbSlowLogTrendRequest request entity.
    ...
    def from_dict(self, m):
        ...
        :rtype: GetPegadbSlowLogTrendRequest
