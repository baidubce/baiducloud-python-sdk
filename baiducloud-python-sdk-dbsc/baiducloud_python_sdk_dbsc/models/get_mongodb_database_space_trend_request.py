"""
Request entity for GetMongodbDatabaseSpaceTrendRequest information.
"""

from baiducloud_python_sdk_core.abstract_model import AbstractModel


class GetMongodbDatabaseSpaceTrendRequest(AbstractModel):
    """
    Request entity for GetMongodbDatabaseSpaceTrendRequest operation.

    This class encapsulates all parameters for the API request.
    """

    def __init__(self, app_id, database, period, node_id=None, start=None, end=None, metrics=None, statistics=None):
        """
        Initialize GetMongodbDatabaseSpaceTrendRequest request entity.
    ...
    def from_dict(self, m):
        ...
        :rtype: GetMongodbDatabaseSpaceTrendRequest
