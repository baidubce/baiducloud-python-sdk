"""
Example for dbsc get_pegadb_slow_log_template method.
"""
...
if __name__ == '__main__':
    try:
        ...
        request = dbsc_models.GetPegadbSlowLogTemplateRequest(
            app_id="", node_id="", start="", end="", db_engine="", page=0, page_size=0, order_by="", order=""
        )
        res = client.get_pegadb_slow_log_template(request)
