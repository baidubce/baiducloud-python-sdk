"""
Example for dbsc get_mysql_space_summary method.
"""
...
if __name__ == '__main__':
    try:
        ...
        request = dbsc_models.GetMysqlSpaceSummaryRequest(app_id="", node_id="")
        res = client.get_mysql_space_summary(request)
