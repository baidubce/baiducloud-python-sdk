"""
Example for dbsc get_mysql_active_sessions method.
"""
...
if __name__ == '__main__':
    try:
        ...
        request = dbsc_models.GetMysqlActiveSessionsRequest(app_id="", node_id="")
        res = client.get_mysql_active_sessions(request)
