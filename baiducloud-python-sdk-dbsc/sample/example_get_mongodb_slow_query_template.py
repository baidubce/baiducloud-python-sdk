"""
Example for dbsc get_mongodb_slow_query_template method.
"""
...
if __name__ == '__main__':
    try:
        ...
        request = dbsc_models.GetMongodbSlowQueryTemplateRequest(
            app_id="",
            start="",
            end="",
            node_id="",
        ...
        res = client.get_mongodb_slow_query_template(request)
