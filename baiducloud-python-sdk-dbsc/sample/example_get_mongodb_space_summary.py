"""
Example for dbsc get_mongodb_space_summary method.
"""
...
if __name__ == '__main__':
    try:
        ...
        request = dbsc_models.GetMongodbSpaceSummaryRequest(app_id="", node_id="")
        res = client.get_mongodb_space_summary(request)
