"""
Example for dbsc get_mysql_deadlock_info method.
"""
...
if __name__ == '__main__':
    try:
        ...
        request = dbsc_models.GetMysqlDeadlockInfoRequest(app_id="", node_id="")
        res = client.get_mysql_deadlock_info(request)
