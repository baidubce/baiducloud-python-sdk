"""
Request entity for GetTagsScanOverviewRequest information.
"""

from baiducloud_python_sdk_core.abstract_model import AbstractModel


class GetTagsScanOverviewRequest(AbstractModel):
    """
    Request entity for GetTagsScanOverviewRequest operation.

    This class encapsulates all parameters for the API request.
    """

    def __init__(self, instance_id, project_name, repository_name, tag_name, page_no=None, page_size=None):
        """
        Initialize GetTagsScanOverviewRequest request entity.
    ...
    def from_dict(self, m):
        ...
        :rtype: GetTagsScanOverviewRequest
