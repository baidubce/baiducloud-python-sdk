"""
Request entity for ListChartVersionsRequest information.
"""

from baiducloud_python_sdk_core.abstract_model import AbstractModel


class ListChartVersionsRequest(AbstractModel):
    """
    Request entity for ListChartVersionsRequest operation.

    This class encapsulates all parameters for the API request.
    """

    def __init__(self, instance_id, project_name, chart_name, chart_version=None, page_no=None, page_size=None):
        """
        Initialize ListChartVersionsRequest request entity.
        ...
        :type chart_version: str (optional)
    ...
    def from_dict(self, m):
        ...
        :rtype: ListChartVersionsRequest
