"""
Request entity for UpdateTriggerRequest information.
"""
...
class UpdateTriggerRequest(AbstractModel):
    """
    Request entity for UpdateTriggerRequest operation.

    This class encapsulates all parameters for the API request.
    """

    def __init__(self, instance_id, policy_id, event_types, name, description=None, filters=None, targets=None):
        """
        Initialize UpdateTriggerRequest request entity.
