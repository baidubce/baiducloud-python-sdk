"""
ReplicationPolicyResult information
"""
...
class ReplicationPolicyResult(AbstractModel):
    """
    ...
    def __init__(
        ...
        """
        Initialize ReplicationPolicyResult instance.

        :param creation_time: 迁移规则创建时间
        :type creation_time: str (optional)

        :param deletion: 级联删除
        :type deletion: bool (optional)

        :param description: 迁移规则描述
        :type description: str (optional)

        :param dest_project_name: 目的命名空间
        :type dest_project_name: str (optional)

        :param dest_registry: dest_registry attribute
        :type dest_registry: ReplicationRegistry (optional)

        :param enabled: 迁移规则状态
        :type enabled: bool (optional)

        :param execution_times: 迁移规则执行次数
