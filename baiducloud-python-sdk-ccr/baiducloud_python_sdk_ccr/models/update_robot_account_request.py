"""
Request entity for UpdateRobotAccountRequest information.
"""
...
class UpdateRobotAccountRequest(AbstractModel):
    """
    Request entity for UpdateRobotAccountRequest operation.

    This class encapsulates all parameters for the API request.
    """

    def __init__(self, instance_id, robot_id, disable=None, duration=None, description=None, permissions=None):
        """
        Initialize UpdateRobotAccountRequest request entity.
    ...
    def from_dict(self, m):
        ...
        :rtype: UpdateRobotAccountRequest
