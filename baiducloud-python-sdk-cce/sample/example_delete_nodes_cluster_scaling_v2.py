"""
Example for cce delete_nodes_cluster_scaling_v2 method.
"""
...
if __name__ == '__main__':
    try:
        ...
        request = cce_models.DeleteNodesClusterScalingV2Request(
            cluster_id="", instance_ids=[], delete_option=delete_option, scale_down=False
        )
        res = client.delete_nodes_cluster_scaling_v2(request)
