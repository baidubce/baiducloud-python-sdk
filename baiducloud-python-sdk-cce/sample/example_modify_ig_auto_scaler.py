"""
Example for cce modify_ig_auto_scaler method.
"""
...
if __name__ == '__main__':
    try:
        ...
        request = cce_models.ModifyIGAutoScalerRequest(
            cluster_id="",
            instance_group_id="",
            enabled=False,
            max_replicas=0,
            min_replicas=0,
            scaling_group_priority=0,
        )
        res = client.modify_ig_auto_scaler(request)
