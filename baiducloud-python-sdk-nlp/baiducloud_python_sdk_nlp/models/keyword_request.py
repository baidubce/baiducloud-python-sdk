"""
Request entity for KeywordRequest information.
"""

from baiducloud_python_sdk_core.abstract_model import AbstractModel


class KeywordRequest(AbstractModel):
    """
    Request entity for KeywordRequest operation.
    ...
    def __init__(self, title, content, charset=None):
        """
        Initialize KeywordRequest request entity.
