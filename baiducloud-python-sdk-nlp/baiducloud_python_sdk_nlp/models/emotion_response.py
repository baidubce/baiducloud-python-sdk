"""
Request entity for EmotionResponse information.
"""

from baiducloud_python_sdk_core.bce_response import BceResponse
from baiducloud_python_sdk_nlp.models.emotion_item import EmotionItem


class EmotionResponse(BceResponse):
    """
    EmotionResponse
    """
    ...
    def __init__(self, error_code=None, error_msg=None, log_id=None, text=None, items=None):
        """
        Initialize EmotionResponse response.
        ...
        :param text: 输入的对话文本内容
        :type text: str (optional)

        :param items: 分析结果数组
        :type items: List[EmotionItem] (optional)
        """
        super().__init__()
    ...
    def from_dict(self, m):
        ...
        if m.get('items') is not None:
            self.items = [EmotionItem().from_dict(i) for i in m.get('items')]
        return self
