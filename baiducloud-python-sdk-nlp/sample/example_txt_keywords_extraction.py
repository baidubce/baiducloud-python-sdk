"""
Example for nlp txt_keywords_extraction method.
"""
...
if __name__ == '__main__':
    try:
        ...
        client = NlpClient(bce_client_config)
        request = nlp_models.TxtKeywordsExtractionRequest(text=[], charset="", num=0)
        res = client.txt_keywords_extraction(request)
