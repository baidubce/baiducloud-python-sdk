"""
Request entity for QueryPermissionGroupRulesResponse information.
"""
...
class QueryPermissionGroupRulesResponse(BceResponse):
    """
    QueryPermissionGroupRulesResponse
    """

    def __init__(self, access_rules=None, marker=None, is_truncated=None, next_marker=None, max_keys=None):
        """
        Initialize QueryPermissionGroupRulesResponse response.

        :param access_rules: 包含查询结果的列表
