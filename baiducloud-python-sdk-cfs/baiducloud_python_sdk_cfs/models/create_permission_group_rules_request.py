"""
Request entity for CreatePermissionGroupRulesRequest information.
"""

from baiducloud_python_sdk_core.abstract_model import AbstractModel


class CreatePermissionGroupRulesRequest(AbstractModel):
    """
    Request entity for CreatePermissionGroupRulesRequest operation.

    This class encapsulates all parameters for the API request.
    """

    def __init__(self, ag_name, ip, mask, write_access, user_access, priority):
        """
        Initialize CreatePermissionGroupRulesRequest request entity.
    ...
    def from_dict(self, m):
        ...
        :rtype: CreatePermissionGroupRulesRequest
