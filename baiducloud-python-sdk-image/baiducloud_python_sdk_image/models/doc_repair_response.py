"""
Request entity for DocRepairResponse information.
"""

from baiducloud_python_sdk_core.bce_response import BceResponse


class DocRepairResponse(BceResponse):
    """
    DocRepairResponse
    """
    ...
    def __init__(self, log_id=None, error_code=None, error_msg=None, result=None):
        """
        Initialize DocRepairResponse response.
        ...
        :param result: 返回处理后的图片，base64编码
