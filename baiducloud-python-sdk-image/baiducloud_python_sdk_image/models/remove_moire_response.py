"""
Request entity for RemoveMoireResponse information.
"""

from baiducloud_python_sdk_core.bce_response import BceResponse


class RemoveMoireResponse(BceResponse):
    """
    RemoveMoireResponse
    """

    def __init__(self, error_code=None, error_msg=None, log_id=None, image_processed=None, pdf_file_size=None):
        """
        Initialize RemoveMoireResponse response.
