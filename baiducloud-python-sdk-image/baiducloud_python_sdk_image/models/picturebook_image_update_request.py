"""
Request entity for PicturebookImageUpdateRequest information.
"""

from baiducloud_python_sdk_core.abstract_model import AbstractModel


class PicturebookImageUpdateRequest(AbstractModel):
    """
    Request entity for PicturebookImageUpdateRequest operation.

    This class encapsulates all parameters for the API request.
    """

    def __init__(self, image=None, url=None, cont_sign=None, brief=None, tags=None):
        """
        Initialize PicturebookImageUpdateRequest request entity.
    ...
    def from_dict(self, m):
        ...
        :rtype: PicturebookImageUpdateRequest
