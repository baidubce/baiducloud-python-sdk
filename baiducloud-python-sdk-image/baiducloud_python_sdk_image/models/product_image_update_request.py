"""
Request entity for ProductImageUpdateRequest information.
"""

from baiducloud_python_sdk_core.abstract_model import AbstractModel


class ProductImageUpdateRequest(AbstractModel):
    """
    Request entity for ProductImageUpdateRequest operation.

    This class encapsulates all parameters for the API request.
    """

    def __init__(self, image=None, url=None, cont_sign=None, brief=None, class_id1=None, class_id2=None):
        """
        Initialize ProductImageUpdateRequest request entity.
        ...
        :param class_id1: 更新的商品分类1，支持1-65535范围内的整数
        :type class_id1: int (optional)

        :param class_id2: 更新的商品分类2，支持1-65535范围内的整数
    ...
    def from_dict(self, m):
        ...
        :rtype: ProductImageUpdateRequest
