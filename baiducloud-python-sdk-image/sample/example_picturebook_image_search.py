"""
Example for image picturebook_image_search method.
"""
...
if __name__ == '__main__':
    try:
        ...
        request = image_models.PicturebookImageSearchRequest(image="", url="", tags="", tag_logic=0, pn=0, rn=0)
        res = client.picturebook_image_search(request)
