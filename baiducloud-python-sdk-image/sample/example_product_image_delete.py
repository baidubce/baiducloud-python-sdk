"""
Example for image product_image_delete method.
"""
...
if __name__ == '__main__':
    try:
        ...
        request = image_models.ProductImageDeleteRequest(image="", url="", cont_sign="")
        res = client.product_image_delete(request)
