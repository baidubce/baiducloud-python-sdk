"""
Example for image materiel_image_update method.
"""
...
if __name__ == '__main__':
    try:
        ...
        request = image_models.MaterielImageUpdateRequest(image="", url="", cont_sign="", brief="", tags="")
        res = client.materiel_image_update(request)
