"""
Example for image similar_image_search method.
"""
...
if __name__ == '__main__':
    try:
        ...
        request = image_models.SimilarImageSearchRequest(image="", url="", tags="", tag_logic=0, pn=0, rn=0)
        res = client.similar_image_search(request)
