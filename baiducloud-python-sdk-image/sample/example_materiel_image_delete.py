"""
Example for image materiel_image_delete method.
"""
...
if __name__ == '__main__':
    try:
        ...
        request = image_models.MaterielImageDeleteRequest(image="", url="", cont_sign="")
        res = client.materiel_image_delete(request)
