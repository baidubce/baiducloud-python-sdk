"""
Example for image same_image_search method.
"""
...
if __name__ == '__main__':
    try:
        ...
        request = image_models.SameImageSearchRequest(image="", url="", tags="", tag_logic=0, pn=0, rn=0)
        res = client.same_image_search(request)
