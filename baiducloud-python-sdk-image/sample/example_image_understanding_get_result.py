"""
Example for image image_understanding_get_result method.
"""
...
if __name__ == '__main__':
    try:
        ...
        request = image_models.ImageUnderstandingGetResultRequest(task_id="")
        res = client.image_understanding_get_result(request)
