"""
Example for image same_image_update method.
"""
...
if __name__ == '__main__':
    try:
        ...
        request = image_models.SameImageUpdateRequest(image="", url="", cont_sign="", brief="", tags="")
        res = client.same_image_update(request)
