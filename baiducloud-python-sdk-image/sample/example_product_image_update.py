"""
Example for image product_image_update method.
"""
...
if __name__ == '__main__':
    try:
        ...
        request = image_models.ProductImageUpdateRequest(
            image="", url="", cont_sign="", brief="", class_id1=0, class_id2=0
        )
        res = client.product_image_update(request)
