"""
Example for image product_image_search method.
"""
...
if __name__ == '__main__':
    try:
        ...
        request = image_models.ProductImageSearchRequest(
            image="", url="", class_id1=0, class_id2=0, tag_logic=0, pn=0, rn=0
        )
        res = client.product_image_search(request)
