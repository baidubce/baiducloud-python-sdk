"""
Example for image picturebook_image_update method.
"""
...
if __name__ == '__main__':
    try:
        ...
        request = image_models.PicturebookImageUpdateRequest(image="", url="", cont_sign="", brief="", tags="")
        res = client.picturebook_image_update(request)
