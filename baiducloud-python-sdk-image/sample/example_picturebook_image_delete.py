"""
Example for image picturebook_image_delete method.
"""
...
if __name__ == '__main__':
    try:
        ...
        request = image_models.PicturebookImageDeleteRequest(image="", url="", cont_sign="")
        res = client.picturebook_image_delete(request)
