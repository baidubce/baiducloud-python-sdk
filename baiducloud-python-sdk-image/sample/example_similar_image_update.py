"""
Example for image similar_image_update method.
"""
...
if __name__ == '__main__':
    try:
        ...
        request = image_models.SimilarImageUpdateRequest(image="", url="", cont_sign="", brief="", tags="")
        res = client.similar_image_update(request)
