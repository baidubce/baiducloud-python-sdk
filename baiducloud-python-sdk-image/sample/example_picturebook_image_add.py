"""
Example for image picturebook_image_add method.
"""
...
if __name__ == '__main__':
    try:
        ...
        request = image_models.PicturebookImageAddRequest(image="", url="", brief="", tags="")
        res = client.picturebook_image_add(request)
