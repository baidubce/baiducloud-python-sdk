"""
Example for image similar_image_delete method.
"""
...
if __name__ == '__main__':
    try:
        ...
        request = image_models.SimilarImageDeleteRequest(image="", url="", cont_sign="")
        res = client.similar_image_delete(request)
