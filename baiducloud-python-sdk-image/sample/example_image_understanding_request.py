"""
Example for image image_understanding_request method.
"""
...
if __name__ == '__main__':
    try:
        ...
        request = image_models.ImageUnderstandingRequestRequest(question="", image="", url="")
        res = client.image_understanding_request(request)
