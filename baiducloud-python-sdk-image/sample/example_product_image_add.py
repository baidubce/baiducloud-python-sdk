"""
Example for image product_image_add method.
"""
...
if __name__ == '__main__':
    try:
        ...
        request = image_models.ProductImageAddRequest(brief="", image="", url="", class_id1=0, class_id2=0)
        res = client.product_image_add(request)
