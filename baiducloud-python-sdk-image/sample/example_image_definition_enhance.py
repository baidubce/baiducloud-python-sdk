"""
Example for image image_definition_enhance method.
"""
...
if __name__ == '__main__':
    try:
        ...
        request = image_models.ImageDefinitionEnhanceRequest(image="", url="")
        res = client.image_definition_enhance(request)
