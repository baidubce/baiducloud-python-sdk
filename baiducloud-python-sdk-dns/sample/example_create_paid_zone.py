"""
Example for dns create_paid_zone method.
"""
...
if __name__ == '__main__':
    try:
        ...
        request = dns_models.CreatePaidZoneRequest(names=[], product_version="", billing=billing, client_token="")
        res = client.create_paid_zone(request)
