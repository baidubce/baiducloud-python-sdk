"""
BccFlavor information
"""

from baiducloud_python_sdk_core.abstract_model import AbstractModel


class BccFlavor(AbstractModel):
    """
    BccFlavor
    """
    ...
    def __init__(
        ...
        :param ephemeral_disk_in_gb: 本地数据盘容量（单位：GB）
        :type ephemeral_disk_in_gb: int (optional)

        :param ephemeral_disk_count: 本地数据盘数量
        :type ephemeral_disk_count: int (optional)
    ...
    def to_dict(self):
        ...
        if self.ephemeral_disk_in_gb is not None:
            result['ephemeralDiskInGb'] = self.ephemeral_disk_in_gb
    ...
    def from_dict(self, m):
        ...
        if m.get('ephemeralDiskInGb') is not None:
            self.ephemeral_disk_in_gb = m.get('ephemeralDiskInGb')
