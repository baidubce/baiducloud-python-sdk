"""
Request entity for RebuildBatchInstanceRequest information.
"""

from baiducloud_python_sdk_core.abstract_model import AbstractModel


class RebuildBatchInstanceRequest(AbstractModel):
    """
    Request entity for RebuildBatchInstanceRequest operation.
    ...
    def __init__(
        ...
        """
        Initialize RebuildBatchInstanceRequest request entity.
        ...
        :param user_data: 待重装的自定义脚本，不传默认使用当前自定义脚本（包括gpu驱动和CFS文件系统）
        :type user_data: str (optional)

        :param use_last_user_data: 在重装实例时是否使用上一次的 userData
        :type use_last_user_data: bool (optional)

        :param clean_last_user_data: 是否清空当前自定义脚本（包括gpu驱动和CFS文件系统），默认false
        :type clean_last_user_data: bool (optional)

        :param instance_ids: 指定的实例ID列表，最多100个
    ...
    def from_dict(self, m):
        ...
        :rtype: RebuildBatchInstanceRequest
