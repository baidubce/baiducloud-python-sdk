"""
Request entity for UpdateAspRequest information.
"""

from baiducloud_python_sdk_core.abstract_model import AbstractModel


class UpdateAspRequest(AbstractModel):
    """
    Request entity for UpdateAspRequest operation.

    This class encapsulates all parameters for the API request.
    """

    def __init__(self, asp_id, name, time_points, repeat_weekdays, retention_days):
        """
        Initialize UpdateAspRequest request entity.
        ...
        :type time_points: List[str] (required)

        :param repeat_weekdays: 一周中做快照的时间，取值为0~6
        :type repeat_weekdays: List[str] (required)
