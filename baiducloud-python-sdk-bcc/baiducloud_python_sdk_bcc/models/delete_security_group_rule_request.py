"""
Request entity for DeleteSecurityGroupRuleRequest information.
"""
...
class DeleteSecurityGroupRuleRequest(AbstractModel):
    """
    Request entity for DeleteSecurityGroupRuleRequest operation.

    This class encapsulates all parameters for the API request.
    """

    def __init__(self, security_group_rule_id, sg_version=None):
        """
        Initialize DeleteSecurityGroupRuleRequest request entity.
    ...
    def from_dict(self, m):
        ...
        :rtype: DeleteSecurityGroupRuleRequest
