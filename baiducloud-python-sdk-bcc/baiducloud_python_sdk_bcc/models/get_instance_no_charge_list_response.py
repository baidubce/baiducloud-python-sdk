"""
Request entity for GetInstanceNoChargeListResponse information.
"""

from baiducloud_python_sdk_core.bce_response import BceResponse
from baiducloud_python_sdk_bcc.models.instance_model import InstanceModel


class GetInstanceNoChargeListResponse(BceResponse):
    """
    GetInstanceNoChargeListResponse
    """

    def __init__(self, marker=None, is_truncated=None, next_marker=None, max_keys=None, instances=None):
        """
        Initialize GetInstanceNoChargeListResponse response.
        ...
        :param instances: 实例信息，由 InstanceModel 组成的集合
