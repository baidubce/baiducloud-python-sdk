"""
Request entity for BindTagImageRequest information.
"""
...
class BindTagImageRequest(AbstractModel):
    """
    Request entity for BindTagImageRequest operation.
    ...
    def __init__(self, image_id, change_tags):
        """
        Initialize BindTagImageRequest request entity.
