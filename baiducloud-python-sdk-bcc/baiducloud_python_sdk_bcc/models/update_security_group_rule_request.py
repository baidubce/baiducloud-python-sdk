"""
Request entity for UpdateSecurityGroupRuleRequest information.
"""

from baiducloud_python_sdk_core.abstract_model import AbstractModel


class UpdateSecurityGroupRuleRequest(AbstractModel):
    """
    Request entity for UpdateSecurityGroupRuleRequest operation.
    ...
    def __init__(
        ...
        """
        Initialize UpdateSecurityGroupRuleRequest request entity.
        ...
        :param protocol: 协议类型，暂不支持tcp/udp转icmp
    ...
    def from_dict(self, m):
        ...
        :rtype: UpdateSecurityGroupRuleRequest
