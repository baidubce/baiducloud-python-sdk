"""
Request entity for UnbindRoleResponse information.
"""
...
class UnbindRoleResponse(BceResponse):
    """
    UnbindRoleResponse
    """
    ...
    def __init__(self, fail_instances=None, instance_role_associations=None):
        """
        Initialize UnbindRoleResponse response.

        :param fail_instances: 实例解绑角色失败列表
        :type fail_instances: List[InstancePassRoleFailModel] (optional)

        :param instance_role_associations: 实例解绑角色成功列表
