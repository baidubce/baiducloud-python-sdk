"""
Request entity for UnbindRoleRequest information.
"""
...
class UnbindRoleRequest(AbstractModel):
    """
    Request entity for UnbindRoleRequest operation.
    ...
    def __init__(self, instances, role_name=None):
        """
        Initialize UnbindRoleRequest request entity.

        :param role_name: 实例解绑的角色名称
        :type role_name: str (optional)

        :param instances: 要解绑角色的实例id列表
