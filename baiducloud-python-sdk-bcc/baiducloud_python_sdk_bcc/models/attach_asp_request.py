"""
Request entity for AttachAspRequest information.
"""

from baiducloud_python_sdk_core.abstract_model import AbstractModel


class AttachAspRequest(AbstractModel):
    """
    Request entity for AttachAspRequest operation.
    ...
    def __init__(self, asp_id, volume_ids, delete_auto_snapshot=None):
        """
        Initialize AttachAspRequest request entity.

        :param asp_id: asp_id parameter
        :type asp_id: str (required)

        :param volume_ids: 需要绑定的磁盘ID列表
