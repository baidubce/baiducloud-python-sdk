"""
Request entity for ShareImageRequest information.
"""

from baiducloud_python_sdk_core.abstract_model import AbstractModel


class ShareImageRequest(AbstractModel):
    """
    Request entity for ShareImageRequest operation.
    ...
    def __init__(self, image_id, account=None, account_id=None, uc_account=None):
        """
        Initialize ShareImageRequest request entity.

        :param image_id: image_id parameter
        :type image_id: str (required)

        :param account: 待共享的用户名
        :type account: str (optional)

        :param account_id: 待共享的用户ID
