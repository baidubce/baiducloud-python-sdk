"""
Request entity for AddIpv6Request information.
"""

from baiducloud_python_sdk_core.abstract_model import AbstractModel


class AddIpv6Request(AbstractModel):
    """
    Request entity for AddIpv6Request operation.
    ...
    def __init__(self, instance_id, ipv6_address=None, reboot=None):
        """
        Initialize AddIpv6Request request entity.

        :param instance_id: 实例id
        :type instance_id: str (required)

        :param ipv6_address: ipv6地址，为空表示自动分配ipv6
        :type ipv6_address: str (optional)

        :param reboot: 是否重启，true表示重启，为空表示不重启
