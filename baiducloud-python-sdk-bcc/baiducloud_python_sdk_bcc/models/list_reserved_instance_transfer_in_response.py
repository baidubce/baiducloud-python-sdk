"""
Request entity for ListReservedInstanceTransferInResponse information.
"""

from baiducloud_python_sdk_core.bce_response import BceResponse
from baiducloud_python_sdk_bcc.models.transfer_in_record import TransferInRecord


class ListReservedInstanceTransferInResponse(BceResponse):
    """
    ...
    def __init__(
        ...
        """
        Initialize ListReservedInstanceTransferInResponse response.
        ...
        :type transfer_records: List[TransferInRecord] (optional)
        """
        super().__init__()
        self.marker = marker
    ...
    def from_dict(self, m):
        ...
        if m.get('transferRecords') is not None:
            self.transfer_records = [TransferInRecord().from_dict(i) for i in m.get('transferRecords')]
        return self
