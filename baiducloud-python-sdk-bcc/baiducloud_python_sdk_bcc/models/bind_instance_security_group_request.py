"""
Request entity for BindInstanceSecurityGroupRequest information.
"""

from baiducloud_python_sdk_core.abstract_model import AbstractModel


class BindInstanceSecurityGroupRequest(AbstractModel):
    """
    Request entity for BindInstanceSecurityGroupRequest operation.
    ...
    def __init__(self, instance_ids, security_group_ids, security_group_type):
        """
        Initialize BindInstanceSecurityGroupRequest request entity.

        :param instance_ids: 待绑定的虚机的短id列表
        :type instance_ids: List[str] (required)

        :param security_group_ids: 待绑定的安全组的短id列表
        :type security_group_ids: List[str] (required)

        :param security_group_type: 待绑定的安全组类型（enterprise/normal）
    ...
    def from_dict(self, m):
        ...
        :rtype: BindInstanceSecurityGroupRequest
