"""
Request entity for DescribePlannedEventRecordsResponse information.
"""
...
class DescribePlannedEventRecordsResponse(BceResponse):
    """
    ...
    def __init__(
        ...
        """
        Initialize DescribePlannedEventRecordsResponse response.
        ...
        :param planned_maintenance_events: 非预期事件列表
