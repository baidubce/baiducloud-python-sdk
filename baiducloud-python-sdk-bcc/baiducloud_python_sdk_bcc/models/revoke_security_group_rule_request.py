"""
Request entity for RevokeSecurityGroupRuleRequest information.
"""
...
class RevokeSecurityGroupRuleRequest(AbstractModel):
    """
    Request entity for RevokeSecurityGroupRuleRequest operation.

    This class encapsulates all parameters for the API request.
    """

    def __init__(self, security_group_id, rule, sg_version=None):
        """
        Initialize RevokeSecurityGroupRuleRequest request entity.
    ...
    def from_dict(self, m):
        ...
        :rtype: RevokeSecurityGroupRuleRequest
