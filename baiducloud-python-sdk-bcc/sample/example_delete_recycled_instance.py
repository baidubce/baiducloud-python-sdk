"""
Example for bcc delete_recycled_instance method.
"""
...
if __name__ == '__main__':
    try:
        ...
        request = bcc_models.DeleteRecycledInstanceRequest(instance_id="")
        res = client.delete_recycled_instance(request)
