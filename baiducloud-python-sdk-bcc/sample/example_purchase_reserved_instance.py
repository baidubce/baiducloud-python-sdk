"""
Example for bcc purchase_reserved_instance method.
"""
...
if __name__ == '__main__':
    try:
        ...
        request = bcc_models.PurchaseReservedInstanceRequest(
            instance_id="", billing=billing, related_renew_flag="", cds_custom_period=[]
        )
        res = client.purchase_reserved_instance(request)
