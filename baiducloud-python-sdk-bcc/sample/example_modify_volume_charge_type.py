"""
Example for bcc modify_volume_charge_type method.
"""
...
if __name__ == '__main__':
    try:
        ...
        request = bcc_models.ModifyVolumeChargeTypeRequest(volume_id="", billing=billing, effective_type="")
        res = client.modify_volume_charge_type(request)
