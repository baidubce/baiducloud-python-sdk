"""
Example for bcc get_zone_by_spec method.
"""
...
if __name__ == '__main__':
    try:
        ...
        request = bcc_models.GetZoneBySpecRequest(instance_type="", product_type="", spec="", spec_id="")
        res = client.get_zone_by_spec(request)
