"""
Example for bcc create_deploy_set method.
"""
...
if __name__ == '__main__':
    try:
        ...
        request = bcc_models.CreateDeploySetRequest(name="", desc="", strategy="", concurrency=0)
        res = client.create_deploy_set(request)
