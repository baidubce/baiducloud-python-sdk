"""
Example for bcc modify_ehc_cluster method.
"""
...
if __name__ == '__main__':
    try:
        ...
        request = bcc_models.ModifyEhcClusterRequest(ehc_cluster_id="", name="", description="")
        res = client.modify_ehc_cluster(request)
