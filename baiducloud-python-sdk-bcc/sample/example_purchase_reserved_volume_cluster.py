"""
Example for bcc purchase_reserved_volume_cluster method.
"""
...
if __name__ == '__main__':
    try:
        ...
        request = bcc_models.PurchaseReservedVolumeClusterRequest(cluster_id="", billing=billing)
        res = client.purchase_reserved_volume_cluster(request)
