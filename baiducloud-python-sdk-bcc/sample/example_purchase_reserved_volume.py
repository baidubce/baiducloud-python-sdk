"""
Example for bcc purchase_reserved_volume method.
"""
...
if __name__ == '__main__':
    try:
        ...
        request = bcc_models.PurchaseReservedVolumeRequest(volume_id="", billing=billing, instance_id="")
        res = client.purchase_reserved_volume(request)
