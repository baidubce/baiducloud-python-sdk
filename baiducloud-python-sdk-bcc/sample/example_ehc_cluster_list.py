"""
Example for bcc ehc_cluster_list method.
"""
...
if __name__ == '__main__':
    try:
        ...
        request = bcc_models.EhcClusterListRequest(ehc_cluster_id_list=[], name_list=[], zone_name="")
        res = client.ehc_cluster_list(request)
