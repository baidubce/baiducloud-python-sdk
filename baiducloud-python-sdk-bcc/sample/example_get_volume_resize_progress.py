"""
Example for bcc get_volume_resize_progress method.
"""
...
if __name__ == '__main__':
    try:
        ...
        request = bcc_models.GetVolumeResizeProgressRequest(volume_id="")
        res = client.get_volume_resize_progress(request)
