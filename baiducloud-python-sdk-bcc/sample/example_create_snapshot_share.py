"""
Example for bcc create_snapshot_share method.
"""
...
if __name__ == '__main__':
    try:
        ...
        request = bcc_models.CreateSnapshotShareRequest(snapshot_id="", account_ids=[])
        res = client.create_snapshot_share(request)
