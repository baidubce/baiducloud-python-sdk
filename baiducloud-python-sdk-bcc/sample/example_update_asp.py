"""
Example for bcc update_asp method.
"""
...
if __name__ == '__main__':
    try:
        ...
        request = bcc_models.UpdateAspRequest(
            asp_id="", name="", time_points=[], repeat_weekdays=[], retention_days=""
        )
        res = client.update_asp(request)
