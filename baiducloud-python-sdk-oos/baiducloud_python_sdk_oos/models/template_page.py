...
class TemplatePage(AbstractModel):
    """
    TemplatePage
    """

    def __init__(self, templates=None, order_by=None, order=None, page_no=None, page_size=None, total_count=None):
        """
        Initialize TemplatePage instance.
