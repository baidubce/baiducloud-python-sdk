...
class ExecutionPage(AbstractModel):
    """
    ExecutionPage
    """

    def __init__(self, executions=None, order_by=None, order=None, page_no=None, page_size=None, total_count=None):
        """
        Initialize ExecutionPage instance.
