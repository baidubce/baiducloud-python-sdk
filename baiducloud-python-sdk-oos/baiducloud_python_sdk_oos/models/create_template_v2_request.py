"""
Request entity for CreateTemplateV2Request information.
"""
...
class CreateTemplateV2Request(AbstractModel):
    """
    Request entity for CreateTemplateV2Request operation.

    This class encapsulates all parameters for the API request.
    """

    def __init__(
        self, name, linear, operators, description=None, tags=None, parallelism=None, links=None, properties=None
    ):
        """
        Initialize CreateTemplateV2Request request entity.
