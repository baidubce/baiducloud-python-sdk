"""
Request entity for CheckTemplateV2Request information.
"""
...
class CheckTemplateV2Request(AbstractModel):
    """
    Request entity for CheckTemplateV2Request operation.

    This class encapsulates all parameters for the API request.
    """

    def __init__(
        self, name, operators, description=None, tags=None, linear=None, parallelism=None, links=None, properties=None
    ):
        """
        Initialize CheckTemplateV2Request request entity.
