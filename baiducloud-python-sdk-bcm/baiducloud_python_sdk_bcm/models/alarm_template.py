...
class AlarmTemplate(AbstractModel):
    """
    AlarmTemplate
    """

    def __init__(
        self, id=None, scope=None, resource_type=None, sub_resource_type=None, name=None, comment=None, rules=None
    ):
        """
        Initialize AlarmTemplate instance.
