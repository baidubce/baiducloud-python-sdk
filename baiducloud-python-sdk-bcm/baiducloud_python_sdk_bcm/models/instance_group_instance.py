"""
InstanceGroupInstance information
"""
...
class InstanceGroupInstance(AbstractModel):
    """
    InstanceGroupInstance
    """

    def __init__(self, dimensions=None, region=None):
        """
        Initialize InstanceGroupInstance instance.

        :param dimensions: 实例维度键值对列表
        :type dimensions: List[Dimension] (optional)

        :param region: 实例所属region
