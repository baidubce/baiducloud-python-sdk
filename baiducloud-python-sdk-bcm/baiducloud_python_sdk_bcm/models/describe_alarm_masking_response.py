"""
Request entity for DescribeAlarmMaskingResponse information.
"""
...
class DescribeAlarmMaskingResponse(BceResponse):
    """
    DescribeAlarmMaskingResponse
    """
    ...
    def __init__(
        ...
        """
        Initialize DescribeAlarmMaskingResponse response.
        ...
        :param state: 屏蔽规则状态，ENABLED/DISABLED
        ...
        :param period_type: 屏蔽时间类型，FOREVER/FIXED/RELATIVE
        :type period_type: str (optional)

        :param begin_time: 屏蔽开始时间
        :type begin_time: str (optional)

        :param end_time: 屏蔽结束时间
        :type end_time: str (optional)

        :param tz: 时区
        :type tz: str (optional)

        :param daily_begin_timestamp: 每日屏蔽开始时间戳
        :type daily_begin_timestamp: int (optional)

        :param daily_end_timestamp: 每日屏蔽结束时间戳
