"""
Request entity for CreateAlarmTemplateRequest information.
"""
...
class CreateAlarmTemplateRequest(AbstractModel):
    """
    Request entity for CreateAlarmTemplateRequest operation.

    This class encapsulates all parameters for the API request.
    """

    def __init__(self, scope, resource_type, name, rules, sub_resource_type=None, comment=None):
        """
        Initialize CreateAlarmTemplateRequest request entity.
    ...
    def from_dict(self, m):
        ...
        :rtype: CreateAlarmTemplateRequest
