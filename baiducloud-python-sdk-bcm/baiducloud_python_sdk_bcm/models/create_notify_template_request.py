"""
Request entity for CreateNotifyTemplateRequest information.
"""
...
class CreateNotifyTemplateRequest(AbstractModel):
    """
    Request entity for CreateNotifyTemplateRequest operation.

    This class encapsulates all parameters for the API request.
    """

    def __init__(self, name, silence_periods=None, receivers=None, callbacks=None):
        """
        Initialize CreateNotifyTemplateRequest request entity.

        :param name: 通知模板名称，可重复
        :type name: str (required)

        :param silence_periods: 静默时间段列表，在这些时间段内不会触发通知
        :type silence_periods: List[SilencePeriod] (optional)

        :param receivers: 通知接收者列表，为空表示模板未绑定具体成员
    ...
    def from_dict(self, m):
        ...
        :rtype: CreateNotifyTemplateRequest
