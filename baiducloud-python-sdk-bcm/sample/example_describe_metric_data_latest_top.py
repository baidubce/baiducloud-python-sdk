"""
Example for bcm describe_metric_data_latest_top method.
"""
...
if __name__ == '__main__':
    try:
        ...
        request = bcm_models.DescribeMetricDataLatestTopRequest(
            action="",
            scope="",
            region="",
            end_datetime="",
        ...
        res = client.describe_metric_data_latest_top(request)
