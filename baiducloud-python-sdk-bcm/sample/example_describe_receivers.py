"""
Example for bcm describe_receivers method.
"""
...
if __name__ == '__main__':
    try:
        ...
        request = bcm_models.DescribeReceiversRequest(type="", page_no=0, page_size=0, name="")
        res = client.describe_receivers(request)
