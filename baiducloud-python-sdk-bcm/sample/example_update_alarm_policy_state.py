"""
Example for bcm update_alarm_policy_state method.
"""
...
if __name__ == '__main__':
    try:
        ...
        request = bcm_models.UpdateAlarmPolicyStateRequest(ids=[], state="")
        res = client.update_alarm_policy_state(request)
