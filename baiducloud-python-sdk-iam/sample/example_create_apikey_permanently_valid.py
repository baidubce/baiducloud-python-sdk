"""
Example for iam create_apikey_permanently_valid method.
"""
...
if __name__ == '__main__':
    try:
        ...
        request = iam_models.CreateApikeyPermanentlyValidRequest(acl=acl, user_id="", name="")
        res = client.create_apikey_permanently_valid(request)
