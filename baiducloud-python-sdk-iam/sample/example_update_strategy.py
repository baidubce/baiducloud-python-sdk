"""
Example for iam update_strategy method.
"""
...
if __name__ == '__main__':
    try:
        ...
        request = iam_models.UpdateStrategyRequest(policy_name="", document="", name="", description="")
        res = client.update_strategy(request)
