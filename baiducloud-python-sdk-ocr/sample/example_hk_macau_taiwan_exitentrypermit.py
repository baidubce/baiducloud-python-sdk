"""
Example for ocr hk_macau_taiwan_exitentrypermit method.
"""
...
if __name__ == '__main__':
    try:
        ...
        request = ocr_models.HkMacauTaiwanExitentrypermitRequest(
            exitentrypermit_type="", image="", url="", pdf_file="", pdf_file_num=0, probability=False, location=False
        )
        res = client.hk_macau_taiwan_exitentrypermit(request)
