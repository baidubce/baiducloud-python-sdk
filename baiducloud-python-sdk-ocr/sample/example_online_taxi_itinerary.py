"""
Example for ocr online_taxi_itinerary method.
"""
...
if __name__ == '__main__':
    try:
        ...
        request = ocr_models.OnlineTaxiItineraryRequest(
            image="", url="", pdf_file="", pdf_file_num=0, ofd_file="", ofd_file_num=0
        )
        res = client.online_taxi_itinerary(request)
