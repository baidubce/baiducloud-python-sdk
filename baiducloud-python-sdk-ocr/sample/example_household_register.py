"""
Example for ocr household_register method.
"""
...
if __name__ == '__main__':
    try:
        ...
        request = ocr_models.HouseholdRegisterRequest(image="", url="", household_register_side="")
        res = client.household_register(request)
