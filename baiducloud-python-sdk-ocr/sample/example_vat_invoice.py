"""
Example for ocr vat_invoice method.
"""
...
if __name__ == '__main__':
    try:
        ...
        request = ocr_models.VatInvoiceRequest(
            image="", url="", pdf_file="", pdf_file_num=0, ofd_file="", ofd_file_num=0, type="", seal_tag=False
        )
        res = client.vat_invoice(request)
