"""
Example for ocr four_factors_verification method.
"""
...
if __name__ == '__main__':
    try:
        ...
        request = ocr_models.FourFactorsVerificationRequest(name="", idcard="", company="", regnum="")
        res = client.four_factors_verification(request)
