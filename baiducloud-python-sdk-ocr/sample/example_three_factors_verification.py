"""
Example for ocr three_factors_verification method.
"""
...
if __name__ == '__main__':
    try:
        ...
        request = ocr_models.ThreeFactorsVerificationRequest(name="", company="", regnum="")
        res = client.three_factors_verification(request)
