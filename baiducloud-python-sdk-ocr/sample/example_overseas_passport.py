"""
Example for ocr overseas_passport method.
"""
...
if __name__ == '__main__':
    try:
        ...
        request = ocr_models.OverseasPassportRequest(image="", url="", pdf_file="", pdf_file_num=0)
        res = client.overseas_passport(request)
