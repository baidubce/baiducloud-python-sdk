"""
Example for ocr medical_summary method.
"""
...
if __name__ == '__main__':
    try:
        ...
        request = ocr_models.MedicalSummaryRequest(image="", url="", location=False, probability=False)
        res = client.medical_summary(request)
