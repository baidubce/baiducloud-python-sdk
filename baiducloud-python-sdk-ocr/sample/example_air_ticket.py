"""
Example for ocr air_ticket method.
"""
...
if __name__ == '__main__':
    try:
        ...
        request = ocr_models.AirTicketRequest(
            image="", url="", pdf_file="", pdf_file_num=0, ofd_file="", ofd_file_num=0, multi_detect=False
        )
        res = client.air_ticket(request)
