"""
Example for ocr vehicle_registration_certificate method.
"""
...
if __name__ == '__main__':
    try:
        ...
        request = ocr_models.VehicleRegistrationCertificateRequest(image="", url="")
        res = client.vehicle_registration_certificate(request)
