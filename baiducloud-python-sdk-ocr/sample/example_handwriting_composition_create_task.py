"""
Example for ocr handwriting_composition_create_task method.
"""
...
if __name__ == '__main__':
    try:
        ...
        request = ocr_models.HandwritingCompositionCreateTaskRequest(
            image="", url="", pdf_file="", recognize_granularity="", pdf_file_num=0
        )
        res = client.handwriting_composition_create_task(request)
