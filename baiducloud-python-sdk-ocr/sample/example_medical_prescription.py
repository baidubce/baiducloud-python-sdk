"""
Example for ocr medical_prescription method.
"""
...
if __name__ == '__main__':
    try:
        ...
        request = ocr_models.MedicalPrescriptionRequest(image="", url="", location=False, probability=False)
        res = client.medical_prescription(request)
