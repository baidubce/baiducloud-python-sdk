"""
Example for ocr paper_cut_edu_vlm_get_result method.
"""
...
if __name__ == '__main__':
    try:
        ...
        request = ocr_models.PaperCutEduVlmGetResultRequest(task_id="")
        res = client.paper_cut_edu_vlm_get_result(request)
