"""
Example for ocr handwriting_composition_get_result method.
"""
...
if __name__ == '__main__':
    try:
        ...
        request = ocr_models.HandwritingCompositionGetResultRequest(task_id="")
        res = client.handwriting_composition_get_result(request)
