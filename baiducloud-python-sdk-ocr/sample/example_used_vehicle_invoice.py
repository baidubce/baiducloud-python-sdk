"""
Example for ocr used_vehicle_invoice method.
"""
...
if __name__ == '__main__':
    try:
        ...
        request = ocr_models.UsedVehicleInvoiceRequest(image="", url="", pdf_file="", pdf_file_num=0)
        res = client.used_vehicle_invoice(request)
