"""
Example for ocr two_factors_verification method.
"""
...
if __name__ == '__main__':
    try:
        ...
        request = ocr_models.TwoFactorsVerificationRequest(company="", regnum="")
        res = client.two_factors_verification(request)
