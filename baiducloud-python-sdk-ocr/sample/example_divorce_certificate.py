"""
Example for ocr divorce_certificate method.
"""
...
if __name__ == '__main__':
    try:
        ...
        request = ocr_models.DivorceCertificateRequest(image="", url="", pdf_file="", pdf_file_num=0)
        res = client.divorce_certificate(request)
