"""
Example for ocr real_estate_certificate method.
"""
...
if __name__ == '__main__':
    try:
        ...
        request = ocr_models.RealEstateCertificateRequest(
            image="", url="", pdf_file="", pdf_file_num=0, probability=False, location=False
        )
        res = client.real_estate_certificate(request)
