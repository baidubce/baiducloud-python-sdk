"""
Example for ocr medical_detail method.
"""
...
if __name__ == '__main__':
    try:
        ...
        request = ocr_models.MedicalDetailRequest(image="", url="", location=False, probability=False)
        res = client.medical_detail(request)
