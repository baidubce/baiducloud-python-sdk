"""
Example for ocr medical_record method.
"""
...
if __name__ == '__main__':
    try:
        ...
        request = ocr_models.MedicalRecordRequest(image="", url="", location=False, probability=False)
        res = client.medical_record(request)
