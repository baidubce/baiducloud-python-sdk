"""
Example for ocr medical_statement method.
"""
...
if __name__ == '__main__':
    try:
        ...
        request = ocr_models.MedicalStatementRequest(image="", url="", location=False, probability=False)
        res = client.medical_statement(request)
