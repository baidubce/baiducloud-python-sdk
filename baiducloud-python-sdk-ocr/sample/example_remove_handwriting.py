"""
Example for ocr remove_handwriting method.
"""
...
if __name__ == '__main__':
    try:
        ...
        request = ocr_models.RemoveHandwritingRequest(
            image="", url="", pdf_file="", pdf_file_num=0, enable_detect=False
        )
        res = client.remove_handwriting(request)
