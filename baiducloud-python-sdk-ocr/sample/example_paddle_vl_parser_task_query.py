"""
Example for ocr paddle_vl_parser_task_query method.
"""
...
if __name__ == '__main__':
    try:
        ...
        request = ocr_models.PaddleVlParserTaskQueryRequest(task_id="")
        res = client.paddle_vl_parser_task_query(request)
