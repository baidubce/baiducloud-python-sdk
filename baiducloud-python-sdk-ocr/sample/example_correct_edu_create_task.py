"""
Example for ocr correct_edu_create_task method.
"""
...
if __name__ == '__main__':
    try:
        ...
        request = ocr_models.CorrectEduCreateTaskRequest(image="", url="", only_split=False, disable_preprocess=False)
        res = client.correct_edu_create_task(request)
