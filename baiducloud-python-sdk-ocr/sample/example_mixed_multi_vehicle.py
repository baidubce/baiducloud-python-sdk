"""
Example for ocr mixed_multi_vehicle method.
"""
...
if __name__ == '__main__':
    try:
        ...
        request = ocr_models.MixedMultiVehicleRequest(image="", url="", detect_direction=False, unified=False)
        res = client.mixed_multi_vehicle(request)
