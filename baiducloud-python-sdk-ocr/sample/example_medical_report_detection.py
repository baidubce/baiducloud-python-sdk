"""
Example for ocr medical_report_detection method.
"""
...
if __name__ == '__main__':
    try:
        ...
        request = ocr_models.MedicalReportDetectionRequest(image="", url="", location=False, probability=False)
        res = client.medical_report_detection(request)
