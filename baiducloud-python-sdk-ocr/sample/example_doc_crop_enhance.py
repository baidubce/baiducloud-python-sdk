"""
Example for ocr doc_crop_enhance method.
"""
...
if __name__ == '__main__':
    try:
        ...
        request = ocr_models.DocCropEnhanceRequest(
            image="", url="", pdf_file="", pdf_file_num=0, scan_type=0, points="", enhance_type=0
        )
        res = client.doc_crop_enhance(request)
