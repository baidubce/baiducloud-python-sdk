"""
Example for ocr foreign_resident_id_card method.
"""
...
if __name__ == '__main__':
    try:
        ...
        request = ocr_models.ForeignResidentIdCardRequest(image="", url="", pdf_file="", pdf_file_num=0)
        res = client.foreign_resident_id_card(request)
