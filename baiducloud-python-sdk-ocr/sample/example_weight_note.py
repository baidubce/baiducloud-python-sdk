"""
Example for ocr weight_note method.
"""
...
if __name__ == '__main__':
    try:
        ...
        request = ocr_models.WeightNoteRequest(image="", url="", pdf_file="", pdf_file_num=0, probability=False)
        res = client.weight_note(request)
