"""
Example for ocr license_plate method.
"""
...
if __name__ == '__main__':
    try:
        ...
        request = ocr_models.LicensePlateRequest(
            image="", url="", multi_detect=False, multi_scale=False, detect_complete=False, detect_risk=False
        )
        res = client.license_plate(request)
