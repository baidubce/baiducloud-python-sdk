"""
Example for ocr businesslicense_verification_standard method.
"""
...
if __name__ == '__main__':
    try:
        ...
        request = ocr_models.BusinesslicenseVerificationStandardRequest(verifynum="")
        res = client.businesslicense_verification_standard(request)
