"""
Example for ocr paper_cut_edu_vlm_create_task method.
"""
...
if __name__ == '__main__':
    try:
        ...
        request = ocr_models.PaperCutEduVlmCreateTaskRequest(
            scene_type="", image="", url="", pdf_file="", pdf_file_num=0, only_split=False, enhance=False
        )
        res = client.paper_cut_edu_vlm_create_task(request)
