"""
Example for ocr smart_struct method.
"""
...
if __name__ == '__main__':
    try:
        ...
        request = ocr_models.SmartStructRequest(image="", url="", pdf_file="", pdf_file_num=0, return_relation=False)
        res = client.smart_struct(request)
