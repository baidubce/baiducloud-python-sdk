"""
Example for ocr road_transport_certificate method.
"""
...
if __name__ == '__main__':
    try:
        ...
        request = ocr_models.RoadTransportCertificateRequest(image="", url="", pdf_file="", pdf_file_num=0)
        res = client.road_transport_certificate(request)
