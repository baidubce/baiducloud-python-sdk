...
if __name__ == '__main__':
    try:
        ...
        request = ocr_models.QrcodeRequest(
            image="", url="", pdf_file="", pdf_file_num=0, ofd_file="", ofd_file_num=0, location=False
        )
        res = client.qrcode(request)
