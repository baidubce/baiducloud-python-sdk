"""
Example for ocr businesslicense_verification_detailed method.
"""
...
if __name__ == '__main__':
    try:
        ...
        request = ocr_models.BusinesslicenseVerificationDetailedRequest(verifynum="")
        res = client.businesslicense_verification_detailed(request)
