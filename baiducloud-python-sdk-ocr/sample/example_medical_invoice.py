"""
Example for ocr medical_invoice method.
"""
...
if __name__ == '__main__':
    try:
        ...
        request = ocr_models.MedicalInvoiceRequest(image="", url="", location=False, probability=False, medi_query="")
        res = client.medical_invoice(request)
