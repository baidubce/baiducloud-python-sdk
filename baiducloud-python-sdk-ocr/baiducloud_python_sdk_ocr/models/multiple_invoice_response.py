"""
Request entity for MultipleInvoiceResponse information.
"""

from baiducloud_python_sdk_core.bce_response import BceResponse
from baiducloud_python_sdk_ocr.models.multiple_invoice_words_result import MultipleInvoiceWordsResult


class MultipleInvoiceResponse(BceResponse):
    """
    ...
    def __init__(
        ...
        """
        Initialize MultipleInvoiceResponse response.
        ...
        :type words_result: List[MultipleInvoiceWordsResult] (optional)
    ...
    def from_dict(self, m):
        ...
        if m.get('words_result') is not None:
            self.words_result = [MultipleInvoiceWordsResult().from_dict(i) for i in m.get('words_result')]
