"""
Request entity for BusinesslicenseStandardResponse information.
"""

from baiducloud_python_sdk_core.bce_response import BceResponse
from baiducloud_python_sdk_ocr.models.businesslicense_verification_standard_result import (
    BusinesslicenseVerificationStandardResult,
)


class BusinesslicenseStandardResponse(BceResponse):
    """
    BusinesslicenseStandardResponse
    """

    def __init__(self, error_code=None, error_msg=None, log_id=None, words_result_num=None, words_result=None):
        """
        Initialize BusinesslicenseStandardResponse response.
        ...
        :type words_result: BusinesslicenseVerificationStandardResult (optional)
        """
        super().__init__()
    ...
    def from_dict(self, m):
        ...
        if m.get('words_result') is not None:
            self.words_result = BusinesslicenseVerificationStandardResult().from_dict(m.get('words_result'))
        return self
