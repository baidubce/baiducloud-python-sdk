"""
Request entity for SealResponse information.
"""

from baiducloud_python_sdk_core.bce_response import BceResponse
from baiducloud_python_sdk_ocr.models.seal_result import SealResult


class SealResponse(BceResponse):
    """
    SealResponse
    """

    def __init__(self, error_code=None, error_msg=None, log_id=None, result_num=None, result=None, pdf_file_size=None):
        """
        Initialize SealResponse response.
        ...
        :param result_num: 识别结果数，表示results的元素个数
        :type result_num: int (optional)

        :param result: 定位结果数组
        :type result: List[SealResult] (optional)
    ...
    def from_dict(self, m):
        ...
        if m.get('result') is not None:
            self.result = [SealResult().from_dict(i) for i in m.get('result')]
