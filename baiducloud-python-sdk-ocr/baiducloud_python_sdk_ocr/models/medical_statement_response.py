"""
Request entity for MedicalStatementResponse information.
"""

from baiducloud_python_sdk_core.bce_response import BceResponse
from baiducloud_python_sdk_ocr.models.medical_statement_words_result import MedicalStatementWordsResult


class MedicalStatementResponse(BceResponse):
    """
    MedicalStatementResponse
    """

    def __init__(
        self, error_code=None, error_msg=None, log_id=None, words_result_num=None, invoice_type=None, word_result=None
    ):
        """
        Initialize MedicalStatementResponse response.
        ...
        :type word_result: MedicalStatementWordsResult (optional)
        """
        super().__init__()
    ...
    def from_dict(self, m):
        ...
        if m.get('word_result') is not None:
            self.word_result = MedicalStatementWordsResult().from_dict(m.get('word_result'))
        return self
