"""
Request entity for AccurateBasicResponse information.
"""

from baiducloud_python_sdk_core.bce_response import BceResponse
from baiducloud_python_sdk_ocr.models.accurate_basic_words_result import AccurateBasicWordsResult
from baiducloud_python_sdk_ocr.models.accurate_basic_paragraphs_result import AccurateBasicParagraphsResult


class AccurateBasicResponse(BceResponse):
    """
    AccurateBasicResponse
    """
    ...
    def __init__(
        ...
        """
        Initialize AccurateBasicResponse response.
        ...
        :type words_result: List[AccurateBasicWordsResult] (optional)

        :param paragraphs_result: 段落检测结果，当 paragraph=true 时返回该字段
        :type paragraphs_result: List[AccurateBasicParagraphsResult] (optional)
    ...
    def from_dict(self, m):
        ...
        if m.get('words_result') is not None:
            self.words_result = [AccurateBasicWordsResult().from_dict(i) for i in m.get('words_result')]
        if m.get('paragraphs_result') is not None:
            self.paragraphs_result = [AccurateBasicParagraphsResult().from_dict(i) for i in m.get('paragraphs_result')]
