"""
IdCardQuality information
"""

from baiducloud_python_sdk_core.abstract_model import AbstractModel


class IdCardQuality(AbstractModel):
    """
    IdCardQuality
    """
    ...
    def __init__(
        ...
        """
        Initialize IdCardQuality instance.
        ...
        :param is_no_cover: 是否头像、关键字段无遮挡/马赛克：0-有遮挡，1-无遮挡
        :type is_no_cover: int (optional)

        :param is_no_cover_propobility: 无遮挡概率，值在0-1之间，值越大表示图像质量越好
