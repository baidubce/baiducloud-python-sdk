"""
Request entity for MultipleInvoiceRequest information.
"""

from baiducloud_python_sdk_core.abstract_model import AbstractModel


class MultipleInvoiceRequest(AbstractModel):
    """
    Request entity for MultipleInvoiceRequest operation.
    ...
    def __init__(
        ...
        ofd_file=None,
        ofd_file_num=None,
        verify_parameter=None,
        probability=None,
        location=None,
    ):
        """
        Initialize MultipleInvoiceRequest request entity.
        ...
        :param verify_parameter: 是否开启验真，默认为 false，即不开启。当为 true 时，返回匹配发票验真接口所需的6要素信息
        :type verify_parameter: bool (optional)

        :param probability: 是否返回字段置信度，默认为 false ，即不返回
        :type probability: bool (optional)

        :param location: 是否返回字段位置坐标，默认为 false，即不返回
        ...
        self.verify_parameter = verify_parameter
    ...
    def to_dict(self):
        ...
        if self.verify_parameter is not None:
            result['verify_parameter'] = self.verify_parameter
    ...
    def from_dict(self, m):
        ...
        if m.get('verify_parameter') is not None:
            self.verify_parameter = m.get('verify_parameter')
