"""
Request entity for AccurateBasicRequest information.
"""

from baiducloud_python_sdk_core.abstract_model import AbstractModel


class AccurateBasicRequest(AbstractModel):
    """
    Request entity for AccurateBasicRequest operation.
    ...
    def __init__(
        ...
        paragraph=None,
        probability=None,
        multidirectional_recognize=None,
    ):
        """
        Initialize AccurateBasicRequest request entity.
        ...
        :param multidirectional_recognize: multidirectional_recognize parameter
        :type multidirectional_recognize: bool (optional)
        """
        super().__init__()
        self.image = image
        self.url = url
        ...
        self.multidirectional_recognize = multidirectional_recognize
    ...
    def to_dict(self):
        ...
        if self.multidirectional_recognize is not None:
            result['multidirectional_recognize'] = self.multidirectional_recognize
        return result
    ...
    def from_dict(self, m):
        ...
        if m.get('multidirectional_recognize') is not None:
            self.multidirectional_recognize = m.get('multidirectional_recognize')
        return self
