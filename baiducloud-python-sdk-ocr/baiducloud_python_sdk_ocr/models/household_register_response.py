"""
Request entity for HouseholdRegisterResponse information.
"""

from baiducloud_python_sdk_core.bce_response import BceResponse
from baiducloud_python_sdk_ocr.models.household_register_result import HouseholdRegisterResult


class HouseholdRegisterResponse(BceResponse):
    """
    HouseholdRegisterResponse
    """

    def __init__(
        self, error_code=None, error_msg=None, log_id=None, direction=None, words_result_num=None, words_result=None
    ):
        """
        Initialize HouseholdRegisterResponse response.
        ...
        :type words_result: HouseholdRegisterResult (optional)
        """
        super().__init__()
    ...
    def from_dict(self, m):
        ...
        if m.get('words_result') is not None:
            self.words_result = HouseholdRegisterResult().from_dict(m.get('words_result'))
        return self
