"""
Request entity for MixedMultiVehicleRequest information.
"""

from baiducloud_python_sdk_core.abstract_model import AbstractModel


class MixedMultiVehicleRequest(AbstractModel):
    """
    Request entity for MixedMultiVehicleRequest operation.

    This class encapsulates all parameters for the API request.
    """

    def __init__(self, image=None, url=None, detect_direction=None, unified=None):
        """
        Initialize MixedMultiVehicleRequest request entity.
    ...
    def from_dict(self, m):
        ...
        :rtype: MixedMultiVehicleRequest
