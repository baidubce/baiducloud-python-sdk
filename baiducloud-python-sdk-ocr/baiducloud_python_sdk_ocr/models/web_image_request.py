"""
Request entity for WebImageRequest information.
"""

from baiducloud_python_sdk_core.abstract_model import AbstractModel


class WebImageRequest(AbstractModel):
    """
    Request entity for WebImageRequest operation.
    ...
    def __init__(
        ...
        """
        Initialize WebImageRequest request entity.
        ...
        :param detect_language: 是否检测语言，默认不检测。当前支持中文、英语、日语、韩语
