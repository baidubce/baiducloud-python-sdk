"""
Request entity for VinCodeResponse information.
"""

from baiducloud_python_sdk_core.bce_response import BceResponse
from baiducloud_python_sdk_ocr.models.vin_code_result import VinCodeResult


class VinCodeResponse(BceResponse):
    """
    VinCodeResponse
    """
    ...
    def __init__(self, error_code=None, error_msg=None, log_id=None, words_result_num=None, words_result=None):
        """
        Initialize VinCodeResponse response.
        ...
        :type words_result: List[VinCodeResult] (optional)
        """
        super().__init__()
    ...
    def from_dict(self, m):
        ...
        if m.get('words_result') is not None:
            self.words_result = [VinCodeResult().from_dict(i) for i in m.get('words_result')]
        return self
