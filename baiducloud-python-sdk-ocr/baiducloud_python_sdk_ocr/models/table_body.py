...
from baiducloud_python_sdk_ocr.models.doc_analysis_office_table_content import DocAnalysisOfficeTableContent


class TableBody(AbstractModel):
    """
    TableBody
    """
    ...
    def __init__(
        ...
        """
        Initialize TableBody instance.

        :param cell_location: 单元格四角点的x,y坐标
        :type cell_location: List[DocAnalysisOfficePoint] (optional)
        ...
        :param contents: 单元格里的文本信息，分行展示
        :type contents: List[DocAnalysisOfficeTableContent] (optional)
        """
        super().__init__()
    ...
    def from_dict(self, m):
        ...
        if m.get('cell_location') is not None:
            self.cell_location = [DocAnalysisOfficePoint().from_dict(i) for i in m.get('cell_location')]
        ...
        if m.get('contents') is not None:
            self.contents = [DocAnalysisOfficeTableContent().from_dict(i) for i in m.get('contents')]
        return self
