"""
Request entity for OnlineTaxiItineraryResponse information.
"""

from baiducloud_python_sdk_core.bce_response import BceResponse
from baiducloud_python_sdk_ocr.models.online_taxi_itinerary_words_result import OnlineTaxiItineraryWordsResult


class OnlineTaxiItineraryResponse(BceResponse):
    """
    OnlineTaxiItineraryResponse
    """
    ...
    def __init__(
        ...
        """
        Initialize OnlineTaxiItineraryResponse response.
        ...
        :type words_result: OnlineTaxiItineraryWordsResult (optional)
    ...
    def from_dict(self, m):
        ...
        if m.get('words_result') is not None:
            self.words_result = OnlineTaxiItineraryWordsResult().from_dict(m.get('words_result'))
