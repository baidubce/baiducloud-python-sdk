"""
MedicalPrescriptionCostDetailItem information
"""
...
class MedicalPrescriptionCostDetailItem(AbstractModel):
    """
    MedicalPrescriptionCostDetailItem
    """

    def __init__(self, word_name=None, word=None, location=None, probability=None):
        """
        Initialize MedicalPrescriptionCostDetailItem instance.

        :param word_name: 字段名，包括：清单项目名称、规格、单价、数量、金额、频率、用量、用法
    ...
    def from_dict(self, m):
        ...
        :rtype: MedicalPrescriptionCostDetailItem
