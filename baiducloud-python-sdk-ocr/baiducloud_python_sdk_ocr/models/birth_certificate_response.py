"""
Request entity for BirthCertificateResponse information.
"""

from baiducloud_python_sdk_core.bce_response import BceResponse
from baiducloud_python_sdk_ocr.models.birth_certificate_result import BirthCertificateResult


class BirthCertificateResponse(BceResponse):
    """
    ...
    def __init__(
        ...
        """
        Initialize BirthCertificateResponse response.
        ...
        :type words_result: BirthCertificateResult (optional)
        """
        super().__init__()
    ...
    def from_dict(self, m):
        ...
        if m.get('words_result') is not None:
            self.words_result = BirthCertificateResult().from_dict(m.get('words_result'))
        return self
