"""
Request entity for OnlineTaxiItineraryRequest information.
"""

from baiducloud_python_sdk_core.abstract_model import AbstractModel


class OnlineTaxiItineraryRequest(AbstractModel):
    """
    Request entity for OnlineTaxiItineraryRequest operation.
    ...
    def __init__(self, image=None, url=None, pdf_file=None, pdf_file_num=None, ofd_file=None, ofd_file_num=None):
        """
        Initialize OnlineTaxiItineraryRequest request entity.
    ...
    def from_dict(self, m):
        ...
        :rtype: OnlineTaxiItineraryRequest
