"""
Request entity for RealEstateCertificateRequest information.
"""

from baiducloud_python_sdk_core.abstract_model import AbstractModel


class RealEstateCertificateRequest(AbstractModel):
    """
    Request entity for RealEstateCertificateRequest operation.

    This class encapsulates all parameters for the API request.
    """

    def __init__(self, image=None, url=None, pdf_file=None, pdf_file_num=None, probability=None, location=None):
        """
        Initialize RealEstateCertificateRequest request entity.
    ...
    def from_dict(self, m):
        ...
        :rtype: RealEstateCertificateRequest
