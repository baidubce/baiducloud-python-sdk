"""
Request entity for WebImageResponse information.
"""

from baiducloud_python_sdk_core.bce_response import BceResponse
from baiducloud_python_sdk_ocr.models.web_image_words_result import WebImageWordsResult


class WebImageResponse(BceResponse):
    """
    WebImageResponse
    """
    ...
    def __init__(
        ...
        """
        Initialize WebImageResponse response.
        ...
        :param language: 图像中识别出的语言类型，-1表示未知语言
        ...
        :type words_result: List[WebImageWordsResult] (optional)
    ...
    def from_dict(self, m):
        ...
        if m.get('words_result') is not None:
            self.words_result = [WebImageWordsResult().from_dict(i) for i in m.get('words_result')]
