"""
Request entity for OverseasPassportResponse information.
"""

from baiducloud_python_sdk_core.bce_response import BceResponse


class OverseasPassportResponse(BceResponse):
    """
    OverseasPassportResponse
    """
    ...
    def __init__(
        ...
        """
        Initialize OverseasPassportResponse response.
        ...
        :param words_result: 识别结果，key为字段名称，value为识别项列表
