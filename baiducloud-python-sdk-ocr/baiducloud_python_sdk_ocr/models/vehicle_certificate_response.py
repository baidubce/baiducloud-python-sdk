"""
Request entity for VehicleCertificateResponse information.
"""

from baiducloud_python_sdk_core.bce_response import BceResponse
from baiducloud_python_sdk_ocr.models.vehicle_certificationwords_result import VehicleCertificationwordsResult


class VehicleCertificateResponse(BceResponse):
    """
    ...
    def __init__(
        ...
        """
        Initialize VehicleCertificateResponse response.
        ...
        :type words_result: VehicleCertificationwordsResult (optional)
        """
        super().__init__()
    ...
    def from_dict(self, m):
        ...
        if m.get('words_result') is not None:
            self.words_result = VehicleCertificationwordsResult().from_dict(m.get('words_result'))
        return self
