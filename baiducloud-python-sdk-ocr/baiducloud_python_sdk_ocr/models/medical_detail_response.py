"""
Request entity for MedicalDetailResponse information.
"""

from baiducloud_python_sdk_core.bce_response import BceResponse
from baiducloud_python_sdk_ocr.models.medical_detail_words_result import MedicalDetailWordsResult


class MedicalDetailResponse(BceResponse):
    """
    ...
    def __init__(self, error_code=None, error_msg=None, log_id=None, words_result_num=None, words_result=None):
        """
        Initialize MedicalDetailResponse response.
        ...
        :type words_result: MedicalDetailWordsResult (optional)
        """
        super().__init__()
    ...
    def from_dict(self, m):
        ...
        if m.get('words_result') is not None:
            self.words_result = MedicalDetailWordsResult().from_dict(m.get('words_result'))
        return self
