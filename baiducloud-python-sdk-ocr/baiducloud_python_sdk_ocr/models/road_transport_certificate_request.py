"""
Request entity for RoadTransportCertificateRequest information.
"""

from baiducloud_python_sdk_core.abstract_model import AbstractModel


class RoadTransportCertificateRequest(AbstractModel):
    """
    Request entity for RoadTransportCertificateRequest operation.

    This class encapsulates all parameters for the API request.
    """

    def __init__(self, image=None, url=None, pdf_file=None, pdf_file_num=None):
        """
        Initialize RoadTransportCertificateRequest request entity.
    ...
    def from_dict(self, m):
        ...
        :rtype: RoadTransportCertificateRequest
