"""
Request entity for MixedMultiVehicleResponse information.
"""

from baiducloud_python_sdk_core.bce_response import BceResponse
from baiducloud_python_sdk_ocr.models.words_result_item import WordsResultItem


class MixedMultiVehicleResponse(BceResponse):
    """
    MixedMultiVehicleResponse
    """

    def __init__(self, error_code=None, error_msg=None, log_id=None, words_result_num=None, words_result=None):
        """
        Initialize MixedMultiVehicleResponse response.
        ...
        :type words_result: List[WordsResultItem] (optional)
        """
        super().__init__()
    ...
    def from_dict(self, m):
        ...
        if m.get('words_result') is not None:
            self.words_result = [WordsResultItem().from_dict(i) for i in m.get('words_result')]
        return self
