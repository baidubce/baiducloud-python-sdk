"""
Request entity for WebImageLocRequest information.
"""

from baiducloud_python_sdk_core.abstract_model import AbstractModel


class WebImageLocRequest(AbstractModel):
    """
    Request entity for WebImageLocRequest operation.
    ...
    def __init__(
        ...
        """
        Initialize WebImageLocRequest request entity.
        ...
        :param poly_location: 是否返回文字所在区域的外接四边形的4个点坐标信息。默认为false
