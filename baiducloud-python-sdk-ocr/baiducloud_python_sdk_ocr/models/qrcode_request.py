"""
Request entity for QrcodeRequest information.
"""

from baiducloud_python_sdk_core.abstract_model import AbstractModel


class QrcodeRequest(AbstractModel):
    """
    Request entity for QrcodeRequest operation.

    This class encapsulates all parameters for the API request.
    """

    def __init__(
        self, image=None, url=None, pdf_file=None, pdf_file_num=None, ofd_file=None, ofd_file_num=None, location=None
    ):
        """
        Initialize QrcodeRequest request entity.
