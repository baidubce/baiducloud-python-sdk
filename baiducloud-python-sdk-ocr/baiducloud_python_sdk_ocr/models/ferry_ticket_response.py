"""
Request entity for FerryTicketResponse information.
"""

from baiducloud_python_sdk_core.bce_response import BceResponse
from baiducloud_python_sdk_ocr.models.ferry_ticket_words_result import FerryTicketWordsResult


class FerryTicketResponse(BceResponse):
    """
    FerryTicketResponse
    """

    def __init__(self, log_id=None, error_code=None, error_msg=None, words_result_num=None, words_result=None):
        """
        Initialize FerryTicketResponse response.
        ...
        :type words_result: FerryTicketWordsResult (optional)
        """
        super().__init__()
        self.log_id = log_id
    ...
    def from_dict(self, m):
        ...
        if m.get('words_result') is not None:
            self.words_result = FerryTicketWordsResult().from_dict(m.get('words_result'))
        return self
