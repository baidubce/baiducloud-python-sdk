"""
Request entity for VehicleRegistrationCertificateResponse information.
"""
...
class VehicleRegistrationCertificateResponse(BceResponse):
    """
    ...
    def __init__(self, error_code=None, error_msg=None, log_id=None, direction=None, words_result=None):
        """
        Initialize VehicleRegistrationCertificateResponse response.
