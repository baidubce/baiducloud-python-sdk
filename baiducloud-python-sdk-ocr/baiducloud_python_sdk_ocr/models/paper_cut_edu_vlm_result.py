"""
PaperCutEduVlmResult information
"""

from baiducloud_python_sdk_core.abstract_model import AbstractModel


class PaperCutEduVlmResult(AbstractModel):
    """
    PaperCutEduVlmResult
    """

    def __init__(self, task_id=None, wait_task_count=None):
        """
        Initialize PaperCutEduVlmResult instance.

        :param task_id: 该请求生成的任务ID，后续使用该task_id获取识别结果
