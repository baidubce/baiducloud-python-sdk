"""
Request entity for MeterResponse information.
"""

from baiducloud_python_sdk_core.bce_response import BceResponse
from baiducloud_python_sdk_ocr.models.meter_words_result import MeterWordsResult


class MeterResponse(BceResponse):
    """
    MeterResponse
    """

    def __init__(self, error_code=None, error_msg=None, log_id=None, words_result=None, words_result_num=None):
        """
        Initialize MeterResponse response.
        ...
        :type words_result: List[MeterWordsResult] (optional)

        :param words_result_num: 识别结果数，表示 words_result 的元素个数
    ...
    def from_dict(self, m):
        ...
        if m.get('words_result') is not None:
            self.words_result = [MeterWordsResult().from_dict(i) for i in m.get('words_result')]
