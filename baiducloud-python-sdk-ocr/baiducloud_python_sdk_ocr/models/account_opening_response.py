"""
Request entity for AccountOpeningResponse information.
"""

from baiducloud_python_sdk_core.bce_response import BceResponse


class AccountOpeningResponse(BceResponse):
    """
    ...
    def __init__(
        ...
        """
        Initialize AccountOpeningResponse response.
        ...
        :param words_result: 识别结果，key为字段名（如：账号、公司名称等），value为识别内容
