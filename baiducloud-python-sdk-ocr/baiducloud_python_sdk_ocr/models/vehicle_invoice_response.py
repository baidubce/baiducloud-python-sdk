"""
Request entity for VehicleInvoiceResponse information.
"""

from baiducloud_python_sdk_core.bce_response import BceResponse
from baiducloud_python_sdk_ocr.models.vehicle_invoice_words_result import VehicleInvoiceWordsResult


class VehicleInvoiceResponse(BceResponse):
    """
    VehicleInvoiceResponse
    """

    def __init__(self, error_code=None, error_msg=None, log_id=None, words_result_num=None, words_result=None):
        """
        Initialize VehicleInvoiceResponse response.
        ...
        :type words_result: VehicleInvoiceWordsResult (optional)
        """
        super().__init__()
    ...
    def from_dict(self, m):
        ...
        if m.get('words_result') is not None:
            self.words_result = VehicleInvoiceWordsResult().from_dict(m.get('words_result'))
        return self
