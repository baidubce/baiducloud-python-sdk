"""
Request entity for BusinesslicenseDetailedResponse information.
"""

from baiducloud_python_sdk_core.bce_response import BceResponse
from baiducloud_python_sdk_ocr.models.businesslicense_verification_detailed_result import (
    BusinesslicenseVerificationDetailedResult,
)


class BusinesslicenseDetailedResponse(BceResponse):
    """
    BusinesslicenseDetailedResponse
    """

    def __init__(self, error_code=None, error_msg=None, log_id=None, words_result_num=None, words_result=None):
        """
        Initialize BusinesslicenseDetailedResponse response.
        ...
        :type words_result: BusinesslicenseVerificationDetailedResult (optional)
        """
        super().__init__()
    ...
    def from_dict(self, m):
        ...
        if m.get('words_result') is not None:
            self.words_result = BusinesslicenseVerificationDetailedResult().from_dict(m.get('words_result'))
        return self
