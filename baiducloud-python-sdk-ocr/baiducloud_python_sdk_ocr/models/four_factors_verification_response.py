"""
Request entity for FourFactorsVerificationResponse information.
"""

from baiducloud_python_sdk_core.bce_response import BceResponse
from baiducloud_python_sdk_ocr.models.four_factors_verification_result import FourFactorsVerificationResult


class FourFactorsVerificationResponse(BceResponse):
    """
    FourFactorsVerificationResponse
    """

    def __init__(self, error_code=None, error_msg=None, log_id=None, words_result_num=None, words_result=None):
        """
        Initialize FourFactorsVerificationResponse response.
        ...
        :type words_result: FourFactorsVerificationResult (optional)
        """
        super().__init__()
    ...
    def from_dict(self, m):
        ...
        if m.get('words_result') is not None:
            self.words_result = FourFactorsVerificationResult().from_dict(m.get('words_result'))
        return self
