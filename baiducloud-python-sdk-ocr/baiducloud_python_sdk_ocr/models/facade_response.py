"""
Request entity for FacadeResponse information.
"""

from baiducloud_python_sdk_core.bce_response import BceResponse
from baiducloud_python_sdk_ocr.models.facade_words_result import FacadeWordsResult


class FacadeResponse(BceResponse):
    """
    FacadeResponse
    """
    ...
    def __init__(self, error_code=None, error_msg=None, log_id=None, words_result_num=None, words_result=None):
        """
        Initialize FacadeResponse response.
        ...
        :type words_result: List[FacadeWordsResult] (optional)
        """
        super().__init__()
    ...
    def from_dict(self, m):
        ...
        if m.get('words_result') is not None:
            self.words_result = [FacadeWordsResult().from_dict(i) for i in m.get('words_result')]
        return self
