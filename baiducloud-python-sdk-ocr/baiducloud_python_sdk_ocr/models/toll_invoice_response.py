"""
Request entity for TollInvoiceResponse information.
"""

from baiducloud_python_sdk_core.bce_response import BceResponse
from baiducloud_python_sdk_ocr.models.toll_invoice_words_result import TollInvoiceWordsResult


class TollInvoiceResponse(BceResponse):
    """
    TollInvoiceResponse
    """
    ...
    def __init__(
        ...
        """
        Initialize TollInvoiceResponse response.
        ...
        :type words_result: TollInvoiceWordsResult (optional)
    ...
    def from_dict(self, m):
        ...
        if m.get('words_result') is not None:
            self.words_result = TollInvoiceWordsResult().from_dict(m.get('words_result'))
