"""
Request entity for PassportResponse information.
"""

from baiducloud_python_sdk_core.bce_response import BceResponse


class PassportResponse(BceResponse):
    """
    PassportResponse
    """
    ...
    def __init__(
        ...
        """
        Initialize PassportResponse response.
        ...
        :param words_result: 识别结果，key为字段名称，每个字段包含location和words
