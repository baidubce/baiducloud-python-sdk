"""
Request entity for AccurateResponse information.
"""

from baiducloud_python_sdk_core.bce_response import BceResponse
from baiducloud_python_sdk_ocr.models.accurate_words_result import AccurateWordsResult
from baiducloud_python_sdk_ocr.models.accurate_paragraphs_result import AccurateParagraphsResult


class AccurateResponse(BceResponse):
    """
    AccurateResponse
    """
    ...
    def __init__(
        ...
        """
        Initialize AccurateResponse response.
        ...
        :type words_result: List[AccurateWordsResult] (optional)

        :param paragraphs_result: 段落检测结果，当 paragraph=true 时返回该字段
        :type paragraphs_result: List[AccurateParagraphsResult] (optional)
    ...
    def from_dict(self, m):
        ...
        if m.get('words_result') is not None:
            self.words_result = [AccurateWordsResult().from_dict(i) for i in m.get('words_result')]
        if m.get('paragraphs_result') is not None:
            self.paragraphs_result = [AccurateParagraphsResult().from_dict(i) for i in m.get('paragraphs_result')]
