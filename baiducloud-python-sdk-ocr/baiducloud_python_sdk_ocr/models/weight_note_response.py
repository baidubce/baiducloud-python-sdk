"""
Request entity for WeightNoteResponse information.
"""

from baiducloud_python_sdk_core.bce_response import BceResponse
from baiducloud_python_sdk_ocr.models.weight_note_words_result import WeightNoteWordsResult


class WeightNoteResponse(BceResponse):
    """
    WeightNoteResponse
    """
    ...
    def __init__(
        ...
        """
        Initialize WeightNoteResponse response.
        ...
        :type words_result: List[WeightNoteWordsResult] (optional)
    ...
    def from_dict(self, m):
        ...
        if m.get('words_result') is not None:
            self.words_result = [WeightNoteWordsResult().from_dict(i) for i in m.get('words_result')]
