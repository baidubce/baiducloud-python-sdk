"""
Request entity for RealEstateCertificateResponse information.
"""

from baiducloud_python_sdk_core.bce_response import BceResponse


class RealEstateCertificateResponse(BceResponse):
    """
    RealEstateCertificateResponse
    """
    ...
    def __init__(
        ...
        """
        Initialize RealEstateCertificateResponse response.
        ...
        :param words_result: 识别结果，key为字段名（如：权利人、坐落等），value为识别内容数组
