"""
Request entity for GeneralBasicResponse information.
"""

from baiducloud_python_sdk_core.bce_response import BceResponse
from baiducloud_python_sdk_ocr.models.general_basic_words_result import GeneralBasicWordsResult
from baiducloud_python_sdk_ocr.models.general_basic_paragraphs_result import GeneralBasicParagraphsResult


class GeneralBasicResponse(BceResponse):
    """
    GeneralBasicResponse
    """
    ...
    def __init__(
        ...
        """
        Initialize GeneralBasicResponse response.
        ...
        :type words_result: List[GeneralBasicWordsResult] (optional)

        :param paragraphs_result: 段落检测结果，当 paragraph=true 时返回该字段
        :type paragraphs_result: List[GeneralBasicParagraphsResult] (optional)
    ...
    def from_dict(self, m):
        ...
        if m.get('words_result') is not None:
            self.words_result = [GeneralBasicWordsResult().from_dict(i) for i in m.get('words_result')]
        if m.get('paragraphs_result') is not None:
            self.paragraphs_result = [GeneralBasicParagraphsResult().from_dict(i) for i in m.get('paragraphs_result')]
