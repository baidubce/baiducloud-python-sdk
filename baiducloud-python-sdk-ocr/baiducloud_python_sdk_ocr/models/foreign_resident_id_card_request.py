"""
Request entity for ForeignResidentIdCardRequest information.
"""

from baiducloud_python_sdk_core.abstract_model import AbstractModel


class ForeignResidentIdCardRequest(AbstractModel):
    """
    Request entity for ForeignResidentIdCardRequest operation.
    ...
    def __init__(self, image=None, url=None, pdf_file=None, pdf_file_num=None):
        """
        Initialize ForeignResidentIdCardRequest request entity.
    ...
    def from_dict(self, m):
        ...
        :rtype: ForeignResidentIdCardRequest
