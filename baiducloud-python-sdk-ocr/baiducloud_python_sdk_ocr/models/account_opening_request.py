"""
Request entity for AccountOpeningRequest information.
"""

from baiducloud_python_sdk_core.abstract_model import AbstractModel


class AccountOpeningRequest(AbstractModel):
    """
    Request entity for AccountOpeningRequest operation.
    ...
    def __init__(self, image=None, url=None, pdf_file=None, pdf_file_num=None):
        """
        Initialize AccountOpeningRequest request entity.
