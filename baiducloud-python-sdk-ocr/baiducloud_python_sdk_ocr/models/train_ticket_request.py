"""
Request entity for TrainTicketRequest information.
"""

from baiducloud_python_sdk_core.abstract_model import AbstractModel


class TrainTicketRequest(AbstractModel):
    """
    Request entity for TrainTicketRequest operation.
    ...
    def __init__(self, image=None, url=None, pdf_file=None, pdf_file_num=None, ofd_file=None, ofd_file_num=None):
        """
        Initialize TrainTicketRequest request entity.
