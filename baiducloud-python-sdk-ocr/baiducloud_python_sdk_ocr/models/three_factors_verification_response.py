"""
Request entity for ThreeFactorsVerificationResponse information.
"""

from baiducloud_python_sdk_core.bce_response import BceResponse
from baiducloud_python_sdk_ocr.models.three_factors_verification_result import ThreeFactorsVerificationResult


class ThreeFactorsVerificationResponse(BceResponse):
    """
    ThreeFactorsVerificationResponse
    """

    def __init__(self, error_code=None, error_msg=None, log_id=None, words_result_num=None, words_result=None):
        """
        Initialize ThreeFactorsVerificationResponse response.
        ...
        :param words_result_num: 识别结果数，标识words_result的元素个数
        :type words_result_num: int (optional)

        :param words_result: words_result field
        :type words_result: ThreeFactorsVerificationResult (optional)
        """
        super().__init__()
    ...
    def from_dict(self, m):
        ...
        if m.get('words_result') is not None:
            self.words_result = ThreeFactorsVerificationResult().from_dict(m.get('words_result'))
        return self
