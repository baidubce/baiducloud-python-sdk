"""
Request entity for MedicalInvoiceResponse information.
"""

from baiducloud_python_sdk_core.bce_response import BceResponse
from baiducloud_python_sdk_ocr.models.medical_invoice_words_result import MedicalInvoiceWordsResult


class MedicalInvoiceResponse(BceResponse):
    """
    ...
    def __init__(
        ...
        """
        Initialize MedicalInvoiceResponse response.
        ...
        :param province: 省市，支持返回：北京/广东/河北/河南/江苏/山东/上海/天津/浙江等
        :type province: str (optional)

        :param words_result: words_result field
        :type words_result: MedicalInvoiceWordsResult (optional)
        """
        super().__init__()
    ...
    def from_dict(self, m):
        ...
        if m.get('words_result') is not None:
            self.words_result = MedicalInvoiceWordsResult().from_dict(m.get('words_result'))
        return self
