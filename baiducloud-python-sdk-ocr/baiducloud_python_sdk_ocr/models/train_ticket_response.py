"""
Request entity for TrainTicketResponse information.
"""

from baiducloud_python_sdk_core.bce_response import BceResponse
from baiducloud_python_sdk_ocr.models.train_ticket_words_result import TrainTicketWordsResult


class TrainTicketResponse(BceResponse):
    """
    TrainTicketResponse
    """
    ...
    def __init__(
        ...
        """
        Initialize TrainTicketResponse response.

        :param log_id: 请求标识码，唯一，用于调用失败后进行问题定位
        ...
        :type words_result: TrainTicketWordsResult (optional)
    ...
    def from_dict(self, m):
        ...
        if m.get('words_result') is not None:
            self.words_result = TrainTicketWordsResult().from_dict(m.get('words_result'))
