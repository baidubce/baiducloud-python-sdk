"""
Request entity for FerryTicketRequest information.
"""

from baiducloud_python_sdk_core.abstract_model import AbstractModel


class FerryTicketRequest(AbstractModel):
    """
    Request entity for FerryTicketRequest operation.
    ...
    def __init__(self, image=None, url=None, pdf_file=None, pdf_file_num=None, ofd_file=None, ofd_file_num=None):
        """
        Initialize FerryTicketRequest request entity.
