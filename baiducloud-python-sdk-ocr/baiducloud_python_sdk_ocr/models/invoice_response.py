"""
Request entity for InvoiceResponse information.
"""

from baiducloud_python_sdk_core.bce_response import BceResponse
from baiducloud_python_sdk_ocr.models.invoice_words_result import InvoiceWordsResult


class InvoiceResponse(BceResponse):
    """
    InvoiceResponse
    """
    ...
    def __init__(
        ...
        """
        Initialize InvoiceResponse response.
        ...
        :type words_result: InvoiceWordsResult (optional)
    ...
    def from_dict(self, m):
        ...
        if m.get('words_result') is not None:
            self.words_result = InvoiceWordsResult().from_dict(m.get('words_result'))
