"""
Request entity for RoadTransportCertificateResponse information.
"""

from baiducloud_python_sdk_core.bce_response import BceResponse


class RoadTransportCertificateResponse(BceResponse):
    """
    RoadTransportCertificateResponse
    """
    ...
    def __init__(
        ...
        """
        Initialize RoadTransportCertificateResponse response.
        ...
        :param words_result: 识别结果，key为字段名（如：道路运输证号、车辆号牌等），value为识别内容数组
