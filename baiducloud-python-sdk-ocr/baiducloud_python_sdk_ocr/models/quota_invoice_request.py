"""
Request entity for QuotaInvoiceRequest information.
"""

from baiducloud_python_sdk_core.abstract_model import AbstractModel


class QuotaInvoiceRequest(AbstractModel):
    """
    Request entity for QuotaInvoiceRequest operation.
    ...
    def __init__(self, image=None, url=None, pdf_file=None, pdf_file_num=None, ofd_file=None, ofd_file_num=None):
        """
        Initialize QuotaInvoiceRequest request entity.
