"""
Request entity for WaybillResponse information.
"""

from baiducloud_python_sdk_core.bce_response import BceResponse
from baiducloud_python_sdk_ocr.models.way_bill_words_result_item import WayBillWordsResultItem


class WaybillResponse(BceResponse):
    """
    WaybillResponse
    """
    ...
    def __init__(self, error_code=None, error_msg=None, log_id=None, words_result_num=None, words_result=None):
        """
        Initialize WaybillResponse response.
        ...
        :type words_result: List[WayBillWordsResultItem] (optional)
        """
        super().__init__()
    ...
    def from_dict(self, m):
        ...
        if m.get('words_result') is not None:
            self.words_result = [WayBillWordsResultItem().from_dict(i) for i in m.get('words_result')]
        return self
