"""
Request entity for TaxiReceiptResponse information.
"""

from baiducloud_python_sdk_core.bce_response import BceResponse
from baiducloud_python_sdk_ocr.models.taxi_receipt_words_result import TaxiReceiptWordsResult


class TaxiReceiptResponse(BceResponse):
    """
    TaxiReceiptResponse
    """
    ...
    def __init__(
        ...
        """
        Initialize TaxiReceiptResponse response.
        ...
        :type words_result: TaxiReceiptWordsResult (optional)
    ...
    def from_dict(self, m):
        ...
        if m.get('words_result') is not None:
            self.words_result = TaxiReceiptWordsResult().from_dict(m.get('words_result'))
