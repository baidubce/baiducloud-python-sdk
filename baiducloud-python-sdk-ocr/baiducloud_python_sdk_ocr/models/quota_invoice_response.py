"""
Request entity for QuotaInvoiceResponse information.
"""

from baiducloud_python_sdk_core.bce_response import BceResponse
from baiducloud_python_sdk_ocr.models.quota_invoice_words_result import QuotaInvoiceWordsResult


class QuotaInvoiceResponse(BceResponse):
    """
    QuotaInvoiceResponse
    """
    ...
    def __init__(
        ...
        """
        Initialize QuotaInvoiceResponse response.
        ...
        :type words_result: QuotaInvoiceWordsResult (optional)
    ...
    def from_dict(self, m):
        ...
        if m.get('words_result') is not None:
            self.words_result = QuotaInvoiceWordsResult().from_dict(m.get('words_result'))
