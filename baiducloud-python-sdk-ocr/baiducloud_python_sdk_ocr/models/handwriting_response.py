"""
Request entity for HandwritingResponse information.
"""

from baiducloud_python_sdk_core.bce_response import BceResponse
from baiducloud_python_sdk_ocr.models.handwriting_words_result import HandwritingWordsResult


class HandwritingResponse(BceResponse):
    """
    HandwritingResponse
    """
    ...
    def __init__(
        ...
        """
        Initialize HandwritingResponse response.
        ...
        :type words_result: List[HandwritingWordsResult] (optional)
    ...
    def from_dict(self, m):
        ...
        if m.get('words_result') is not None:
            self.words_result = [HandwritingWordsResult().from_dict(i) for i in m.get('words_result')]
