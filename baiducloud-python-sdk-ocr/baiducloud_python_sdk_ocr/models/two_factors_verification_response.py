"""
Request entity for TwoFactorsVerificationResponse information.
"""

from baiducloud_python_sdk_core.bce_response import BceResponse
from baiducloud_python_sdk_ocr.models.two_factors_verification_result import TwoFactorsVerificationResult


class TwoFactorsVerificationResponse(BceResponse):
    """
    TwoFactorsVerificationResponse
    """

    def __init__(self, error_code=None, error_msg=None, log_id=None, words_result_num=None, words_result=None):
        """
        Initialize TwoFactorsVerificationResponse response.
        ...
        :type words_result: TwoFactorsVerificationResult (optional)
        """
        super().__init__()
    ...
    def from_dict(self, m):
        ...
        if m.get('words_result') is not None:
            self.words_result = TwoFactorsVerificationResult().from_dict(m.get('words_result'))
        return self
