"""
Request entity for AirTicketResponse information.
"""

from baiducloud_python_sdk_core.bce_response import BceResponse
from baiducloud_python_sdk_ocr.models.air_ticket_words_result import AirTicketWordsResult


class AirTicketResponse(BceResponse):
    """
    AirTicketResponse
    """
    ...
    def __init__(
        ...
        """
        Initialize AirTicketResponse response.
        ...
        :type words_result: AirTicketWordsResult (optional)
    ...
    def from_dict(self, m):
        ...
        if m.get('words_result') is not None:
            self.words_result = AirTicketWordsResult().from_dict(m.get('words_result'))
