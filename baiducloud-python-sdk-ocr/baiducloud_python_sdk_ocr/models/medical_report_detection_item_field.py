"""
MedicalReportDetectionItemField information
"""
...
class MedicalReportDetectionItemField(AbstractModel):
    """
    MedicalReportDetectionItemField
    """

    def __init__(self, word_name=None, word=None, location=None, probability=None):
        """
        Initialize MedicalReportDetectionItemField instance.

        :param word_name: 字段名，包括：项目名称、项目代号、结果、单位、参考区间、结果提示、测试方法、仪器类型
    ...
    def from_dict(self, m):
        ...
        :rtype: MedicalReportDetectionItemField
