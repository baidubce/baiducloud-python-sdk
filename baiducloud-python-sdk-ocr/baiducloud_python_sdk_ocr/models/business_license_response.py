"""
Request entity for BusinessLicenseResponse information.
"""

from baiducloud_python_sdk_core.bce_response import BceResponse
from baiducloud_python_sdk_ocr.models.business_license_quality import BusinessLicenseQuality


class BusinessLicenseResponse(BceResponse):
    """
    ...
    def __init__(
        ...
        """
        Initialize BusinessLicenseResponse response.
    ...
    def from_dict(self, m):
        ...
        if m.get('card_quality') is not None:
            self.card_quality = BusinessLicenseQuality().from_dict(m.get('card_quality'))
        return self
