"""
Request entity for NumbersResponse information.
"""

from baiducloud_python_sdk_core.bce_response import BceResponse
from baiducloud_python_sdk_ocr.models.numbers_words_result import NumbersWordsResult


class NumbersResponse(BceResponse):
    """
    NumbersResponse
    """

    def __init__(
        self, error_code=None, error_msg=None, log_id=None, words_result_num=None, direction=None, words_result=None
    ):
        """
        Initialize NumbersResponse response.
        ...
        :param words_result: 定位和识别结果数组
        :type words_result: List[NumbersWordsResult] (optional)
        """
        super().__init__()
    ...
    def from_dict(self, m):
        ...
        if m.get('words_result') is not None:
            self.words_result = [NumbersWordsResult().from_dict(i) for i in m.get('words_result')]
        return self
