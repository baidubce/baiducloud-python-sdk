"""
Request entity for BusTicketRequest information.
"""

from baiducloud_python_sdk_core.abstract_model import AbstractModel


class BusTicketRequest(AbstractModel):
    """
    Request entity for BusTicketRequest operation.
    ...
    def __init__(self, image=None, url=None, pdf_file=None, pdf_file_num=None, ofd_file=None, ofd_file_num=None):
        """
        Initialize BusTicketRequest request entity.
