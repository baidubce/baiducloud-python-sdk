"""
MedicalInvoiceCostDetailItem information
"""
...
class MedicalInvoiceCostDetailItem(AbstractModel):
    """
    MedicalInvoiceCostDetailItem
    """

    def __init__(self, name=None, word=None, medi_info=None):
        """
        Initialize MedicalInvoiceCostDetailItem instance.

        :param name: 字段名，包括：编码、项目、规格、数量、单价、金额
    ...
    def from_dict(self, m):
        ...
        :rtype: MedicalInvoiceCostDetailItem
