...
with io.open(os.path.join("baiducloud_python_sdk_scs", "__init__.py"), "rt") as f:
...
setup(
    ...
    version=SDK_VERSION,
    description='Baidu Cloud scsApi SDK Library for Python',
    ...
    project_urls={
        ...
        'Changelog': (
            'https://github.com/baidubce/baiducloud-python-sdk/blob/master/baiducloud-python-sdk-scs/ChangeLog.md'
        ),
    },
)
