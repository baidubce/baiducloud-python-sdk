"""
Example for scs get_instance_list method.
"""
...
if __name__ == '__main__':
    try:
        ...
        request = scs_models.GetInstanceListRequest(marker="", max_keys="", instance_ids="", vnet_ip="")
        res = client.get_instance_list(request)
