"""
Example for scs modify_instance_name method.
"""
...
if __name__ == '__main__':
    try:
        ...
        request = scs_models.ModifyInstanceNameRequest(instance_id="", instance_name="")
        res = client.modify_instance_name(request)
