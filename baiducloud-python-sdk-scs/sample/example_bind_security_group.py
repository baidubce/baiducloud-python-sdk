"""
Example for scs bind_security_group method.
"""
...
if __name__ == '__main__':
    try:
        ...
        request = scs_models.BindSecurityGroupRequest(instance_id="", security_group_ids=[])
        res = client.bind_security_group(request)
