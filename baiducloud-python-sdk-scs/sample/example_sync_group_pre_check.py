"""
Example for scs sync_group_pre_check method.
"""
...
if __name__ == '__main__':
    try:
        ...
        request = scs_models.SyncGroupPreCheckRequest(sync_group_show_id="", members=[])
        res = client.sync_group_pre_check(request)
