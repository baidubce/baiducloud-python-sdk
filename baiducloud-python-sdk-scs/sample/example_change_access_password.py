"""
Example for scs change_access_password method.
"""
...
if __name__ == '__main__':
    try:
        ...
        request = scs_models.ChangeAccessPasswordRequest(instance_id="", password="")
        res = client.change_access_password(request)
