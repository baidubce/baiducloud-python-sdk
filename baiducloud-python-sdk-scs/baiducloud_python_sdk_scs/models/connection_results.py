"""
ConnectionResults information
"""

from baiducloud_python_sdk_core.abstract_model import AbstractModel


class ConnectionResults(AbstractModel):
    """
    ConnectionResults
    """
    ...
    def __init__(self, source_id=None, source_role=None, target_id=None, target_role=None, connectable=None):
        """
        Initialize ConnectionResults instance.

        :param source_id: 源端集群ID
        :type source_id: str (optional)

        :param source_role: 源端集群角色
        :type source_role: str (optional)

        :param target_id: 目标端集群ID
        :type target_id: str (optional)

        :param target_role: 目标端集群角色
        :type target_role: str (optional)

        :param connectable: 是否连通（true:连通 false：不连通）
