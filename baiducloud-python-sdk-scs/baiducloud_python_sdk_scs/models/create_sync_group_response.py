"""
Request entity for CreateSyncGroupResponse information.
"""

from baiducloud_python_sdk_core.bce_response import BceResponse


class CreateSyncGroupResponse(BceResponse):
    """
    CreateSyncGroupResponse
    """

    def __init__(self, sync_group_show_id=None):
        """
        Initialize CreateSyncGroupResponse response.

        :param sync_group_show_id: 多活实例组ID。
