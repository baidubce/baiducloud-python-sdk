"""
Request entity for BindTagsRequest information.
"""
...
class BindTagsRequest(AbstractModel):
    """
    Request entity for BindTagsRequest operation.
    ...
    def __init__(self, instance_id, change_tags):
        """
        Initialize BindTagsRequest request entity.
