"""
Request entity for GetRecycleListResponse information.
"""
...
class GetRecycleListResponse(BceResponse):
    """
    GetRecycleListResponse
    """

    def __init__(self, marker=None, max_keys=None, is_truncated=None, next_marker=None, instances=None):
        """
        Initialize GetRecycleListResponse response.
