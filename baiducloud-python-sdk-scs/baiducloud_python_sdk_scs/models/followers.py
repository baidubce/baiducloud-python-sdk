...
class Followers(AbstractModel):
    ...
    def __init__(
        ...
        """
        Initialize Followers instance.

        :param cluster_name: 从角色实例名称
        ...
        :param sync_status: 状态。online：正常
        :type sync_status: str (optional)

        :param max_offset: 主从同步offset的最大差值
        :type max_offset: int (optional)
