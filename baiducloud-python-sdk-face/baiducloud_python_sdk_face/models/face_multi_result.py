"""
FaceMultiResult information
"""

from baiducloud_python_sdk_core.abstract_model import AbstractModel

from baiducloud_python_sdk_face.models.face_multi_face_info import FaceMultiFaceInfo


class FaceMultiResult(AbstractModel):
    """
    FaceMultiResult
    """
    ...
    def __init__(self, face_num=None, face_list=None):
        """
        Initialize FaceMultiResult instance.

        :param face_num: 图片中的人脸数量
        :type face_num: int (optional)

        :param face_list: 人脸信息列表
        :type face_list: List[FaceMultiFaceInfo] (optional)
        """
        super().__init__()
    ...
    def from_dict(self, m):
        ...
        if m.get('face_list') is not None:
            self.face_list = [FaceMultiFaceInfo().from_dict(i) for i in m.get('face_list')]
        return self
