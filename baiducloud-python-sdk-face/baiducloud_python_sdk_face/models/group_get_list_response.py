"""
Request entity for GroupGetListResponse information.
"""

from baiducloud_python_sdk_core.bce_response import BceResponse
from baiducloud_python_sdk_face.models.group_get_list_result import GroupGetListResult


class GroupGetListResponse(BceResponse):
    """
    GroupGetListResponse
    """

    def __init__(self, result=None, error_code=None, error_msg=None, log_id=None):
        """
        Initialize GroupGetListResponse response.

        :param result: result field
        :type result: GroupGetListResult (optional)
    ...
    def from_dict(self, m):
        ...
        if m.get('result') is not None:
            self.result = GroupGetListResult().from_dict(m.get('result'))
