"""
Request entity for IdMatchDateRequest information.
"""

from baiducloud_python_sdk_core.abstract_model import AbstractModel


class IdMatchDateRequest(AbstractModel):
    """
    Request entity for IdMatchDateRequest operation.
    ...
    def __init__(self, name, id_card_number, start_date, end_date):
        """
        Initialize IdMatchDateRequest request entity.
