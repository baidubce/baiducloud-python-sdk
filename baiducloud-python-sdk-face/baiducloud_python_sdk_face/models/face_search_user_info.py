"""
FaceSearchUserInfo information
"""

from baiducloud_python_sdk_core.abstract_model import AbstractModel


class FaceSearchUserInfo(AbstractModel):
    """
    FaceSearchUserInfo
    """
    ...
    def __init__(self, score=None, group_id=None, user_id=None, user_info=None):
        """
        Initialize FaceSearchUserInfo instance.

        :param score: 用户的匹配得分，推荐阈值80分
