"""
Example for face face_merge method.
"""
...
if __name__ == '__main__':
    try:
        ...
        request = face_models.FaceMergeRequest(
            image_template="", image_target="", version="", alpha=0.0, merge_degree="", position=0, language=0
        )
        res = client.face_merge(request)
