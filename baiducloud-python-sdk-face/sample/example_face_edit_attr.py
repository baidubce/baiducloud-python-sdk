"""
Example for face face_edit_attr method.
"""
...
if __name__ == '__main__':
    try:
        ...
        request = face_models.FaceEditAttrRequest(
            image="", image_type="", action_type="", target=0, quality_control="", face_location=""
        )
        res = client.face_edit_attr(request)
