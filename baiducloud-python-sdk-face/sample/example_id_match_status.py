"""
Example for face id_match_status method.
"""
...
if __name__ == '__main__':
    try:
        ...
        request = face_models.IdMatchStatusRequest(name="", id_card_number="", start_date="", end_date="")
        res = client.id_match_status(request)
