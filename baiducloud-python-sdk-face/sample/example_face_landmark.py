"""
Example for face face_landmark method.
"""
...
if __name__ == '__main__':
    try:
        ...
        request = face_models.FaceLandmarkRequest(image="", image_type="", max_face_num=0, face_field="")
        res = client.face_landmark(request)
