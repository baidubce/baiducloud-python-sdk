"""
Request entity for CreateSandboxResponse information.
"""

from baiducloud_python_sdk_core.bce_response import BceResponse


class CreateSandboxResponse(BceResponse):
    """
    ...
    def __init__(
        ...
        """
        Initialize CreateSandboxResponse response.

        :param sandbox_id: 新建沙箱实例 ID。
        :type sandbox_id: str (optional)

        :param template_id: 使用的模板 ID。
