"""
Example for ax list_sandboxes_v2_by_path method.
"""
...
if __name__ == '__main__':
    try:
        ...
        request = ax_models.ListSandboxesV2ByPathRequest(limit=0, next_token="", metadata="", state="")
        res = client.list_sandboxes_v2_by_path(request)
