"""
Example for privatezone delete_resolver method.
"""
...
if __name__ == '__main__':
    try:
        ...
        request = privatezone_models.DeleteResolverRequest(resolver_id="", client_token="")
        res = client.delete_resolver(request)
