"""
Example for privatezone get_dns_resolver_detail method.
"""
...
if __name__ == '__main__':
    try:
        ...
        request = privatezone_models.GetDnsResolverDetailRequest(resolver_id="")
        res = client.get_dns_resolver_detail(request)
