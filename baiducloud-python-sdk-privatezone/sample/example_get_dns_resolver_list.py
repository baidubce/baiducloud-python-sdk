"""
Example for privatezone get_dns_resolver_list method.
"""
...
if __name__ == '__main__':
    try:
        ...
        request = privatezone_models.GetDnsResolverListRequest(marker="", max_keys="", status="")
        res = client.get_dns_resolver_list(request)
