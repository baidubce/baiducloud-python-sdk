"""
Example for privatezone update_dns_parser method.
"""
...
if __name__ == '__main__':
    try:
        ...
        request = privatezone_models.UpdateDnsParserRequest(resolver_id="", client_token="", name="", description="")
        res = client.update_dns_parser(request)
