"""
Example for privatezone delete_resolver_rule method.
"""
...
if __name__ == '__main__':
    try:
        ...
        request = privatezone_models.DeleteResolverRuleRequest(rule_id="", client_token="")
        res = client.delete_resolver_rule(request)
