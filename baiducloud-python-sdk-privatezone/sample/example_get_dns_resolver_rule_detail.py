"""
Example for privatezone get_dns_resolver_rule_detail method.
"""
...
if __name__ == '__main__':
    try:
        ...
        request = privatezone_models.GetDnsResolverRuleDetailRequest(rule_id="")
        res = client.get_dns_resolver_rule_detail(request)
