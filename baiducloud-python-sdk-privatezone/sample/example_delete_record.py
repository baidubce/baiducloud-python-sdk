"""
Example for privatezone delete_record method.
"""
...
if __name__ == '__main__':
    try:
        ...
        request = privatezone_models.DeleteRecordRequest(record_id="", client_token="")
        res = client.delete_record(request)
        print("delete_record success")
