...
with io.open(os.path.join("baiducloud_python_sdk_privatezone", "__init__.py"), "rt") as f:
...
setup(
    name='baiducloud-python-sdk-privatezone',
    version=SDK_VERSION,
    description='Baidu Cloud privatezoneApi SDK Library for Python',
    long_description=LONG_DESCRIPTION,
    long_description_content_type='text/markdown',
    install_requires=['pycryptodome>=3.8.0', 'future>=0.6.0', 'six>=1.4.0', 'baiducloud-python-sdk-core>=0.0.2'],
    python_requires='>=2.7, !=3.0.*, !=3.1.*, !=3.2.*, <4',
    packages=find_packages(exclude=["tests*"]),
    url='https://github.com/baidubce/baiducloud-python-sdk',
    keywords=["baiducloud", "privatezone"],
    ...
    project_urls={
        ...
        'Changelog': (
            ...
            'baiducloud-python-sdk-privatezone/ChangeLog.md'
        ),
    },
)
