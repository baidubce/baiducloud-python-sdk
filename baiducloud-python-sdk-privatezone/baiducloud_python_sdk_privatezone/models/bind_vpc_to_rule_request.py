"""
Request entity for BindVpcToRuleRequest information.
"""
...
class BindVpcToRuleRequest(AbstractModel):
    """
    Request entity for BindVpcToRuleRequest operation.
    ...
    def __init__(self, rule_id, vpc_regions, clien_token=None):
        """
        Initialize BindVpcToRuleRequest request entity.
