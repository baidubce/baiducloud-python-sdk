"""
Request entity for GetDnsResolverDetailResponse information.
"""
...
class GetDnsResolverDetailResponse(BceResponse):
    """
    GetDnsResolverDetailResponse
    """
    ...
    def __init__(
        ...
        """
        Initialize GetDnsResolverDetailResponse response.
        ...
        :param vpc_id: VPC ID，解析器所有出站或入站的 DNS 查询流量都将经由此 VPC 进行流量转发
