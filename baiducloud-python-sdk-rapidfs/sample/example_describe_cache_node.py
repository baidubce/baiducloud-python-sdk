"""
Example for rapidfs describe_cache_node method.
"""
...
if __name__ == '__main__':
    try:
        ...
        request = rapidfs_models.DescribeCacheNodeRequest(instance_id="", cache_node_id="")
        res = client.describe_cache_node(request)
