"""
Example for rapidfs add_cache_nodes method.
"""
...
if __name__ == '__main__':
    try:
        ...
        request = rapidfs_models.AddCacheNodesRequest(instance_id="", cache_nodes=[], client_token="", type="")
        res = client.add_cache_nodes(request)
