"""
Example for rapidfs create_and_assign_tag method.
"""
...
if __name__ == '__main__':
    try:
        ...
        request = rapidfs_models.CreateAndAssignTagRequest(tag_resources=[], client_token="")
        res = client.create_and_assign_tag(request)
