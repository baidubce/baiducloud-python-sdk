"""
Example for rapidfs describe_auth_group method.
"""
...
if __name__ == '__main__':
    try:
        ...
        request = rapidfs_models.DescribeAuthGroupRequest(instance_id="", auth_group_id="")
        res = client.describe_auth_group(request)
