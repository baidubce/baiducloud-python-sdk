"""
Example for rapidfs restart_cache_nodes method.
"""
...
if __name__ == '__main__':
    try:
        ...
        request = rapidfs_models.RestartCacheNodesRequest(instance_id="", cache_node_ids=[], client_token="")
        res = client.restart_cache_nodes(request)
