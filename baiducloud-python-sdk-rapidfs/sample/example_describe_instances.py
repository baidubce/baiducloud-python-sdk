"""
Example for rapidfs describe_instances method.
"""
...
if __name__ == '__main__':
    try:
        ...
        request = rapidfs_models.DescribeInstancesRequest(filters=[], max_keys=0, marker="")
        res = client.describe_instances(request)
