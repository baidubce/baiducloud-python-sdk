"""
Example for rapidfs describe_cache_node_quota method.
"""
...
if __name__ == '__main__':
    try:
        ...
        request = rapidfs_models.DescribeCacheNodeQuotaRequest(instance_id="")
        res = client.describe_cache_node_quota(request)
