"""
Example for rapidfs create_meta_sync_rule method.
"""
...
if __name__ == '__main__':
    try:
        ...
        request = rapidfs_models.CreateMetaSyncRuleRequest(
            instance_id="",
            data_src_id="",
            meta_sync_rule_name="",
            type="",
            ...
            directory="",
            interval_minutes=0,
            execute_on_create=False,
            enable_on_create=False,
            description="",
        )
        res = client.create_meta_sync_rule(request)
