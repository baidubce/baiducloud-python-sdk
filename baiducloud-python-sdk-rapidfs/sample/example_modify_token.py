"""
Example for rapidfs modify_token method.
"""
...
if __name__ == '__main__':
    try:
        ...
        request = rapidfs_models.ModifyTokenRequest(
            instance_id="", token_id="", token_refresh_interval_minutes=0, client_token=""
        )
        res = client.modify_token(request)
