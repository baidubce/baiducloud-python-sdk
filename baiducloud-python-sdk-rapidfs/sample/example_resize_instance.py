"""
Example for rapidfs resize_instance method.
"""
...
if __name__ == '__main__':
    try:
        ...
        request = rapidfs_models.ResizeInstanceRequest(instance_id="", capacity_ti_b=0, client_token="")
        res = client.resize_instance(request)
