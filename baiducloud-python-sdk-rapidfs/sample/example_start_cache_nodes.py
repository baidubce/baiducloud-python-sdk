"""
Example for rapidfs start_cache_nodes method.
"""
...
if __name__ == '__main__':
    try:
        ...
        request = rapidfs_models.StartCacheNodesRequest(instance_id="", cache_node_ids=[], client_token="")
        res = client.start_cache_nodes(request)
