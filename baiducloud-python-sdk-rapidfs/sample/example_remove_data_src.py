"""
Example for rapidfs remove_data_src method.
"""
...
if __name__ == '__main__':
    try:
        ...
        request = rapidfs_models.RemoveDataSrcRequest(data_src_id="", instance_id="", client_token="", token="")
        res = client.remove_data_src(request)
