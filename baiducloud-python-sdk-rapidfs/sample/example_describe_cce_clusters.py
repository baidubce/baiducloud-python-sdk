"""
Example for rapidfs describe_cce_clusters method.
"""
...
if __name__ == '__main__':
    try:
        ...
        request = rapidfs_models.DescribeCceClustersRequest(vpc_id="", max_keys=0, marker="")
        res = client.describe_cce_clusters(request)
