"""
Example for rapidfs describe_auth_groups method.
"""
...
if __name__ == '__main__':
    try:
        ...
        request = rapidfs_models.DescribeAuthGroupsRequest(instance_id="", filters=[], max_keys=0, marker="")
        res = client.describe_auth_groups(request)
