"""
Example for rapidfs delete_instance method.
"""
...
if __name__ == '__main__':
    try:
        ...
        request = rapidfs_models.DeleteInstanceRequest(instance_id="", client_token="", token="")
        res = client.delete_instance(request)
