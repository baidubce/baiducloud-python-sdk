"""
Example for rapidfs describe_data_srcs method.
"""
...
if __name__ == '__main__':
    try:
        ...
        request = rapidfs_models.DescribeDataSrcsRequest(instance_id="", filters=[], max_keys=0, marker="")
        res = client.describe_data_srcs(request)
