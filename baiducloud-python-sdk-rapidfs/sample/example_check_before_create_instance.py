"""
Example for rapidfs check_before_create_instance method.
"""
...
if __name__ == '__main__':
    try:
        ...
        request = rapidfs_models.CheckBeforeCreateInstanceRequest(
            zone="",
            vpc_id="",
            subnet_id="",
            managed_mode="",
        ...
        res = client.check_before_create_instance(request)
