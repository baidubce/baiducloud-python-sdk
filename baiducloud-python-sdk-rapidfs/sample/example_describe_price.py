"""
Example for rapidfs describe_price method.
"""
...
if __name__ == '__main__':
    try:
        ...
        request = rapidfs_models.DescribePriceRequest(
            currency="", managed_mode="", meta_spec="", data_spec="", capacity_ti_b=0
        )
        res = client.describe_price(request)
