"""
Request entity for DisableMetaSyncRuleRequest information.
"""

from baiducloud_python_sdk_core.abstract_model import AbstractModel


class DisableMetaSyncRuleRequest(AbstractModel):
    """
    Request entity for DisableMetaSyncRuleRequest operation.
    ...
    def __init__(self, instance_id, data_src_id, meta_sync_rule_id, client_token=None):
        """
        Initialize DisableMetaSyncRuleRequest request entity.
    ...
    def from_dict(self, m):
        ...
        :rtype: DisableMetaSyncRuleRequest
