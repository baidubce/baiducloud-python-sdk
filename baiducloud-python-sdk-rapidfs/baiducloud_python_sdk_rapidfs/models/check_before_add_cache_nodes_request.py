"""
Request entity for CheckBeforeAddCacheNodesRequest information.
"""
...
class CheckBeforeAddCacheNodesRequest(AbstractModel):
    """
    Request entity for CheckBeforeAddCacheNodesRequest operation.

    This class encapsulates all parameters for the API request.
    """

    def __init__(self, instance_id, cache_nodes, type=None):
        """
        Initialize CheckBeforeAddCacheNodesRequest request entity.
    ...
    def from_dict(self, m):
        ...
        :rtype: CheckBeforeAddCacheNodesRequest
