"""
Request entity for DescribeMetaSyncRuleRequest information.
"""

from baiducloud_python_sdk_core.abstract_model import AbstractModel


class DescribeMetaSyncRuleRequest(AbstractModel):
    """
    Request entity for DescribeMetaSyncRuleRequest operation.

    This class encapsulates all parameters for the API request.
    """

    def __init__(self, instance_id, data_src_id, meta_sync_rule_id):
        """
        Initialize DescribeMetaSyncRuleRequest request entity.
    ...
    def from_dict(self, m):
        ...
        :rtype: DescribeMetaSyncRuleRequest
