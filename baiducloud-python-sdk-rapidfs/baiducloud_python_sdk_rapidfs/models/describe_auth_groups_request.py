"""
Request entity for DescribeAuthGroupsRequest information.
"""
...
class DescribeAuthGroupsRequest(AbstractModel):
    """
    Request entity for DescribeAuthGroupsRequest operation.
    ...
    def __init__(self, instance_id, filters=None, max_keys=None, marker=None):
        """
        Initialize DescribeAuthGroupsRequest request entity.
        ...
        :param marker: 批量获取列表的查询的起始位置，返回列表按 authGroupId 字典序排序， 取值为上一次返回的 nextMarker
    ...
    def from_dict(self, m):
        ...
        :rtype: DescribeAuthGroupsRequest
