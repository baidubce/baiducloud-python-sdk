"""
Request entity for DeleteMetaSyncRuleRequest information.
"""

from baiducloud_python_sdk_core.abstract_model import AbstractModel


class DeleteMetaSyncRuleRequest(AbstractModel):
    """
    Request entity for DeleteMetaSyncRuleRequest operation.
    ...
    def __init__(self, instance_id, data_src_id, meta_sync_rule_id, client_token=None):
        """
        Initialize DeleteMetaSyncRuleRequest request entity.
    ...
    def from_dict(self, m):
        ...
        :rtype: DeleteMetaSyncRuleRequest
