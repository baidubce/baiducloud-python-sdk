"""
Request entity for DescribeDataSrcsRequest information.
"""
...
class DescribeDataSrcsRequest(AbstractModel):
    """
    Request entity for DescribeDataSrcsRequest operation.
    ...
    def __init__(self, instance_id, filters=None, max_keys=None, marker=None):
        """
        Initialize DescribeDataSrcsRequest request entity.
        ...
        :param marker: 批量获取列表的查询的起始位置，返回列表按 dataSrcId 字典序排序，取值为上一次返回的 nextMarker
