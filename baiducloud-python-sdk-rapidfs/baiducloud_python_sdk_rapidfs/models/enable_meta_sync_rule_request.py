"""
Request entity for EnableMetaSyncRuleRequest information.
"""

from baiducloud_python_sdk_core.abstract_model import AbstractModel


class EnableMetaSyncRuleRequest(AbstractModel):
    """
    Request entity for EnableMetaSyncRuleRequest operation.
    ...
    def __init__(self, instance_id, data_src_id, meta_sync_rule_id, client_token=None):
        """
        Initialize EnableMetaSyncRuleRequest request entity.
    ...
    def from_dict(self, m):
        ...
        :rtype: EnableMetaSyncRuleRequest
