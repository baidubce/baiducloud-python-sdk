"""
Request entity for CancelMetaSyncJobRequest information.
"""

from baiducloud_python_sdk_core.abstract_model import AbstractModel


class CancelMetaSyncJobRequest(AbstractModel):
    """
    Request entity for CancelMetaSyncJobRequest operation.
    ...
    def __init__(self, instance_id, data_src_id, meta_sync_rule_id, client_token=None):
        """
        Initialize CancelMetaSyncJobRequest request entity.
    ...
    def from_dict(self, m):
        ...
        :rtype: CancelMetaSyncJobRequest
