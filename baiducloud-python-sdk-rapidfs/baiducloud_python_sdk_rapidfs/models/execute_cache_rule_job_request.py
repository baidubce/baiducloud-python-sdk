"""
Request entity for ExecuteCacheRuleJobRequest information.
"""

from baiducloud_python_sdk_core.abstract_model import AbstractModel


class ExecuteCacheRuleJobRequest(AbstractModel):
    """
    Request entity for ExecuteCacheRuleJobRequest operation.

    This class encapsulates all parameters for the API request.
    """

    def __init__(self, instance_id, data_src_id, cache_rule_id, client_token=None):
        """
        Initialize ExecuteCacheRuleJobRequest request entity.
    ...
    def from_dict(self, m):
        ...
        :rtype: ExecuteCacheRuleJobRequest
