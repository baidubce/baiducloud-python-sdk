"""
Request entity for DescribeCacheRulesRequest information.
"""
...
class DescribeCacheRulesRequest(AbstractModel):
    """
    Request entity for DescribeCacheRulesRequest operation.
    ...
    def __init__(self, instance_id, filters=None, max_keys=None, marker=None):
        """
        Initialize DescribeCacheRulesRequest request entity.
        ...
        :param marker: 批量获取列表的查询的起始位置，返回列表按 cacheRuleId 字典序排序，取值为上一次返回的 nextMarker
    ...
    def from_dict(self, m):
        ...
        :rtype: DescribeCacheRulesRequest
